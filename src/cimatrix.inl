...
INLINE cimatrix::cimatrix() noexcept:dat(NULL),lb1(1),ub1(0),lb2(1),ub2(0),xsize(0),ysize(0)
{
}

INLINE cimatrix::cimatrix(const cinterval &r) noexcept:lb1(1),ub1(1),lb2(1),ub2(1),xsize(1),ysize(1)
{
	dat=new cinterval[1];
	*dat=r;
}

INLINE cimatrix::cimatrix(const real &r) noexcept:lb1(1),ub1(1),lb2(1),ub2(1),xsize(1),ysize(1)
{
	dat=new cinterval[1];
	*dat=r;
}

INLINE cimatrix::cimatrix(const complex &r) noexcept:lb1(1),ub1(1),lb2(1),ub2(1),xsize(1),ysize(1)
{
	dat=new cinterval[1];
	*dat=r;
}

INLINE cimatrix::cimatrix(const interval &r) noexcept:lb1(1),ub1(1),lb2(1),ub2(1),xsize(1),ysize(1)
{
	dat=new cinterval[1];
	*dat=r;
}

INLINE cimatrix::cimatrix(const rmatrix &rm) noexcept:lb1(rm.lb1),ub1(rm.ub1),lb2(rm.lb2),ub2(rm.ub2),xsize(rm.xsize),ysize(rm.ysize)
{
...
INLINE cimatrix::cimatrix(const cmatrix &rm) noexcept:lb1(rm.lb1),ub1(rm.ub1),lb2(rm.lb2),ub2(rm.ub2),xsize(rm.xsize),ysize(rm.ysize)
{
	dat=new cinterval[xsize*ysize];
	for(int i=0;i<xsize*ysize;i++)
		dat[i]=rm.dat[i];
...
INLINE cimatrix::cimatrix(const imatrix &rm) noexcept:lb1(rm.lb1),ub1(rm.ub1),lb2(rm.lb2),ub2(rm.ub2),xsize(rm.xsize),ysize(rm.ysize)
{
	dat=new cinterval[xsize*ysize];
	for(int i=0;i<xsize*ysize;i++)
		dat[i]=rm.dat[i];
...
INLINE cimatrix::cimatrix(const cimatrix &rm) noexcept:lb1(rm.lb1),ub1(rm.ub1),lb2(rm.lb2),ub2(rm.ub2),xsize(rm.xsize),ysize(rm.ysize)
{
	dat=new cinterval[xsize*ysize];
	for(int i=0;i<xsize*ysize;i++)
		dat[i]=rm.dat[i];
...
#if(CXSC_INDEX_CHECK)
	noexcept(false):lb1(1),ub1(m),lb2(1),ub2(n),xsize(n),ysize(m)
#else
...
#if(CXSC_INDEX_CHECK)
	noexcept(false):lb1(m1),ub1(m2),lb2(n1),ub2(n2),xsize(n2-n1+1),ysize(m2-m1+1)
#else
...
INLINE civector::civector(const cimatrix_subv &v) noexcept:l(v.lb),u(v.ub),size(v.size)
{
...
INLINE cimatrix::cimatrix(const civector &v) noexcept:lb1(v.l),ub1(v.u),lb2(1),ub2(1),xsize(1),ysize(v.size)
{
...
INLINE cimatrix::cimatrix(const rvector &v) noexcept:lb1(v.l),ub1(v.u),lb2(1),ub2(1),xsize(1),ysize(v.size)
{
	dat=new cinterval[v.size];
	for(int i=0;i<v.size;i++)
		dat[i]=v.dat[i];
...
INLINE cimatrix::cimatrix(const cvector &v) noexcept:lb1(v.l),ub1(v.u),lb2(1),ub2(1),xsize(1),ysize(v.size)
{
	dat=new cinterval[v.size];
	for(int i=0;i<v.size;i++)
		dat[i]=v.dat[i];
...
INLINE cimatrix::cimatrix(const ivector &v) noexcept:lb1(v.l),ub1(v.u),lb2(1),ub2(1),xsize(1),ysize(v.size)
{
	dat=new cinterval[v.size];
	for(int i=0;i<v.size;i++)
		dat[i]=v.dat[i];
...
INLINE cimatrix::cimatrix(const civector_slice &v) noexcept:lb1(v.start),ub1(v.end),lb2(1),ub2(1),xsize(1),ysize(v.size)
{
	dat=new cinterval[v.size];
...
INLINE cimatrix::cimatrix(const rvector_slice &v) noexcept:lb1(v.start),ub1(v.end),lb2(1),ub2(1),xsize(1),ysize(v.size)
{
	dat=new cinterval[v.size];
	for(int i=0,j=v.start-v.l;i<v.size;i++,j++)
		dat[i]=v.dat[j];
...
INLINE cimatrix::cimatrix(const ivector_slice &v) noexcept:lb1(v.start),ub1(v.end),lb2(1),ub2(1),xsize(1),ysize(v.size)
{
	dat=new cinterval[v.size];
	for(int i=0,j=v.start-v.l;i<v.size;i++,j++)
		dat[i]=v.dat[j];
...
INLINE cimatrix::cimatrix(const cvector_slice &v) noexcept:lb1(v.start),ub1(v.end),lb2(1),ub2(1),xsize(1),ysize(v.size)
{
	dat=new cinterval[v.size];
	for(int i=0,j=v.start-v.l;i<v.size;i++,j++)
		dat[i]=v.dat[j];
	...
	INLINE cimatrix::cimatrix(const cimatrix_slice &sl) noexcept:lb1(sl.start1),ub1(sl.end1),lb2(sl.start2),ub2(sl.end2),xsize(sl.sxsize),ysize(sl.sysize)
	{
		int i,j;
	...
	INLINE cimatrix::cimatrix(const rmatrix_slice &sl) noexcept:lb1(sl.start1),ub1(sl.end1),lb2(sl.start2),ub2(sl.end2),xsize(sl.sxsize),ysize(sl.sysize)
	{
		int i,j;
	...
	INLINE cimatrix::cimatrix(const cmatrix_slice &sl) noexcept:lb1(sl.start1),ub1(sl.end1),lb2(sl.start2),ub2(sl.end2),xsize(sl.sxsize),ysize(sl.sysize)
	{
		int i,j;
	...
	INLINE cimatrix::cimatrix(const imatrix_slice &sl) noexcept:lb1(sl.start1),ub1(sl.end1),lb2(sl.start2),ub2(sl.end2),xsize(sl.sxsize),ysize(sl.sysize)
	{
		int i,j;
...
#endif
{
	...
	INLINE cimatrix_subv &cimatrix_subv::operator =(const cimatrix_subv &rv) noexcept { return _mvmvassign(*this,rv); }
	INLINE cimatrix_subv &cimatrix_subv::operator =(const cinterval &r) noexcept { return _mvsassign(*this,r); }
	...
	INLINE cimatrix_subv &cimatrix_subv::operator =(const rmatrix_subv &rv) noexcept { return _mvvassign(*this,rvector(rv)); }
	INLINE cimatrix_subv &cimatrix_subv::operator =(const real &r) noexcept { return _mvsassign(*this,r); }
	...
	INLINE cimatrix_subv &cimatrix_subv::operator =(const cmatrix_subv &rv) noexcept { return _mvvassign(*this,cvector(rv)); }
	INLINE cimatrix_subv &cimatrix_subv::operator =(const complex &r) noexcept { return _mvsassign(*this,r); }
	...
	INLINE cimatrix_subv &cimatrix_subv::operator =(const imatrix_subv &rv) noexcept { return _mvvassign(*this,ivector(rv)); }
	INLINE cimatrix_subv &cimatrix_subv::operator =(const interval &r) noexcept { return _mvsassign(*this,r); }
	...
	INLINE cimatrix &cimatrix::operator =(const cinterval &r) noexcept { return _msassign(*this,r); }
	INLINE cimatrix &cimatrix::operator =(const cimatrix &m) noexcept { return _mmassign<cimatrix,cimatrix,cinterval>(*this,m,cinterval()); }
	INLINE cimatrix &cimatrix::operator =(const cimatrix_slice &ms) noexcept { return _mmsassign<cimatrix,cimatrix_slice,cinterval>(*this,ms); }
	INLINE cimatrix &cimatrix::operator =(const civector &v) noexcept { return _mvassign<cimatrix,civector,cinterval>(*this,v); }
	INLINE cimatrix &cimatrix::operator =(const civector_slice &v) noexcept { return _mvassign<cimatrix,civector,cinterval>(*this,civector(v)); }
	
	INLINE cimatrix &cimatrix::operator =(const real &r) noexcept { return _msassign(*this,cinterval(r)); }
	INLINE cimatrix &cimatrix::operator =(const rmatrix &m) noexcept { return _mmassign<cimatrix,rmatrix,cinterval>(*this,m,cinterval()); }
	INLINE cimatrix &cimatrix::operator =(const rmatrix_slice &ms) noexcept { return _mmsassign<cimatrix,rmatrix_slice,cinterval>(*this,ms); }
	INLINE cimatrix &cimatrix::operator =(const rvector &v) noexcept { return _mvassign<cimatrix,rvector,cinterval>(*this,v); }
	INLINE cimatrix &cimatrix::operator =(const rvector_slice &v) noexcept { return _mvassign<cimatrix,rvector,cinterval>(*this,rvector(v)); }
	
	INLINE cimatrix &cimatrix::operator =(const complex &r) noexcept { return _msassign(*this,cinterval(r)); }
	INLINE cimatrix &cimatrix::operator =(const cmatrix &m) noexcept { return _mmassign<cimatrix,cmatrix,cinterval>(*this,m,cinterval()); }
	INLINE cimatrix &cimatrix::operator =(const cmatrix_slice &ms) noexcept { return _mmsassign<cimatrix,cmatrix_slice,cinterval>(*this,ms); }
	INLINE cimatrix &cimatrix::operator =(const cvector &v) noexcept { return _mvassign<cimatrix,cvector,cinterval>(*this,v); }
	INLINE cimatrix &cimatrix::operator =(const cvector_slice &v) noexcept { return _mvassign<cimatrix,cvector,cinterval>(*this,cvector(v)); }
	
	INLINE cimatrix &cimatrix::operator =(const interval &r) noexcept { return _msassign(*this,cinterval(r)); }
	INLINE cimatrix &cimatrix::operator =(const imatrix &m) noexcept { return _mmassign<cimatrix,imatrix,cinterval>(*this,m,cinterval()); }
	INLINE cimatrix &cimatrix::operator =(const imatrix_slice &ms) noexcept { return _mmsassign<cimatrix,imatrix_slice,cinterval>(*this,ms); }
	INLINE cimatrix &cimatrix::operator =(const ivector &v) noexcept { return _mvassign<cimatrix,ivector,cinterval>(*this,v); }
	INLINE cimatrix &cimatrix::operator =(const ivector_slice &v) noexcept { return _mvassign<cimatrix,ivector,cinterval>(*this,ivector(v)); }
	
	INLINE cimatrix::operator void*() noexcept { return _mvoid(*this); }
	...
	INLINE cimatrix_slice &cimatrix_slice::operator =(const cinterval &r) noexcept { return _mssassign(*this,r); }
...
#endif
	{ return _msmsassign(*this,ms); }
	INLINE cimatrix_slice &cimatrix_slice::operator =(const real &r) noexcept { return _mssassign(*this,r); }
...
#endif
	{ return _msmsassign(*this,ms); }
	INLINE cimatrix_slice &cimatrix_slice::operator =(const complex &r) noexcept { return _mssassign(*this,r); }
...
#endif
	{ return _msmsassign(*this,ms); }
	INLINE cimatrix_slice &cimatrix_slice::operator =(const interval &r) noexcept { return _mssassign(*this,r); }
	...
	INLINE cimatrix_slice::operator void*() noexcept { return _msvoid(*this); }
	INLINE civector operator /(const cimatrix_subv &rv, const cinterval &s) noexcept { return _mvsdiv<cimatrix_subv,cinterval,civector>(rv,s); }
	INLINE civector operator *(const cimatrix_subv &rv, const cinterval &s) noexcept { return _mvsmult<cimatrix_subv,cinterval,civector>(rv,s); }
	INLINE civector operator *(const cinterval &s, const cimatrix_subv &rv) noexcept { return _mvsmult<cimatrix_subv,cinterval,civector>(rv,s); }
	INLINE cimatrix_subv &cimatrix_subv::operator *=(const cinterval &c) noexcept { return _mvsmultassign(*this,c); }
	INLINE cimatrix_subv &cimatrix_subv::operator +=(const cinterval &c) noexcept { return _mvsplusassign(*this,c); }
	INLINE cimatrix_subv &cimatrix_subv::operator -=(const cinterval &c) noexcept { return _mvsminusassign(*this,c); }
	INLINE cimatrix_subv &cimatrix_subv::operator /=(const cinterval &c) noexcept { return _mvsdivassign(*this,c); }
	INLINE ivector abs(const cimatrix_subv &mv) noexcept { return _mvabs<cimatrix_subv,ivector>(mv); }
	INLINE cvector diam(const cimatrix_subv &mv) noexcept { return _mvdiam<cimatrix_subv,cvector>(mv); }
	INLINE cvector mid(const cimatrix_subv &mv) noexcept { return _mvmid<cimatrix_subv,cvector>(mv); }
	INLINE cvector Inf(const cimatrix_subv &mv) noexcept { return _mvinf<cimatrix_subv,cvector>(mv); }
	INLINE cvector Sup(const cimatrix_subv &mv) noexcept { return _mvsup<cimatrix_subv,cvector>(mv); }
	INLINE ivector Im(const cimatrix_subv &mv) noexcept { return _mvim<cimatrix_subv,ivector>(mv); }
	INLINE ivector Re(const cimatrix_subv &mv) noexcept { return _mvre<cimatrix_subv,ivector>(mv); }

	INLINE rmatrix InfRe(const cimatrix &m) noexcept
	{
	...
	INLINE rmatrix InfRe(const cimatrix_slice &sl) noexcept
	{
	...
	INLINE rmatrix SupRe(const cimatrix &m) noexcept
	{
		rmatrix erg(m.lb1,m.lb2,m.ub1,m.ub2);
	...
	INLINE rmatrix SupRe(const cimatrix_slice &sl) noexcept
	{
		rmatrix erg(sl.start1,sl.start2,sl.end1,sl.end2);
	...
	INLINE rmatrix InfIm(const cimatrix &m) noexcept
	{
		rmatrix erg(m.lb1,m.lb2,m.ub1,m.ub2);
	...
	INLINE rmatrix InfIm(const cimatrix_slice &sl) noexcept
	{
		rmatrix erg(sl.start1,sl.start2,sl.end1,sl.end2);
	...
	INLINE rmatrix SupIm(const cimatrix &m) noexcept
	{
		rmatrix erg(m.lb1,m.lb2,m.ub1,m.ub2);
	...
	INLINE rmatrix SupIm(const cimatrix_slice &sl) noexcept
	{
		rmatrix erg(sl.start1,sl.start2,sl.end1,sl.end2);
	...
	INLINE cimatrix_subv &SetSup(cimatrix_subv &iv,const complex &r) noexcept { return _mvssetsup(iv,r); }
	INLINE cimatrix_subv &SetInf(cimatrix_subv &iv,const complex &r) noexcept { return _mvssetinf(iv,r); }
	INLINE cimatrix_subv &UncheckedSetSup(cimatrix_subv &iv,const complex &r) noexcept { return _mvsusetsup(iv,r); }
	INLINE cimatrix_subv &SetUncheckedInf(cimatrix_subv &iv,const complex &r) noexcept { return _mvsusetinf(iv,r); }
	INLINE cimatrix_subv &SetRe(cimatrix_subv &iv,const interval &r) noexcept { return _mvssetre(iv,r); }
	INLINE cimatrix_subv &SetIm(cimatrix_subv &iv,const interval &r) noexcept { return _mvssetim(iv,r); }
	INLINE civector &civector::operator =(const cimatrix_subv &mv) noexcept { return _vmvassign<civector,cimatrix_subv,cinterval>(*this,mv); }
	INLINE civector_slice &civector_slice::operator =(const cimatrix_subv &mv) noexcept { return _vsvassign(*this,civector(mv)); }
...
//  matrix x matrix
	...
	*/
	INLINE cimatrix _imatrix(const cimatrix &rm) noexcept { return rm; }
	/*!
	\deprecated use standard contructors for typecasting

	\sa cxsc::cimatrix::cimatrix(const civector &v)
	*/
	INLINE cimatrix _imatrix(const civector &v) noexcept { return cimatrix(v); }
	/*!
	\deprecated use standard contructors for typecasting

	\sa cxsc::cimatrix::cimatrix(const civector_slice &v)
	*/
	INLINE cimatrix _imatrix(const civector_slice &v) noexcept { return cimatrix(v); }
	/*!
	\deprecated use standard contructors for typecasting

	\sa cxsc::cimatrix::cimatrix(const cinterval &r)
	*/
	INLINE cimatrix _imatrix(const cinterval &r) noexcept { return cimatrix(r); }
	...
	INLINE void Resize(cimatrix &A) noexcept { _mresize(A);}
	...
	INLINE imatrix abs(const cimatrix &m) noexcept { return _mabs<cimatrix,imatrix>(m); }
	INLINE imatrix abs(const cimatrix_slice &ms) noexcept { return _msabs<cimatrix_slice,imatrix>(ms); }
	INLINE cmatrix diam(const cimatrix &m) noexcept { return _mdiam<cimatrix,cmatrix>(m); }
	INLINE cmatrix diam(const cimatrix_slice &m) noexcept { return _msdiam<cimatrix_slice,cmatrix>(m); }
	INLINE cmatrix mid(const cimatrix &m) noexcept { return _mmid<cimatrix,cmatrix>(m); }
	INLINE cmatrix mid(const cimatrix_slice &m) noexcept { return _msmid<cimatrix_slice,cmatrix>(m); }
	INLINE cmatrix Inf(const cimatrix &m) noexcept { return _minf<cimatrix,cmatrix>(m); }
	INLINE cmatrix Sup(const cimatrix &m) noexcept { return _msup<cimatrix,cmatrix>(m); }
	INLINE cmatrix Inf(const cimatrix_slice &m) noexcept { return _msinf<cimatrix_slice,cmatrix>(m); }
	INLINE cmatrix Sup(const cimatrix_slice &m) noexcept { return _mssup<cimatrix_slice,cmatrix>(m); }
	...
	INLINE imatrix Im(const cimatrix &m) noexcept { return _mim<cimatrix,imatrix>(m); }
	INLINE imatrix Re(const cimatrix &m) noexcept { return _mre<cimatrix,imatrix>(m); }
	INLINE imatrix Im(const cimatrix_slice &m) noexcept { return _msim<cimatrix_slice,imatrix>(m); }
	INLINE imatrix Re(const cimatrix_slice &m) noexcept { return _msre<cimatrix_slice,imatrix>(m); }
...
#endif
	{ _smconstr(*this,m); }
//	INLINE cinterval cinterval::_interval(const cimatrix &m) noexcept(false) { _smconstr(*this,m); return *this; }

	INLINE cimatrix_subv &cimatrix_subv::operator *=(const real &c) noexcept { return _mvsmultassign(*this,c); }
	INLINE cimatrix_subv &cimatrix_subv::operator +=(const real &c) noexcept { return _mvsplusassign(*this,c); }
	INLINE cimatrix_subv &cimatrix_subv::operator -=(const real &c) noexcept { return _mvsminusassign(*this,c); }
	INLINE cimatrix_subv &cimatrix_subv::operator /=(const real &c) noexcept { return _mvsdivassign(*this,c); }
	...
	INLINE cimatrix_subv &cimatrix_subv::operator *=(const complex &c) noexcept { return _mvsmultassign(*this,c); }
	INLINE cimatrix_subv &cimatrix_subv::operator +=(const complex &c) noexcept { return _mvsplusassign(*this,c); }
	INLINE cimatrix_subv &cimatrix_subv::operator -=(const complex &c) noexcept { return _mvsminusassign(*this,c); }
	INLINE cimatrix_subv &cimatrix_subv::operator /=(const complex &c) noexcept { return _mvsdivassign(*this,c); }
	...
	INLINE cimatrix_subv &cimatrix_subv::operator *=(const interval &c) noexcept { return _mvsmultassign(*this,c); }
	INLINE cimatrix_subv &cimatrix_subv::operator +=(const interval &c) noexcept { return _mvsplusassign(*this,c); }
	INLINE cimatrix_subv &cimatrix_subv::operator -=(const interval &c) noexcept { return _mvsminusassign(*this,c); }
	INLINE cimatrix_subv &cimatrix_subv::operator /=(const interval &c) noexcept { return _mvsdivassign(*this,c); }
	...
	INLINE cimatrix operator *(const cinterval &c, const cimatrix &m) noexcept { return _smmult<cinterval,cimatrix,cimatrix>(c,m); }
	INLINE cimatrix operator *(const cinterval &c, const cimatrix_slice &ms) noexcept { return _smsmult<cinterval,cimatrix_slice,cimatrix>(c,ms); }
	INLINE cimatrix operator *(const cimatrix &m,const cinterval &c) noexcept { return _smmult<cinterval,cimatrix,cimatrix>(c,m); }
	INLINE cimatrix operator *(const cimatrix_slice &ms,const cinterval &c) noexcept { return _smsmult<cinterval,cimatrix_slice,cimatrix>(c,ms); }
	INLINE cimatrix &operator *=(cimatrix &m,const cinterval &c) noexcept { return _msmultassign(m,c); }
	INLINE cimatrix_slice &cimatrix_slice::operator *=(const cimatrix &m)
#if(CXSC_INDEX_CHECK)
	noexcept(false)
#else
...
#endif
	{ return (*this=*this*m); }
	INLINE cimatrix_slice &cimatrix_slice::operator *=(const cinterval &c) noexcept { return _mssmultassign(*this,c); }
	INLINE cimatrix operator /(const cimatrix &m,const cinterval &c) noexcept { return _msdiv<cimatrix,cinterval,cimatrix>(m,c); }
	INLINE cimatrix operator /(const cimatrix_slice &ms, const cinterval &c) noexcept { return _mssdiv<cimatrix_slice,cinterval,cimatrix>(ms,c); }
	INLINE cimatrix &operator /=(cimatrix &m,const cinterval &c) noexcept { return _msdivassign(m,c); }
	INLINE cimatrix_slice &cimatrix_slice::operator /=(const cinterval &c) noexcept { return _mssdivassign(*this,c); }
	
	INLINE cimatrix operator *(const real &c, const cimatrix &m) noexcept { return _smmult<real,cimatrix,cimatrix>(c,m); }
	INLINE cimatrix operator *(const real &c, const cimatrix_slice &ms) noexcept { return _smsmult<real,cimatrix_slice,cimatrix>(c,ms); }
	INLINE cimatrix operator *(const cimatrix &m,const real &c) noexcept { return _smmult<real,cimatrix,cimatrix>(c,m); }
	INLINE cimatrix operator *(const cimatrix_slice &ms,const real &c) noexcept { return _smsmult<real,cimatrix_slice,cimatrix>(c,ms); }
	INLINE cimatrix &operator *=(cimatrix &m,const real &c) noexcept { return _msmultassign(m,c); }
	INLINE cimatrix_slice &cimatrix_slice::operator *=(const rmatrix &m)
#if(CXSC_INDEX_CHECK)
	noexcept(false)
#else
...
#endif
	{ return (*this=*this*m); }
	INLINE cimatrix_slice &cimatrix_slice::operator *=(const real &c) noexcept { return _mssmultassign(*this,c); }
	INLINE cimatrix operator /(const cimatrix &m,const real &c) noexcept { return _msdiv<cimatrix,real,cimatrix>(m,c); }
	INLINE cimatrix operator /(const cimatrix_slice &ms, const real &c) noexcept { return _mssdiv<cimatrix_slice,real,cimatrix>(ms,c); }
	INLINE cimatrix &operator /=(cimatrix &m,const real &c) noexcept { return _msdivassign(m,c); }
	INLINE cimatrix_slice &cimatrix_slice::operator /=(const real &c) noexcept { return _mssdivassign(*this,c); }

	INLINE cimatrix operator *(const complex &c, const cimatrix &m) noexcept { return _smmult<complex,cimatrix,cimatrix>(c,m); }
	INLINE cimatrix operator *(const complex &c, const cimatrix_slice &ms) noexcept { return _smsmult<complex,cimatrix_slice,cimatrix>(c,ms); }
	INLINE cimatrix operator *(const cimatrix &m,const complex &c) noexcept { return _smmult<complex,cimatrix,cimatrix>(c,m); }
	INLINE cimatrix operator *(const cimatrix_slice &ms,const complex &c) noexcept { return _smsmult<complex,cimatrix_slice,cimatrix>(c,ms); }
	INLINE cimatrix &operator *=(cimatrix &m,const complex &c) noexcept { return _msmultassign(m,c); }
	INLINE cimatrix_slice &cimatrix_slice::operator *=(const cmatrix &m)
#if(CXSC_INDEX_CHECK)
	noexcept(false)
#else
...
#endif
	{ return (*this=*this*m); }
	INLINE cimatrix_slice &cimatrix_slice::operator *=(const complex &c) noexcept { return _mssmultassign(*this,c); }
	INLINE cimatrix operator /(const cimatrix &m,const complex &c) noexcept { return _msdiv<cimatrix,complex,cimatrix>(m,c); }
	INLINE cimatrix operator /(const cimatrix_slice &ms, const complex &c) noexcept { return _mssdiv<cimatrix_slice,complex,cimatrix>(ms,c); }
	INLINE cimatrix &operator /=(cimatrix &m,const complex &c) noexcept { return _msdivassign(m,c); }
	INLINE cimatrix_slice &cimatrix_slice::operator /=(const complex &c) noexcept { return _mssdivassign(*this,c); }

	INLINE cimatrix operator *(const interval &c, const cimatrix &m) noexcept { return _smmult<interval,cimatrix,cimatrix>(c,m); }
	INLINE cimatrix operator *(const interval &c, const cimatrix_slice &ms) noexcept { return _smsmult<interval,cimatrix_slice,cimatrix>(c,ms); }
	INLINE cimatrix operator *(const cimatrix &m,const interval &c) noexcept { return _smmult<interval,cimatrix,cimatrix>(c,m); }
	INLINE cimatrix operator *(const cimatrix_slice &ms,const interval &c) noexcept { return _smsmult<interval,cimatrix_slice,cimatrix>(c,ms); }
	INLINE cimatrix &operator *=(cimatrix &m,const interval &c) noexcept { return _msmultassign(m,c); }
	INLINE cimatrix_slice &cimatrix_slice::operator *=(const imatrix &m)
#if(CXSC_INDEX_CHECK)
	noexcept(false)
#else
...
#endif
	{ return (*this=*this*m); }
	INLINE cimatrix_slice &cimatrix_slice::operator *=(const interval &c) noexcept { return _mssmultassign(*this,c); }
	INLINE cimatrix operator /(const cimatrix &m,const interval &c) noexcept { return _msdiv<cimatrix,interval,cimatrix>(m,c); }
	INLINE cimatrix operator /(const cimatrix_slice &ms, const interval &c) noexcept { return _mssdiv<cimatrix_slice,interval,cimatrix>(ms,c); }
	INLINE cimatrix &operator /=(cimatrix &m,const interval &c) noexcept { return _msdivassign(m,c); }
	INLINE cimatrix_slice &cimatrix_slice::operator /=(const interval &c) noexcept { return _mssdivassign(*this,c); }

//	INLINE cinterval::cinterval(const rmatrix &m) noexcept(false) { _smconstr(*this,m); }
//	INLINE cinterval cinterval::_interval(const cimatrix &m) noexcept(false) { _smconstr(*this,m); return *this; }

	INLINE cimatrix operator *(const cinterval &c, const rmatrix &m) noexcept { return _smmult<cinterval,rmatrix,cimatrix>(c,m); }
	INLINE cimatrix operator *(const cinterval &c, const rmatrix_slice &ms) noexcept { return _smsmult<cinterval,rmatrix_slice,cimatrix>(c,ms); }
	INLINE cimatrix operator *(const rmatrix &m,const cinterval &c) noexcept { return _smmult<cinterval,rmatrix,cimatrix>(c,m); }
	INLINE cimatrix operator *(const rmatrix_slice &ms,const cinterval &c) noexcept { return _smsmult<cinterval,rmatrix_slice,cimatrix>(c,ms); }
	INLINE cimatrix operator /(const rmatrix &m,const cinterval &c) noexcept { return _msdiv<rmatrix,cinterval,cimatrix>(m,c); }
	INLINE cimatrix operator /(const rmatrix_slice &ms, const cinterval &c) noexcept { return _mssdiv<rmatrix_slice,cinterval,cimatrix>(ms,c); }

	INLINE cimatrix operator *(const cinterval &c, const cmatrix &m) noexcept { return _smmult<cinterval,cmatrix,cimatrix>(c,m); }
	INLINE cimatrix operator *(const cinterval &c, const cmatrix_slice &ms) noexcept { return _smsmult<cinterval,cmatrix_slice,cimatrix>(c,ms); }
	INLINE cimatrix operator *(const cmatrix &m,const cinterval &c) noexcept { return _smmult<cinterval,cmatrix,cimatrix>(c,m); }
	INLINE cimatrix operator *(const cmatrix_slice &ms,const cinterval &c) noexcept { return _smsmult<cinterval,cmatrix_slice,cimatrix>(c,ms); }
	INLINE cimatrix operator /(const cmatrix &m,const cinterval &c) noexcept { return _msdiv<cmatrix,cinterval,cimatrix>(m,c); }
	INLINE cimatrix operator /(const cmatrix_slice &ms, const cinterval &c) noexcept { return _mssdiv<cmatrix_slice,cinterval,cimatrix>(ms,c); }

	INLINE cimatrix operator *(const cinterval &c, const imatrix &m) noexcept { return _smmult<cinterval,imatrix,cimatrix>(c,m); }
	INLINE cimatrix operator *(const cinterval &c, const imatrix_slice &ms) noexcept { return _smsmult<cinterval,imatrix_slice,cimatrix>(c,ms); }
	INLINE cimatrix operator *(const imatrix &m,const cinterval &c) noexcept { return _smmult<cinterval,imatrix,cimatrix>(c,m); }
	INLINE cimatrix operator *(const imatrix_slice &ms,const cinterval &c) noexcept { return _smsmult<cinterval,imatrix_slice,cimatrix>(c,ms); }
	INLINE cimatrix operator /(const imatrix &m,const cinterval &c) noexcept { return _msdiv<imatrix,cinterval,cimatrix>(m,c); }
	INLINE cimatrix operator /(const imatrix_slice &ms, const cinterval &c) noexcept { return _mssdiv<imatrix_slice,cinterval,cimatrix>(ms,c); }
	...
	INLINE const cimatrix &operator +(const cimatrix &m) noexcept { return m; }
	INLINE cimatrix operator +(const cimatrix_slice &m) noexcept { return cimatrix(m); }
	...
	INLINE cimatrix operator -(const cimatrix &m) noexcept { return _mminus(m); }
	INLINE cimatrix operator -(const cimatrix_slice &m) noexcept { return _msminus<cimatrix_slice,cimatrix>(m); }
	INLINE cimatrix operator -(const cimatrix &m1,const cimatrix &m2)
#if(CXSC_INDEX_CHECK)
	noexcept(false)
#else
...
//------------- complex x complex ------------------------
	...
	INLINE bool operator ==(const cimatrix &m1,const cimatrix &m2) noexcept { return _mmeq(m1,m2); }
	INLINE bool operator !=(const cimatrix &m1,const cimatrix &m2) noexcept { return _mmneq(m1,m2); }
	INLINE bool operator <(const cimatrix &m1,const cimatrix &m2) noexcept { return _mmless(m1,m2); }
	INLINE bool operator <=(const cimatrix &m1,const cimatrix &m2) noexcept { return _mmleq(m1,m2); }
	INLINE bool operator >(const cimatrix &m1,const cimatrix &m2) noexcept { return _mmless(m2,m1); }
	INLINE bool operator >=(const cimatrix &m1,const cimatrix &m2) noexcept { return _mmleq(m2,m1); }
	INLINE bool operator ==(const cimatrix &m1,const cimatrix_slice &ms) noexcept { return _mmseq(m1,ms); }
	INLINE bool operator !=(const cimatrix &m1,const cimatrix_slice &ms) noexcept { return _mmsneq(m1,ms); }
	INLINE bool operator <(const cimatrix &m1,const cimatrix_slice &ms) noexcept { return _mmsless(m1,ms); }
	INLINE bool operator <=(const cimatrix &m1,const cimatrix_slice &ms) noexcept { return _mmsleq(m1,ms); }
	INLINE bool operator >(const cimatrix &m1,const cimatrix_slice &ms) noexcept { return _msmless(ms,m1); }
	INLINE bool operator >=(const cimatrix &m1,const cimatrix_slice &ms) noexcept { return _msmleq(ms,m1); }
	INLINE bool operator ==(const cimatrix_slice &m1,const cimatrix_slice &m2) noexcept { return _msmseq(m1,m2); }
	INLINE bool operator !=(const cimatrix_slice &m1,const cimatrix_slice &m2) noexcept { return _msmsneq(m1,m2); }
	INLINE bool operator <(const cimatrix_slice &m1,const cimatrix_slice &m2) noexcept { return _msmsless(m1,m2); }
	INLINE bool operator <=(const cimatrix_slice &m1,const cimatrix_slice &m2) noexcept { return _msmsleq(m1,m2); }
	INLINE bool operator >(const cimatrix_slice &m1,const cimatrix_slice &m2) noexcept { return _msmsless(m2,m1); }
	INLINE bool operator >=(const cimatrix_slice &m1,const cimatrix_slice &m2) noexcept { return _msmsleq(m2,m1); }
	INLINE bool operator !(const cimatrix &ms) noexcept { return _mnot(ms); }
	INLINE bool operator !(const cimatrix_slice &ms) noexcept { return _msnot(ms); }
	INLINE std::ostream &operator <<(std::ostream &s,const cimatrix &r) noexcept { return _mout(s,r); }
	INLINE std::ostream &operator <<(std::ostream &s,const cimatrix_slice &r) noexcept { return _msout(s,r); }
	INLINE std::istream &operator >>(std::istream &s,cimatrix &r) noexcept { return _min(s,r); }
	INLINE std::istream &operator >>(std::istream &s,cimatrix_slice &r) noexcept { return _msin(s,r); }
