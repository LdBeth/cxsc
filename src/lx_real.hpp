...
namespace cxsc {
   ...
   //! Returns 1 if x is an integer value and if \f$ |x|\le 2^{53}-1 \f$ 
    ...
    //! Constructor of class lx_real
			lx_real(void)  noexcept {}
    //! Constructor of class lx_real
			lx_real(const real& n, const l_real &a) noexcept 
			{ 
				if ( !(Is_Integer(n)) ) 
    ...
    //! Constructor of class lx_real
			lx_real(const real& n, const real &a) noexcept 
			{ 
				if ( !(Is_Integer(n)) ) 
    ...
    //! Constructor of class lx_real
			explicit lx_real(const l_real &a) noexcept : ex(0), lr(a) { }
    //! Constructor of class lx_real
			explicit lx_real(const real &a)   noexcept : ex(0), lr(a) { }
	 //! Constructor of class lx_real
			lx_real(const real&, const string&) noexcept;


    // ------------- Assignments ---------------------------------------------
	 
    //! Implementation of standard assigning operator
			inline lx_real & operator = (const lx_real &) noexcept;
	 //! Implementation of standard assigning operator
			inline lx_real & operator = (const l_real &)  noexcept;
	 //! Implementation of standard assigning operator
			inline lx_real & operator = (const real &)    noexcept;

    // ------------- Functions -----------------------------------------------

	 //! Returns the precision of a lx_real value
			friend inline int StagPrec(const lx_real&) noexcept; 
	 //! Returns the exponent a.ex of a lx_real value a
			friend inline real expo(const lx_real&) noexcept;
	 //! Returns the sign of a lx_real value
			friend inline int sign(const lx_real&) noexcept;
	 //! Returns the l_real component a.lr of a lx_real value a
			friend inline l_real lr_part(const lx_real&) noexcept;
	 //! Returns the absolute value of a lx_real value a
			friend inline lx_real abs(const lx_real&) noexcept;
	 //! Scaling a.lr upwards and keeps the value of a unchanged
			friend void scale_up  (lx_real &) noexcept;
	 //! Scaling a.lr downwards and keeps the value of a unchanged
			friend void scale_down(lx_real &) noexcept;
	 //! matches the precision of an lx_real value to the actual stagprec value
			friend inline lx_real adjust(const lx_real &) noexcept;

	 //! Returns 1 if \f$ a=0 \f$ and 0 otherwise
			friend inline bool eq_zero (const lx_real &a) noexcept; // a = 0;
	 //! Returns 1 if \f$ a>0 \f$ and 0 otherwise
			friend inline bool gr_zero (const lx_real &a) noexcept; // a > 0;
	 //! Returns 1 if \f$ a\ge0 \f$ and 0 otherwise
			friend inline bool ge_zero (const lx_real &a) noexcept; // a >=0;
	 //! Returns 1 if \f$ a<0 \f$ and 0 otherwise
			friend inline bool sm_zero (const lx_real &a) noexcept; // a < 0;
	 //! Returns 1 if \f$ a\le0 \f$ and 0 otherwise
			friend inline bool se_zero (const lx_real &a) noexcept; // a <=0;
	 
	 //! Multiplication with \f$ 2^r; \f$ the real value r must be an integer
			friend inline void times2pown(lx_real &, const real &) noexcept;
	 //! Multiplication with \f$ 2^r; \f$ the real value r must be a negative integer
			friend inline void times2pown_neg(lx_real& a, const real& n) noexcept;
	 //! Implementation of standard negation operation
			friend inline bool operator ! (const lx_real &) noexcept;
    //! Implementation of standard algebraic negative sign operation
			friend inline lx_real operator -(const lx_real &) noexcept;


// ----------------------- Output --------------------------------------------

//friend inline std::ostream& operator << (std::ostream& s, const lx_real& a) 
//    noexcept; // A value a of type lx_real is written to the output channel.
...
inline int StagPrec(const lx_real&) noexcept;
inline real expo(const lx_real&) noexcept;
inline int sign(const lx_real&) noexcept;
inline l_real lr_part(const lx_real&) noexcept;
inline lx_real abs(const lx_real&) noexcept;
inline lx_real adjust(const lx_real &) noexcept;
inline void times2pown_neg(lx_real&, const real&) noexcept;

       void scale_up  (lx_real&)   noexcept;
		 void scale_down(lx_real &a) noexcept;

		 inline bool eq_zero (const lx_real &a) noexcept; // a = 0;
		 inline bool gr_zero (const lx_real &a) noexcept; // a > 0;
		 inline bool ge_zero (const lx_real &a) noexcept; // a >=0;
		 inline bool sm_zero (const lx_real &a) noexcept; // a < 0;
		 inline bool se_zero (const lx_real &a) noexcept; // a <=0;

		 inline void times2pown(lx_real &, const real &) noexcept;
		 inline bool operator ! (const lx_real &) noexcept;
...
//! Implementation of standard input method
		 string & operator >> (string &s, lx_real &a) noexcept;
//! Implementation of standard input method
		 void operator >> (const string &s, lx_real &a) noexcept;
//! Implementation of standard input method
		 void operator >> (const char *s, lx_real&) noexcept;
//! Implementation of standard input method
		 std::istream & operator >> (std::istream &s, lx_real &a) noexcept;
...
//! Returns \f$ a+b; \f$ a,b must be integers with \f$ |a|,|b|\le2^{53}. \f$
		 inline real add_real(const real &a, const real &b) noexcept;

//! Returns \f$ a-b; \f$ a,b must be integers with \f$ |a|,|b|\le2^{53}. \f$
		 inline real sub_real(const real &a, const real &b) noexcept;
...
//! Implementation of standard algebraic addition operation
		 lx_real operator + (const lx_real &, const lx_real &) noexcept;
//! Implementation of standard algebraic addition operation
		 inline lx_real operator + (const lx_real&, const l_real &) noexcept;
//! Implementation of standard algebraic addition operation
		 inline lx_real operator + (const l_real&, const lx_real &) noexcept;
//! Implementation of standard algebraic addition operation
		 inline lx_real operator + (const lx_real&, const real &) noexcept;
//! Implementation of standard algebraic addition operation
		 inline lx_real operator + (const real&, const lx_real &) noexcept;

//! Implementation of standard algebraic addition and allocation operation
		 inline lx_real & operator +=(lx_real &, const lx_real &) noexcept;
//! Implementation of standard algebraic addition and allocation operation
		 inline lx_real & operator +=(lx_real &, const l_real &) noexcept;
//! Implementation of standard algebraic addition and allocation operation
		 inline lx_real & operator +=(lx_real &, const real &) noexcept;

//! Implementation of standard algebraic subtraction operation
		 inline lx_real operator - (const lx_real &, const lx_real &) noexcept;
//! Implementation of standard algebraic subtraction operation
		 inline lx_real operator - (const lx_real &, const l_real &) noexcept;
//! Implementation of standard algebraic subtraction operation
		 inline lx_real operator - (const l_real &, const lx_real &) noexcept;
...
//! Implementation of standard equality operation
		 bool operator == (const lx_real &, const lx_real &) noexcept;
//! Implementation of standard equality operation
		 inline bool operator == (const lx_real &, const l_real &) noexcept;
//! Implementation of standard equality operation
		 inline bool operator == (const l_real &, const lx_real &) noexcept;
//! Implementation of standard equality operation
		 inline bool operator == (const lx_real &, const real &)   noexcept;
//! Implementation of standard equality operation
		 inline bool operator == (const real &,   const lx_real &) noexcept;

//! Implementation of standard negated equality operation
		 inline bool operator != (const lx_real &, const lx_real &) noexcept;
//! Implementation of standard negated equality operation
		 inline bool operator != (const lx_real &, const l_real &) noexcept;
//! Implementation of standard negated equality operation
		 inline bool operator != (const l_real &, const lx_real &) noexcept;
...
//! Returns the truncated integer part of x.
		 inline real cutint(const real& x) noexcept;

// ------------------- lx_real Constants ------------------------------------

    //! lx_real approximation for \f$ \pi \f$
		 lx_real Pi_lx_real() noexcept; // pi
	 //! lx_real approximation for \f$ \pi^2 \f$
		 lx_real Pip2_lx_real() noexcept; // pi^2
	 //! lx_real approximation for \f$ 2\pi \f$
		 lx_real Pi2_lx_real() noexcept; // 2*pi
	 //! lx_real approximation for \f$ \frac{\pi}{4} \f$
		 lx_real Pid4_lx_real() noexcept; // Pi/4
	 //! lx_real approximation for \f$ \frac{\pi}{2} \f$
		 lx_real Pid2_lx_real() noexcept; // Pi/2
    ...
    //! lx_real approximation for \f$ \frac{1}{\pi} \f$
	 ...
	 //! lx_real approximation for \f$ \frac{1}{2\pi} \f$
		 lx_real Pi2r_lx_real() noexcept;  // 1/(2*pi)
...
//! Calculates \f$ \sqrt{[x]}  \f$
 lx_real sqrt(const lx_real&) noexcept;
//! Calculates \f$ [x]^2  \f$
 lx_real sqr(const lx_real&) noexcept;
//! Calculates \f$ \ln([x]) \f$
 lx_real ln(const lx_real &) noexcept;
//! Calculates \f$ \log2([x]) \f$
 lx_real log2(const lx_real &) noexcept;
//! Calculates \f$ \log10([x]) \f$
 lx_real log10(const lx_real &) noexcept;
//! Calculates \f$ \ln(1+[x]) \f$
 lx_real lnp1(const lx_real &) noexcept;
//! Calculates \f$ \exp([x]) \f$
 lx_real exp(const lx_real &) noexcept;
//! Calculates \f$ 2^{[x]} \f$
 lx_real exp2(const lx_real &) noexcept; // 2^x
//! Calculates \f$ 10^{[x]} \f$
 lx_real exp10(const lx_real &) noexcept; // 10^x
//! Calculates \f$ \exp([x])-1 \f$
 lx_real expm1(const lx_real &x) noexcept; 
//! Calculates \f$ [x]^n \f$
 lx_real power(const lx_real &, const real &) noexcept;
//! Calculates \f$ [x]^{[y]} \f$
 lx_real pow(const lx_real &, const lx_real &) noexcept;
//! Calculates \f$ (1+[x])^{[y]} \f$
 lx_real xp1_pow_y(const lx_real &, const lx_real &) noexcept; 
//! Calculates \f$ \sin([x]) \f$
 lx_real sin(const lx_real &)noexcept;
//! Calculates \f$ \sin(n\cdot\pi+[x]) \f$
 lx_real sin_n(const lx_real &x, const real& n) noexcept;
//! Calculates \f$ \cos([x]) \f$
 lx_real cos(const lx_real &) noexcept;
//! Calculates \f$ \cos((n+1/2)\cdot\pi+[x]) \f$
 lx_real cos_n(const lx_real &x, const real& n) noexcept;
//! Calculates \f$ \tan([x]) \f$
 lx_real tan(const lx_real &) noexcept;
//! Calculates \f$ \cot([x]) \f$
 lx_real cot(const lx_real &) noexcept;
//! Calculates \f$ \sqrt{1+[x]^2} \f$
 lx_real sqrt1px2(const lx_real &) noexcept;
//! Calculates \f$ \arctan([x]) \f$
 lx_real atan(const lx_real &) noexcept;
//! Calculates \f$ \sqrt{1-[x]^2} \f$
 lx_real sqrt1mx2(const lx_real &) noexcept;
//! Calculates \f$ \sqrt{[x]^2-1} \f$
 lx_real sqrtx2m1(const lx_real &) noexcept;
//! Calculates \f$ \arcsin([x]) \f$
 lx_real asin(const lx_real & ) noexcept;
//! Calculates \f$ \arccos([x]) \f$
 lx_real acos(const lx_real &) noexcept;
//! Calculates \f$ \mbox{arccot}([x]) \f$
 lx_real acot(const lx_real &) noexcept;
//! Calculates \f$ \sinh([x]) \f$
 lx_real sinh(const lx_real &) noexcept;
//! Calculates \f$ \cosh([x]) \f$
 lx_real cosh(const lx_real &) noexcept;
//! Calculates \f$ \tanh([x]) \f$
 lx_real tanh(const lx_real &) noexcept;
//! Calculates \f$ \coth([x]) \f$
 lx_real coth(const lx_real &) noexcept;
//! Calculates \f$ \sqrt{([x]+1)-1} \f$
 lx_real sqrtp1m1(const lx_real &) noexcept;
//! Calculates \f$ \mbox{arcsinh}([x]) \f$
 lx_real asinh(const lx_real &) noexcept;
//! Calculates \f$ \mbox{arccosh}([x]) \f$
 lx_real acosh(const lx_real &) noexcept;
//! Calculates \f$ \mbox{arccosh}(1+[x]) \f$
 lx_real acoshp1(const lx_real &) noexcept;
//! Calculates \f$ \mbox{arctanh}([x]) \f$
 lx_real atanh(const lx_real &) noexcept;
//! Calculates \f$ \mbox{arctanh}(1-[x]) \f$
 lx_real atanh1m(const lx_real &) noexcept;
//! Calculates \f$ \mbox{arctanh}(-1+[x]) \f$
 lx_real atanhm1p(const lx_real &) noexcept;
//! Calculates \f$ \mbox{arccoth}([x]) \f$
 lx_real acoth(const lx_real &) noexcept;
//! Calculates \f$ \mbox{arccoth}(+1+[x]) \f$
 lx_real acothp1(const lx_real &) noexcept;
//! Calculates \f$ \mbox{arctanh}(-1-[x]) \f$
 lx_real acothm1m(const lx_real &) noexcept;
//! Calculates \f$ \sqrt{[x]^2 + [y]^2} \f$
 lx_real sqrtx2y2(const lx_real &, const lx_real &) noexcept;
//! Calculates \f$ \ln(\sqrt{[x]^2 + [y]^2}) \f$
 lx_real ln_sqrtx2y2(const lx_real &, const lx_real &) noexcept;
//! Calculates \f$ \sqrt[n]{[x]} \f$
 lx_real sqrt(const lx_real &, int) noexcept;
