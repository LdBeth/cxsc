...
#ifdef OLD_CXSC
	//! Constructor of class intvector
	explicit INLINE intvector(const class index &i) noexcept; // for backwards compatibility
#endif
	//! Constructor of class intvector
...
//	INLINE intvector _intvector(const intmatrix &m) noexcept(false);
//	INLINE intvector _intvector(const intmatrix_slice &sl) noexcept(false);
