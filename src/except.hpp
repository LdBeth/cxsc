...
//		virtual ~ERROR_INTERVAL() noexcept;
//	private:
//		string fkt;
};
...
//		virtual ~ERROR_COMPLEX() noexcept;
//	private:
//		string fkt;
};
...
//		virtual ~ERROR_CINTERVAL() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~ERROR_RVECTOR() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~ERROR_IVECTOR() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~ERROR_CVECTOR() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~ERROR_CIVECTOR() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~ERROR_RMATRIX() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~ERROR_IMATRIX() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~ERROR_CMATRIX() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~ERROR_CIMATRIX() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~ERROR_LINTERVAL() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~ERROR_LRVECTOR() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~ERROR_LIVECTOR() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~ERROR_LRMATRIX() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~ERROR_LIMATRIX() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~ERROR_INTVECTOR() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~ERROR_INTMATRIX() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~WRONG_ROUNDING() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~NO_MORE_MEMORY() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~WRONG_DOT_TYPE() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~NOT_AVAILABLE() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~EMPTY_INTERVAL() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~IN_EXACT_CH_OR_IS() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~WRONG_BOUNDARIES() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~SUB_ARRAY_TOO_BIG() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~RES_OR_INP_OF_TEMP_OBJ() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~ELEMENT_NOT_IN_VEC() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~ROW_OR_COL_NOT_IN_MAT() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~WRONG_ROW_OR_COL() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~TYPE_CAST_OF_THICK_OBJ() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~OP_WITH_WRONG_DIM() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~WRONG_STAGPREC() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~ELEMENT_NOT_IN_LONG() noexcept {!././compcxsc  }
//	private:
//		string fkt;
};
...
//		virtual ~STD_FKT_OUT_OF_DEF() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~USE_OF_UNINITIALIZED_OBJ() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual int errnum() const noexcept;
//		virtual string errtext() const noexcept;
//		CONTINUE_NOT_POSSIBLE() noexcept;
//// virtual ~}() noexcept { }
//		CONTINUE_NOT_POSSIBLE(const string &f) noexcept:fkt(f) { //}private:
//	string fkt;//
//};
...
//		virtual ~ERROR__ELEMENT_NOT_IN_VEC() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~ERROR__TYPE_CAST_OF_THICK_OBJ() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~ERROR__USE_OF_UNINITIALIZED_OBJ() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~ERROR__OP_WITH_WRONG_DIM() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~ERROR__WRONG_BOUNDARIES() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~ERROR__NO_MORE_MEMORY() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~ERROR__SUB_ARRAY_TOO_BIG() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~ERROR__ROW_OR_COL_NOT_IN_MAT() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~ERROR__WRONG_ROW_OR_COL() noexcept { }
//	private:
//		string fkt;
};
...
class ERROR__WRONG_BOUNDARIES<rvector>: virtual public ERROR_RVECTOR, virtual public WRONG_BOUNDARIES
{
	public:
		...
		ERROR__WRONG_BOUNDARIES() noexcept;
		ERROR__WRONG_BOUNDARIES(const string &f) noexcept;
//		virtual ~ERROR_RVECTOR_WRONG_BOUNDARIES() noexcept { }
//	private:
//		string fkt;
};
...
class ERROR__WRONG_BOUNDARIES<intvector>: virtual public ERROR_INTVECTOR, virtual public WRONG_BOUNDARIES
{
	public:
		...
		ERROR__WRONG_BOUNDARIES() noexcept  ;// { fkt="<unknown function>"; }
		ERROR__WRONG_BOUNDARIES(const string &f) noexcept  ;// { fkt=f; }
//		virtual ~ERROR_INTVECTOR_WRONG_BOUNDARIES() noexcept { }
//	private:
//		string fkt;
};
...
class ERROR__WRONG_BOUNDARIES<cvector>: virtual public ERROR_CVECTOR, virtual public WRONG_BOUNDARIES
{
	public:
		...
		ERROR__WRONG_BOUNDARIES() noexcept  ;// { fkt="<unknown function>"; }
		ERROR__WRONG_BOUNDARIES(const string &f) noexcept  ;// { fkt=f; }
//		virtual ~ERROR_CVECTOR_WRONG_BOUNDARIES() noexcept { }
//	private:
//		string fkt;
};
...
class ERROR__WRONG_BOUNDARIES<civector>: virtual public ERROR_CIVECTOR, virtual public WRONG_BOUNDARIES
{
	public:
		...
		ERROR__WRONG_BOUNDARIES() noexcept  ;// { fkt="<unknown function>"; }
		ERROR__WRONG_BOUNDARIES(const string &f) noexcept  ;// { fkt=f; }
//		virtual ~ERROR_CIVECTOR_WRONG_BOUNDARIES() noexcept { }
//	private:
//		string fkt;
};
...
class ERROR__WRONG_BOUNDARIES<l_rvector>: virtual public ERROR_LRVECTOR, virtual public WRONG_BOUNDARIES
{
	public:
		...
		ERROR__WRONG_BOUNDARIES() noexcept  ;// { fkt="<unknown function>"; }
		ERROR__WRONG_BOUNDARIES(const string &f) noexcept  ;// { fkt=f; }
//		virtual ~ERROR_LRVECTOR_WRONG_BOUNDARIES() noexcept { }
//	private:
//		string fkt;
};
...
class ERROR__WRONG_BOUNDARIES<l_ivector>: virtual public ERROR_LIVECTOR, virtual public WRONG_BOUNDARIES
{
	public:
		...
		ERROR__WRONG_BOUNDARIES() noexcept  ;// { fkt="<unknown function>"; }
		ERROR__WRONG_BOUNDARIES(const string &f) noexcept  ;// { fkt=f; }
//		virtual ~ERROR_LIVECTOR_WRONG_BOUNDARIES() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~ERROR_IDOTPRECISION_EMPTY_INTERVAL() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~ERROR_CIDOTPRECISION_EMPTY_INTERVAL() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~ERROR_INTERVAL_EMPTY_INTERVAL() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~ERROR_CINTERVAL_EMPTY_INTERVAL() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~ERROR_INTERVAL_STD_FKT_OUT_OF_DEF() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~ERROR_LREAL_STD_FKT_OUT_OF_DEF() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~ERROR_LINTERVAL_DIV_BY_ZERO() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~ERROR_LINTERVAL_EMPTY_INTERVAL() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~ERROR_LINTERVAL_IN_EXACT_CH_OR_IS() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~ERROR_LINTERVAL_WRONG_STAGPREC() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~ERROR_LINTERVAL_ELEMENT_NOT_IN_LONG() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~ERROR_LINTERVAL_STD_FKT_OUT_OF_DEF() noexcept { }
//	private:
//		string fkt;
};
...
//		virtual ~ERROR_LINTERVAL_FAK_OVERFLOW() noexcept { }
//	private:
//		string fkt;
};
