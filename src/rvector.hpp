...
template <class MV,class V> friend  MV &_mvvsetre(MV &v,const V &rv)
 ...
 template <class V,class MS,class E> friend 	 E _vmslimult(const V &v,const MS &ms)
	...
	INLINE rvector () noexcept;
	//! Constructor of class rvector
	explicit INLINE rvector(const int &i) noexcept;
#ifdef OLD_CXSC
	//! Constructor of class rvector
	explicit INLINE rvector(const class index &i) noexcept; // for backwards compatibility
#endif
	//! Constructor of class rvector
...
#endif
	//! Constructor of class rvector
	INLINE rvector(const rmatrix_subv &) noexcept;
	//! Constructor of class rvector
	explicit INLINE rvector(const real &) noexcept;
	//! Constructor of class rvector
	...
	//! Constructor of class rvector
	INLINE rvector(const rvector_slice &rs) noexcept;
	//! Constructor of class rvector
	INLINE rvector(const rvector &v) noexcept;
	//! Constructor of class rvector
	INLINE rvector(const srvector &v);
	//! Constructor of class rvector
	INLINE rvector(const srvector_slice &v);
	//! Implementation of standard assigning operator
	INLINE rvector &operator =(const rvector &rv) noexcept;
	//! Implementation of standard assigning operator
	INLINE rvector &operator =(const rvector_slice &sl) noexcept;
	//! Implementation of standard assigning operator
	INLINE rvector &operator =(const srvector &rv);
	//! Implementation of standard assigning operator
	INLINE rvector &operator =(const srvector_slice &sl);
	//! Implementation of standard assigning operator
	INLINE rvector &operator =(const real &r) noexcept;
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE rvector &operator =(const rmatrix_subv &) noexcept;
	...
	friend INLINE int Lb(const rvector &rv) noexcept { return rv.l; }
	//! Returns the upper bound of the vector
	friend INLINE int Ub(const rvector &rv) noexcept { return rv.u; }
	//! Returns the dimension of the vector
        friend INLINE int VecLen(const rvector &rv) noexcept { return rv.size; }
	//! Sets the lower bound of the vector
	friend INLINE rvector &SetLb(rvector &rv, const int &l) noexcept { rv.l=l; rv.u=l+rv.size-1; return rv; }
	//! Sets the upper bound of the vector
	friend INLINE rvector &SetUb(rvector &rv, const int &u) noexcept { rv.u=u; rv.l=u-rv.size+1; return rv; }
	...
	INLINE rvector & operator ()() noexcept { return *this; }
...
//------------------------- Templates -------------------------------------------
 ...
 template <class VS1,class VS2,class E> friend 	 E _vsvslimult(const VS1 & sl1, const VS2 &sl2)
	...
	explicit INLINE rvector_slice(rvector &a, const int &lb, const int &ub) noexcept:dat(a.dat),l(a.l),u(a.u),size(ub-lb+1),start(lb),end(ub) { }
	//! Constructor of class rvector_slice
	explicit INLINE rvector_slice(rvector_slice &a, const int &lb, const int &ub) noexcept:dat(a.dat),l(a.l),u(a.u),size(ub-lb+1),start(lb),end(ub) { }
	public: 
	//! Constructor of class rvector_slice
	INLINE rvector_slice(const rvector_slice &a) noexcept:dat(a.dat),l(a.l),u(a.u),size(a.size),start(a.start),end(a.end) { }
	public:
	//! Implementation of standard assigning operator
	...
	//! Implementation of standard assigning operator
	INLINE rvector_slice & operator =(const real &r) noexcept;
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE rvector_slice &operator =(const rmatrix_subv &) noexcept;
...
#endif
	//! Returns the lower bound of the vector
	friend INLINE int Lb(const rvector_slice &sl) noexcept { return sl.start; }
	//! Returns the upper bound of the vector
	friend INLINE int Ub(const rvector_slice &sl) noexcept { return sl.end; }
	//! Returns the dimension of the vector
        friend INLINE int VecLen(const rvector_slice &sl) noexcept { return sl.end-sl.start+1; }
	//! Operator for accessing the single elements of the vector
	INLINE real & operator [](const int &i)
#if(CXSC_INDEX_CHECK)
	noexcept(false);
	...
	//! Operator for accessing the whole vector
	INLINE rvector_slice & operator ()() noexcept { return *this; }
	//! Operator for accessing a part of the vector
	INLINE rvector_slice operator ()(const int &i)
#if(CXSC_INDEX_CHECK)
	noexcept(false);
...
//	INLINE rvector _rvector(const rmatrix_slice &sl) noexcept(false);
	...
	INLINE rvector abs(const rvector &rv) noexcept;
	//! Returns the absolute value of the vector
	INLINE rvector abs(const rvector_slice &sl) noexcept;
	//! Implementation of standard negation operation
	INLINE bool operator !(const rvector &rv) noexcept;
	//! Implementation of standard negation operation
	INLINE bool operator !(const rvector_slice &sl) noexcept;

//======================= Vector / Scalar ===============================

	//! Implementation of multiplication operation
	INLINE rvector operator *(const rvector &rv, const real &s) noexcept;
	//! Implementation of multiplication operation
	INLINE rvector operator *(const rvector_slice &sl, const real &s) noexcept;
	//! Implementation of multiplication operation
	INLINE rvector operator *(const real &s, const rvector &rv) noexcept;
	//! Implementation of multiplication operation
	INLINE rvector operator *(const real &s, const rvector_slice &sl) noexcept;
	//! Implementation of multiplication and allocation operation
	INLINE rvector &operator *=(rvector &rv,const real &r) noexcept;
...
//======================= Vector / Vector ===============================
	...
	INLINE const rvector &operator +(const rvector &rv) noexcept;
	//! Implementation of positive sign operation
	INLINE rvector operator +(const rvector_slice &sl) noexcept;
	...
	INLINE bool operator ==(const rvector &rv1, const rvector &rv2) noexcept;
	//! Implementation of standard equality operation
	INLINE bool operator ==(const rvector_slice &sl1, const rvector_slice &sl2) noexcept;
	//! Implementation of standard equality operation
	INLINE bool operator ==(const rvector_slice &sl, const rvector &rv) noexcept;
	//! Implementation of standard equality operation
	INLINE bool operator ==(const rvector &rv, const rvector_slice &sl) noexcept;
	...
	INLINE std::ostream &operator <<(std::ostream &s, const rvector &rv) noexcept;
	//! Implementation of standard output method
	INLINE std::ostream &operator <<(std::ostream &o, const rvector_slice &sl) noexcept;
	//! Implementation of standard input method
	INLINE std::istream &operator >>(std::istream &s, rvector &rv) noexcept;
	//! Implementation of standard input method
	INLINE std::istream &operator >>(std::istream &s, rvector_slice &rv) noexcept;
