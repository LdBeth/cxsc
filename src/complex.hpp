...
//     friend inline complex _complex(const real &a,const real &b) noexcept{ return complex(a,b); }
      ...
      */
      ...
      // ---- Comp.Operat.  ---------------------------------------
//             inline       operator void *() const noexcept { if(re) return (void *)1; if(im) return (void *)1; else return 0; }
