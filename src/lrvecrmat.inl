...
namespace cxsc {
	...
	INLINE l_rvector::l_rvector(const rmatrix_subv &v) noexcept:l(v.lb),u(v.ub),size(v.size)
	{
		dat=new l_real[size];
	...
	*/
	...
	INLINE l_rvector &l_rvector::operator =(const rmatrix_subv &mv) noexcept { return _vmvassign<l_rvector,rmatrix_subv,l_real>(*this,mv); }
	INLINE l_rvector_slice &l_rvector_slice::operator =(const rmatrix_subv &mv) noexcept { return _vsvassign(*this,rvector(mv)); }
