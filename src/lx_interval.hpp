...
public:
    ...
    lx_interval(void)  noexcept {}

    //! Constructor of class lx_interval
    lx_interval(const real& n, const l_interval& a) noexcept 
    {
	if ( !(Is_Integer(n)) ) 
    ...
    //! Constructor of class lx_interval
    lx_interval(const real& n, const l_real& a) noexcept 
    { 
	if ( !(Is_Integer(n)) ) 
    ...
    //! Constructor of class lx_interval
    lx_interval(const real& n, const interval& a) noexcept
    { 
	if ( !(Is_Integer(n)) ) 
    ...
    //! Constructor of class lx_interval
    explicit lx_interval(const real& n, const real& a) noexcept
    { 
		if ( !(Is_Integer(n)) ) 
    ...
    //! Constructor of class lx_interval
    explicit lx_interval(const l_interval& a) noexcept : ex(0), li(a) { }
    //! Constructor of class lx_interval
    explicit lx_interval(const l_real& a)     noexcept : ex(0), li(a) { }
    //! Constructor of class lx_interval
    lx_interval(const l_real& a, const l_real& b)  noexcept : ex(0),li(a,b) { }
    //! Constructor of class lx_interval
    explicit lx_interval(const interval& a)   noexcept : ex(0), li(a)   { }
    //! Constructor of class lx_interval
    explicit lx_interval(const real& a)       noexcept : ex(0), li(a)   { }
    //! Constructor of class lx_interval
    lx_interval(const lx_real&, const lx_real&) noexcept;
    //! Constructor of class lx_interval
    explicit lx_interval(const lx_real& a)     
                                 noexcept : ex(expo(a)), li(lr_part(a)) { }
    //! Constructor of class lx_interval
    lx_interval(const real&, const string&) noexcept; 

    // ------------- Assignments ---------------------------------------------

    //! Implementation of standard assigning operator
    inline lx_interval & operator = (const lx_interval & a) noexcept;
    //! Implementation of standard assigning operator
    inline lx_interval & operator = (const l_interval & a) noexcept;
    //! Implementation of standard assigning operator
    inline lx_interval & operator = (const l_real & a)     noexcept;
    //! Implementation of standard assigning operator
    inline lx_interval & operator = (const real & a)       noexcept;
    //! Implementation of standard assigning operator
    inline lx_interval & operator = (const interval & a)   noexcept;
    //! Implementation of standard assigning operator
    inline lx_interval & operator = (const lx_real & a)     noexcept;

    // l_interval & operator = (const lx_interval &a) noexcept; declared
    // in l_interval.hpp and implemented in lx_interval.cpp; 
	 
	 // interval & operator = (const lx_interval &a) noexcept; declared
    // in interval.hpp and implemented in lx_interval.cpp; 

    // ------------- Functions -----------------------------------------------

    //! Returns the actual precision of an interval of type lx_interval
    friend inline int StagPrec(const lx_interval&) noexcept; 
    //! Returns the exponent of base 2 of an interval of type lx_interval
    friend inline real expo(const lx_interval&) noexcept;
    //! Returns the l_interval part of an interval of type lx_interval
    friend inline l_interval li_part(const lx_interval&) noexcept;
    ...
    friend inline lx_interval adjust(const lx_interval &) noexcept;
    //! Returns the absolute value of an interval
    friend inline lx_interval abs(const lx_interval &) noexcept;
    //! Returns 1 if the interval is a point interval
    friend inline bool point_intv(const lx_interval &);
    //! Implementation of standard negation operation
    friend inline bool operator ! (const lx_interval &) noexcept; 
    //! Returns 1 if an empty interval is given
    friend inline bool IsEmpty(const lx_interval &) noexcept; 
    //! Multiplication of an interval with \f$ 2^n \f$
    friend inline void times2pown(lx_interval &, const real &) noexcept;
    //! Returns an inflated interval a, if abs(a) is too small
    friend inline lx_interval Blow(const lx_interval &) noexcept; 
    //! Multiplication of an interval with \f$ 2^n, n<0, \f$ without integer overflow
    friend inline void times2pown_neg(lx_interval &, const real&) noexcept;
    ...
    friend inline lx_real diam(const lx_interval &) noexcept;
    //! Returns the rounded middle of an interval
    friend inline lx_real mid(const lx_interval &) noexcept;
    //! Returns the infimum of an interval
    friend inline lx_real Inf(const lx_interval &) noexcept;
    //! Returns the supremum of an interval
    friend inline lx_real Sup(const lx_interval &) noexcept;

    // ---------------- Monadic arithmetic operator ---------------------

    //! Implementation of standard algebraic negative sign operation
    friend inline lx_interval operator-(const lx_interval & a) noexcept;
...
inline int StagPrec(const lx_interval &a) noexcept;
inline real expo(const lx_interval &a) noexcept;
inline l_interval li_part(const lx_interval &a) noexcept;

       void scale_down(lx_interval &);
       void scale_up  (lx_interval &);
inline bool point_intv(const lx_interval &);
inline bool IsEmpty(const lx_interval &) noexcept;
inline void times2pown(lx_interval &, const real &) noexcept;
inline lx_interval Blow(const lx_interval &) noexcept;
inline void times2pown_neg(lx_interval &, const real&) noexcept;
inline lx_real RelDiam(const lx_interval &);
inline lx_real Inf(const lx_interval &) noexcept;
inline lx_real Sup(const lx_interval &) noexcept;
inline lx_interval abs(const lx_interval &) noexcept;
inline lx_interval adjust(const lx_interval &) noexcept;
inline lx_real diam(const lx_interval &) noexcept;
inline lx_real mid(const lx_interval &) noexcept;

// ------------------------ Input --------------------------------------

    //! Implementation of standard input method
    std::string & operator >> (std::string &s, lx_interval &a) noexcept;
    //! Implementation of standard input method
    void operator >> (const std::string &s, lx_interval &a) noexcept;
    //! Implementation of standard input method
    void operator >> (const char *s, lx_interval&) noexcept;

    //! Implementation of standard input method
    std::istream & operator >> (std::istream&, lx_interval&) noexcept;

// ------------------------ Output --------------------------------------

std::ostream& operator << (std::ostream& s,const lx_interval& a) noexcept;
...
std::string & operator << (std::string &s,const lx_interval& a) noexcept;
...
inline bool operator <  (const lx_interval&, const lx_interval&) noexcept;
...
//! Implementation of standard less-than operation
inline bool operator <  (const lx_interval&, const l_interval&) noexcept;
//! Implementation of standard less-or-equal-than operation
inline bool operator <= (const lx_interval&, const l_interval&) noexcept;
//! Implementation of standard less-than operation
inline bool operator <  (const l_interval&, const lx_interval&) noexcept;
//! Implementation of standard less-or-equal-than operation
inline bool operator <= (const l_interval&, const lx_interval&) noexcept;
//! Implementation of standard greater-than operation
inline bool operator >  (const lx_interval&, const l_interval&) noexcept;
...
//! Implementation of standard less-than operation
inline bool operator <  (const lx_interval&, const interval&) noexcept;
//! Implementation of standard less-or-equal-than operation
inline bool operator <= (const lx_interval&, const interval&) noexcept;
//! Implementation of standard less-than operation
inline bool operator <  (const interval&, const lx_interval&) noexcept;
//! Implementation of standard less-or-equal-than operation
inline bool operator <= (const interval&, const lx_interval&) noexcept;
//! Implementation of standard greater-than operation
inline bool operator >  (const lx_interval&, const interval&) noexcept;
...
//! Implementation of standard less-than operation
inline bool operator <  (const real &, const lx_interval &) noexcept;
//! Implementation of standard less-or-equal-than operation
inline bool operator <= (const real &, const lx_interval &) noexcept;
//! Implementation of standard greater-than operation
inline bool operator >  (const lx_interval &, const real &) noexcept;
//! Implementation of standard greater-or-equal-than operation
inline bool operator >= (const lx_interval &, const real &) noexcept;
...
//! Implementation of standard less-than operation
inline bool operator <  (const l_real &, const lx_interval &) noexcept;
//! Implementation of standard less-or-equal-than operation
inline bool operator <= (const l_real &, const lx_interval &) noexcept;
//! Implementation of standard greater-than operation
inline bool operator >  (const lx_interval &, const l_real &) noexcept;
//! Implementation of standard greater-or-equal-than operation
inline bool operator >= (const lx_interval &, const l_real &) noexcept;
...
//! Implementation of standard less-than operation
inline bool operator <  (const lx_real &, const lx_interval &) noexcept;
//! Implementation of standard less-or-equal-than operation
inline bool operator <= (const lx_real &, const lx_interval &) noexcept;
//! Implementation of standard greater-than operation
inline bool operator >  (const lx_interval &, const lx_real &) noexcept;
//! Implementation of standard greater-or-equal-than operation
inline bool operator >= (const lx_interval &, const lx_real &) noexcept;
...
//! Implementation of standard negation operation
inline bool operator ! (const lx_interval &) noexcept;
...
inline lx_interval operator+(const lx_interval &) noexcept;
//! Implementation of standard algebraic negative sign operation
inline lx_interval operator-(const lx_interval &) noexcept;

//! Implementation of standard algebraic addition operation
lx_interval operator + (const lx_interval &, const lx_interval &) noexcept;
...
inline lx_interval & operator +=(lx_interval &, const lx_interval &) noexcept;
//! Implementation of standard algebraic addition and allocation operation
inline lx_interval & operator +=(lx_interval &, const l_interval &) noexcept;
//! Implementation of standard algebraic addition and allocation operation
inline lx_interval & operator +=(lx_interval &, const l_real     &) noexcept;
//! Implementation of standard algebraic addition and allocation operation
inline lx_interval & operator +=(lx_interval &, const lx_real     &) noexcept;
//! Implementation of standard algebraic addition and allocation operation
inline lx_interval & operator +=(lx_interval &, const real       &) noexcept;
//! Implementation of standard algebraic addition and allocation operation
inline lx_interval & operator +=(lx_interval &, const interval   &) noexcept;
...
// --------------------------------------------------------------------
 ...
 lx_interval Pi_lx_interval() noexcept; // pi
	 //! Enclosure-Interval for \f$ \pi^2 \f$
 lx_interval Pip2_lx_interval() noexcept; // pi^2
	 //! Enclosure-Interval for \f$ 2\pi \f$
 lx_interval Pi2_lx_interval() noexcept; // 2*pi
	 //! Enclosure-Interval for \f$ \frac{1}{2\pi} \f$
 lx_interval Pi2r_lx_interval() noexcept; // 1/(2*pi)
	 //! Enclosure-Interval for \f$ \pi/4 \f$
 lx_interval Pid4_lx_interval() noexcept; // pi/4
	 //! Enclosure-Interval for \f$ \pi/2 \f$
 lx_interval Pid2_lx_interval() noexcept; // pi/2
    //! Enclosure-Interval for \f$ \ln(2) \f$
 lx_interval Ln2_lx_interval() noexcept; // ln(2)
    //! Enclosure-Interval for \f$ \ln(10) \f$
 lx_interval Ln10_lx_interval() noexcept; // ln(10)
    //! Enclosure-Interval for \f$ 1/\ln(10) \f$
 lx_interval Ln10r_lx_interval() noexcept; // 1/ln(10)
    //! Enclosure-Interval for \f$ 1/\pi \f$
 lx_interval Pir_lx_interval() noexcept;  // 1/pi
    //! Enclosure-Interval for \f$ \sqrt{\pi} \f$
 lx_interval SqrtPi_lx_interval() noexcept;  // sqrt(pi)
    //! Enclosure-Interval for \f$ \sqrt{2\pi} \f$
 lx_interval Sqrt2Pi_lx_interval() noexcept; // sqrt(2pi)
    //! Enclosure-Interval for \f$ \sqrt{2} \f$
 lx_interval Sqrt2_lx_interval() noexcept;  // sqrt(2)
	 //! Enclosure-Interval for \f$ \frac{1}{\sqrt{2}} \f$
 lx_interval Sqrt2r_lx_interval() noexcept;  // sqrt(2)
    //! Enclosure-Interval for \f$ \sqrt{3} \f$
 lx_interval Sqrt3_lx_interval() noexcept;  // sqrt(3)
	 //! Enclosure-Interval for \f$ \frac{\sqrt{3}}{2} \f$
 lx_interval Sqrt3d2_lx_interval() noexcept;  // sqrt(3)/2
	 //! Enclosure-Interval for \f$ \frac{1}{\sqrt{3}} \f$
 lx_interval Sqrt3r_lx_interval() noexcept;  // 1/sqrt(3)
    //! Enclosure-Interval for \f$ 1/\ln(2) \f$
 lx_interval Ln2r_lx_interval() noexcept;  // 1/ln(2)
    //! Enclosure-Interval for \f$ \pi/3 \f$
 lx_interval Pid3_lx_interval() noexcept;  // pi/3
    //! Enclosure-Interval for \f$ 1/\sqrt{\pi} \f$
 lx_interval SqrtPir_lx_interval() noexcept;  // 1/sqrt(pi)
    //! Enclosure-Interval for \f$ 1/\sqrt{2\pi} \f$
 lx_interval Sqrt2Pir_lx_interval() noexcept; // 1/sqrt(2pi)
    //! Enclosure-Interval for \f$ \ln(\pi) \f$
 lx_interval LnPi_lx_interval() noexcept;  // ln(pi)
    //! Enclosure-Interval for \f$ \ln(2\pi) \f$
 lx_interval Ln2Pi_lx_interval() noexcept;  // ln(2pi)
    //! Enclosure-Interval for \f$ e=2.718... \f$
 lx_interval E_lx_interval() noexcept;  // e
	 //! Enclosure-Interval for \f$ e^2 \f$
 lx_interval Ep2_lx_interval() noexcept;  // e^2
	 //! Enclosure-Interval for \f$ e^{-2} \f$
 lx_interval Ep2r_lx_interval() noexcept;  // 1/e^2
	 //! Enclosure-Interval for \f$ \frac{1}{e} \f$
 lx_interval Er_lx_interval() noexcept;  // 1/e
    //! Enclosure-Interval for \f$ e^{\pi} \f$
 lx_interval EpPi_lx_interval() noexcept;  // e^pi
	 //! Enclosure-Interval for \f$ e^{\pi/2} \f$
 lx_interval EpPid2_lx_interval() noexcept;  // e^(pi/2)
	 //! Enclosure-Interval for \f$ e^{\pi/4} \f$
 lx_interval EpPid4_lx_interval() noexcept;  // e^(pi/4)
	 //! Enclosure-Interval for \f$ e^{2\pi} \f$
 lx_interval Ep2Pi_lx_interval() noexcept;  // e^(2*pi)
 ...
 lx_interval sqrt5_lx_interval() noexcept;  // sqrt(5)
    //! Enclosure-Interval for \f$ \sqrt{7} \f$
 lx_interval sqrt7_lx_interval() noexcept;   // sqrt(7)
...
//! Calculates \f$ \sqrt{[x]}  \f$
 lx_interval sqrt(const lx_interval&) noexcept;
//! Calculates \f$ [x]^2  \f$
 lx_interval sqr(const lx_interval&) noexcept;
//! Calculates \f$ \ln([x]) \f$
 lx_interval ln(const lx_interval &) noexcept;
//! Calculates \f$ \log2([x]) \f$
 lx_interval log2(const lx_interval &) noexcept;
//! Calculates \f$ \log10([x]) \f$
 lx_interval log10(const lx_interval &) noexcept;
//! Calculates \f$ \ln(1+[x]) \f$
 lx_interval lnp1(const lx_interval &) noexcept;
//! Calculates \f$ \exp([x]) \f$
 lx_interval exp(const lx_interval &) noexcept;
//! Calculates \f$ 2^{[x]} \f$
 lx_interval exp2(const lx_interval &) noexcept; // 2^x
//! Calculates \f$ 10^{[x]} \f$
 lx_interval exp10(const lx_interval &) noexcept; // 10^x
//! Calculates \f$ \exp([x])-1 \f$
 lx_interval expm1(const lx_interval &x) noexcept; 
//! Calculates \f$ [x]^n \f$
 lx_interval power(const lx_interval &, const real &) noexcept;
//! Calculates \f$ [x]^{[y]} \f$
 lx_interval pow(const lx_interval &, const lx_interval &) noexcept;
//! Calculates \f$ (1+[x])^{[y]} \f$
 lx_interval xp1_pow_y(const lx_interval &, const lx_interval &) noexcept; 
//! Calculates \f$ \sin([x]) \f$
 lx_interval sin(const lx_interval &)noexcept;
//! Calculates \f$ \sin(n\cdot\pi+[x]) \f$
 lx_interval sin_n(const lx_interval &x, const real& n) noexcept;
//! Calculates \f$ \cos([x]) \f$
 lx_interval cos(const lx_interval &) noexcept;
//! Calculates \f$ \cos((n+1/2)\cdot\pi+[x]) \f$
 lx_interval cos_n(const lx_interval &x, const real& n) noexcept;
//! Calculates \f$ \tan([x]) \f$
 lx_interval tan(const lx_interval &) noexcept;
//! Calculates \f$ \cot([x]) \f$
 lx_interval cot(const lx_interval &) noexcept;
//! Calculates \f$ \sqrt{1+[x]^2} \f$
 lx_interval sqrt1px2(const lx_interval &) noexcept;
//! Calculates \f$ \arctan([x]) \f$
 lx_interval atan(const lx_interval &) noexcept;
//! Calculates \f$ \sqrt{1-[x]^2} \f$
 lx_interval sqrt1mx2(const lx_interval &) noexcept;
//! Calculates \f$ \sqrt{[x]^2-1} \f$
 lx_interval sqrtx2m1(const lx_interval &) noexcept;
//! Calculates \f$ \arcsin([x]) \f$
 lx_interval asin(const lx_interval & ) noexcept;
//! Calculates \f$ \arccos([x]) \f$
 lx_interval acos(const lx_interval &) noexcept;
//! Calculates \f$ \mbox{arccot}([x]) \f$
 lx_interval acot(const lx_interval &) noexcept;
//! Calculates \f$ \sinh([x]) \f$
 lx_interval sinh(const lx_interval &) noexcept;
//! Calculates \f$ \cosh([x]) \f$
 lx_interval cosh(const lx_interval &) noexcept;
//! Calculates \f$ \tanh([x]) \f$
 lx_interval tanh(const lx_interval &) noexcept;
//! Calculates \f$ \coth([x]) \f$
 lx_interval coth(const lx_interval &) noexcept;
//! Calculates \f$ \sqrt{([x]+1)-1} \f$
 lx_interval sqrtp1m1(const lx_interval &) noexcept;
//! Calculates \f$ \mbox{arcsinh}([x]) \f$
 lx_interval asinh(const lx_interval &) noexcept;
//! Calculates \f$ \mbox{arccosh}([x]) \f$
 lx_interval acosh(const lx_interval &) noexcept;
//! Calculates \f$ \mbox{arccosh}(1+[x]) \f$
 lx_interval acoshp1(const lx_interval &) noexcept;
//! Calculates \f$ \mbox{arctanh}([x]) \f$
 lx_interval atanh(const lx_interval &) noexcept;
//! Calculates \f$ \mbox{arctanh}(1-[x]) \f$
 lx_interval atanh1m(const lx_interval &) noexcept;
//! Calculates \f$ \mbox{arctanh}(-1+[x]) \f$
 lx_interval atanhm1p(const lx_interval &) noexcept;
//! Calculates \f$ \mbox{arccoth}([x]) \f$
 lx_interval acoth(const lx_interval &) noexcept;
//! Calculates \f$ \mbox{arccoth}(+1+[x]) \f$
 lx_interval acothp1(const lx_interval &) noexcept;
//! Calculates \f$ \mbox{arctanh}(-1-[x]) \f$
 lx_interval acothm1m(const lx_interval &) noexcept;
//! Calculates \f$ \sqrt{[x]^2 + [y]^2} \f$
 lx_interval sqrtx2y2(const lx_interval &, const lx_interval &) noexcept;
//! Calculates \f$ \ln(\sqrt{[x]^2 + [y]^2}) \f$
 lx_interval ln_sqrtx2y2(const lx_interval &, const lx_interval &) noexcept;
//! Calculates \f$ \sqrt[n]{[x]} \f$
 lx_interval sqrt(const lx_interval &, int) noexcept;
