...
namespace cxsc {
	...
	INLINE civector::civector () noexcept:dat(NULL),l(1),u(0),size(0)
	{
	}

	INLINE civector::civector(const int &i) noexcept:l(1),u(i),size(i)
	{
		dat=new cinterval[i];
	}

#ifdef OLD_CXSC
	INLINE civector::civector(const class index &i) noexcept:l(1),u(i._int()),size(i._int())
	{
	...
	INLINE civector::civector(const civector_slice &rs) noexcept:l(rs.start),u(rs.end),size(rs.end-rs.start+1)
	{
		dat=new cinterval[size];
	...
	INLINE civector::civector(const cvector_slice &rs) noexcept:l(rs.start),u(rs.end),size(rs.end-rs.start+1)
	{
		dat=new cinterval[size];
		for(int i=0, j=l-rs.l;i<size;i++,j++)
			dat[i]=rs.dat[j];
	...
	INLINE civector::civector(const ivector_slice &rs) noexcept:l(rs.start),u(rs.end),size(rs.end-rs.start+1)
	{
		dat=new cinterval[size];
		for(int i=0, j=l-rs.l;i<size;i++,j++)
			dat[i]=rs.dat[j];
	...
	INLINE civector::civector(const rvector_slice &rs) noexcept:l(rs.start),u(rs.end),size(rs.end-rs.start+1)
	{
		dat=new cinterval[size];
		for(int i=0, j=l-rs.l;i<size;i++,j++)
			dat[i]=rs.dat[j];
	...
	INLINE civector::civector(const civector &v) noexcept:l(v.l),u(v.u),size(v.size)
	{
		dat=new cinterval[size];
	...
	INLINE civector::civector(const cinterval &r) noexcept:l(1),u(1),size(1)
	{
		dat=new cinterval[1];
		*dat=r;
	}
	
	INLINE civector::civector(const cvector &v) noexcept:l(v.l),u(v.u),size(v.size)
	{
		dat=new cinterval[size];
		for (int i=0;i<size;i++)
			dat[i]=v.dat[i];
	...
	INLINE civector::civector(const ivector &v) noexcept:l(v.l),u(v.u),size(v.size)
	{
		dat=new cinterval[size];
		for (int i=0;i<size;i++)
			dat[i]=v.dat[i];
	...
	INLINE civector::civector(const rvector &v) noexcept:l(v.l),u(v.u),size(v.size)
	{
		dat=new cinterval[size];
		for (int i=0;i<size;i++)
			dat[i]=v.dat[i];
	...
	INLINE civector::civector(const real &r) noexcept:l(1),u(1),size(1)
	{
		dat=new cinterval[1];
		*dat=r;
	}
	
	INLINE civector::civector(const interval &r) noexcept:l(1),u(1),size(1)
	{
		dat=new cinterval[1];
		*dat=r;
	}
	
	INLINE civector::civector(const complex &r) noexcept:l(1),u(1),size(1)
	{
		dat=new cinterval[1];
		*dat=r;
	}
	...
	*/
	INLINE civector _civector(const cinterval &r) noexcept { return civector(r); }
	...
	*/
	INLINE civector _civector(const real &r) noexcept { return civector(r); }	
	/*!
	\deprecated use standard contructors for typecasting

	\sa cxsc::civector::civector(const rvector_slice &rs)
	*/
	INLINE civector _civector(const rvector_slice &rs) noexcept { return civector(rs); }	
	/*!
	\deprecated use standard contructors for typecasting

	\sa cxsc::civector::civector(const rvector &v)
	*/
	INLINE civector _civector(const rvector &rs) noexcept { return civector(rs); }
	...
	*/
	INLINE civector _civector(const complex &r) noexcept { return civector(r); }	
	/*!
	\deprecated use standard contructors for typecasting

	\sa cxsc::civector::civector(const cvector_slice &rs)
	*/
	INLINE civector _civector(const cvector_slice &rs) noexcept { return civector(rs); }	
	/*!
	\deprecated use standard contructors for typecasting

	\sa cxsc::civector::civector(const cvector &v)
	*/
	INLINE civector _civector(const cvector &rs) noexcept { return civector(rs); }
	...
	\sa cxsc::civector::civector(const interval &)
	*/
	INLINE civector _civector(const interval &r) noexcept { return civector(r); }	
	/*!
	\deprecated use standard contructors for typecasting

	\sa cxsc::civector::civector(const ivector_slice &rs)
	*/
	INLINE civector _civector(const ivector_slice &rs) noexcept { return civector(rs); }	
	/*!
	\deprecated use standard contructors for typecasting

	\sa cxsc::civector::civector(const ivector &v)
	*/
	INLINE civector _civector(const ivector &rs) noexcept { return civector(rs); }
	
	INLINE civector &civector::operator =(const civector &rv) noexcept { return _vvassign<civector,civector,cinterval>(*this,rv); }
	INLINE civector &civector::operator =(const cinterval &r) noexcept { return _vsassign<civector,cinterval>(*this,r); }
	INLINE civector::operator void*() noexcept { return _vvoid(*this); }
	...
	INLINE civector_slice & civector_slice::operator =(const cinterval &r) noexcept { return _vssassign<civector_slice,cinterval>(*this,r); }
	...
	INLINE civector_slice::operator void*() noexcept { return _vsvoid(*this); }
...
//======================== Vector Functions =============================
	...
	INLINE civector &SetSup(civector &iv,const complex &r) noexcept { return _vssetsup(iv,r); }
	INLINE civector &SetInf(civector &iv,const complex &r) noexcept { return _vssetinf(iv,r); }
	INLINE civector &UncheckedSetSup(civector &iv,const complex &r) noexcept { return _vsusetsup(iv,r); }
	INLINE civector &SetUncheckedInf(civector &iv,const complex &r) noexcept { return _vsusetinf(iv,r); }
	INLINE civector &SetRe(civector &iv,const interval &r) noexcept { return _vssetre(iv,r); }
	INLINE civector &SetIm(civector &iv,const interval &r) noexcept { return _vssetim(iv,r); }

	INLINE civector_slice &SetSup(civector_slice &iv,const complex &r) noexcept { return _vsssetsup(iv,r); }
	INLINE civector_slice &SetInf(civector_slice &iv,const complex &r) noexcept { return _vsssetinf(iv,r); }
	INLINE civector_slice &UncheckedSetSup(civector_slice &iv,const complex &r) noexcept { return _vssusetsup(iv,r); }
	INLINE civector_slice &SetUncheckedInf(civector_slice &iv,const complex &r) noexcept { return _vssusetinf(iv,r); }
	INLINE civector_slice &SetRe(civector_slice &iv,const interval &r) noexcept { return _vsssetre(iv,r); }
	INLINE civector_slice &SetIm(civector_slice &iv,const interval &r) noexcept { return _vsssetim(iv,r); }

	INLINE ivector Re(const civector &v) noexcept
	{
		ivector erg(v.l,v.u);
	...
	INLINE ivector Re(const civector_slice &sl) noexcept
	{
	...
	INLINE rvector InfRe(const civector_slice &sl) noexcept
	{
	...
	INLINE ivector Im(const civector &v) noexcept
	{
		ivector erg(v.l,v.u);
	...
	INLINE ivector Im(const civector_slice &sl) noexcept
	{
		ivector erg(sl.start,sl.end);
	...
	INLINE rvector InfIm(const civector_slice &sl) noexcept
	{
		rvector erg(sl.start,sl.end);
	...
	INLINE rvector SupIm(const civector_slice &sl) noexcept
	{
		rvector erg(sl.start,sl.end);
	...
	INLINE rvector SupRe(const civector_slice &sl) noexcept
	{
		rvector erg(sl.start,sl.end);
	...
	INLINE void Resize(civector &rv) noexcept { _vresize(rv); } 
	...
	INLINE civector conj(const civector &rv) noexcept { return _vconj<civector>(rv); }
	INLINE civector conj(const civector_slice &sl) noexcept { return _vsconj<civector_slice,civector>(sl); }
	
	INLINE ivector abs(const civector &rv) noexcept { return _vabs<civector,ivector>(rv); }
	INLINE ivector abs(const civector_slice &sl) noexcept { return _vsabs<civector_slice,ivector>(sl); }
	INLINE cvector diam(const civector &v) noexcept { return _vdiam<civector,cvector>(v); }
	INLINE cvector diam(const civector_slice &v) noexcept { return _vsdiam<civector_slice,cvector>(v); }
	INLINE cvector mid(const civector &v) noexcept { return _vmid<civector,cvector>(v); }
	INLINE cvector mid(const civector_slice &v) noexcept { return _vsmid<civector_slice,cvector>(v); }
	INLINE cvector Inf(const civector &v) noexcept { return _vinf<civector,cvector>(v); }
	INLINE cvector Inf(const civector_slice &v) noexcept { return _vsinf<civector_slice,cvector>(v); }
	INLINE cvector Sup(const civector &v) noexcept { return _vsup<civector,cvector>(v); }
	INLINE cvector Sup(const civector_slice &v) noexcept { return _vssup<civector_slice,cvector>(v); }
	INLINE bool operator !(const civector &rv) noexcept { return _vnot(rv); }
	INLINE bool operator !(const civector_slice &sl) noexcept { return _vsnot(sl); }

//======================= Vector / Scalar ===============================

//----------------------------- cinterval ---------------------------

	INLINE civector operator *(const civector &rv, const cinterval &s) noexcept { return _vsmult<civector,cinterval,civector>(rv,s); }
	INLINE civector operator *(const civector_slice &sl, const cinterval &s) noexcept { return _vssmult<civector_slice,cinterval,civector>(sl,s); }
	INLINE civector operator *(const cinterval &s, const civector &rv) noexcept { return _vsmult<civector,cinterval,civector>(rv,s); }
	INLINE civector operator *(const cinterval &s, const civector_slice &sl) noexcept { return _vssmult<civector_slice,cinterval,civector>(sl,s); }
	INLINE civector &operator *=(civector &rv,const cinterval &r) noexcept { return _vsmultassign(rv,r); }
	INLINE civector_slice &civector_slice::operator *=(const cinterval &r) noexcept { return _vssmultassign(*this,r); }

	INLINE civector operator /(const civector &rv, const cinterval &s) noexcept { return _vsdiv<civector,cinterval,civector>(rv,s); }
	INLINE civector operator /(const civector_slice &sl, const cinterval &s) noexcept { return _vssdiv<civector_slice,cinterval,civector>(sl,s); }
	INLINE civector &operator /=(civector &rv,const cinterval &r) noexcept { return _vsdivassign(rv,r); }
	INLINE civector_slice &civector_slice::operator /=(const cinterval &r) noexcept { return _vssdivassign(*this,r); }

//---------------------------- Real --------------------------------------

	INLINE civector operator *(const civector &rv, const real &s) noexcept { return _vsmult<civector,real,civector>(rv,s); }
	INLINE civector operator *(const civector_slice &sl, const real &s) noexcept { return _vssmult<civector_slice,real,civector>(sl,s); }
	INLINE civector operator *(const real &s, const civector &rv) noexcept { return _vsmult<civector,real,civector>(rv,s); }
	INLINE civector operator *(const real &s, const civector_slice &sl) noexcept { return _vssmult<civector_slice,real,civector>(sl,s); }
	INLINE civector &operator *=(civector &rv,const real &r) noexcept { return _vsmultassign(rv,r); }
	INLINE civector_slice &civector_slice::operator *=(const real &r) noexcept { return _vssmultassign(*this,r); }

	INLINE civector operator /(const civector &rv, const real &s) noexcept { return _vsdiv<civector,real,civector>(rv,s); }
	INLINE civector operator /(const civector_slice &sl, const real &s) noexcept { return _vssdiv<civector_slice,real,civector>(sl,s); }
	INLINE civector &operator /=(civector &rv,const real &r) noexcept { return _vsdivassign(rv,r); }
	INLINE civector_slice &civector_slice::operator /=(const real &r) noexcept { return _vssdivassign(*this,r); }

	INLINE civector operator *(const rvector &rv, const cinterval &s) noexcept { return _vsmult<rvector,cinterval,civector>(rv,s); }
	INLINE civector operator *(const rvector_slice &sl, const cinterval &s) noexcept { return _vssmult<rvector_slice,cinterval,civector>(sl,s); }
	INLINE civector operator *(const cinterval &s, const rvector &rv) noexcept { return _vsmult<rvector,cinterval,civector>(rv,s); }
	INLINE civector operator *(const cinterval &s, const rvector_slice &sl) noexcept { return _vssmult<rvector_slice,cinterval,civector>(sl,s); }

	INLINE civector operator /(const rvector &rv, const cinterval &s) noexcept { return _vsdiv<rvector,cinterval,civector>(rv,s); }
	INLINE civector operator /(const rvector_slice &sl, const cinterval &s) noexcept { return _vssdiv<rvector_slice,cinterval,civector>(sl,s); }

//---------------------------- complex --------------------------------------

	INLINE civector operator *(const civector &rv, const complex &s) noexcept { return _vsmult<civector,complex,civector>(rv,s); }
	INLINE civector operator *(const civector_slice &sl, const complex &s) noexcept { return _vssmult<civector_slice,complex,civector>(sl,s); }
	INLINE civector operator *(const complex &s, const civector &rv) noexcept { return _vsmult<civector,complex,civector>(rv,s); }
	INLINE civector operator *(const complex &s, const civector_slice &sl) noexcept { return _vssmult<civector_slice,complex,civector>(sl,s); }
	INLINE civector &operator *=(civector &rv,const complex &r) noexcept { return _vsmultassign(rv,r); }
	INLINE civector_slice &civector_slice::operator *=(const complex &r) noexcept { return _vssmultassign(*this,r); }

	INLINE civector operator /(const civector &rv, const complex &s) noexcept { return _vsdiv<civector,complex,civector>(rv,s); }
	INLINE civector operator /(const civector_slice &sl, const complex &s) noexcept { return _vssdiv<civector_slice,complex,civector>(sl,s); }
	INLINE civector &operator /=(civector &rv,const complex &r) noexcept { return _vsdivassign(rv,r); }
	INLINE civector_slice &civector_slice::operator /=(const complex &r) noexcept { return _vssdivassign(*this,r); }

	INLINE civector operator *(const cvector &rv, const cinterval &s) noexcept { return _vsmult<cvector,cinterval,civector>(rv,s); }
	INLINE civector operator *(const cvector_slice &sl, const cinterval &s) noexcept { return _vssmult<cvector_slice,cinterval,civector>(sl,s); }
	INLINE civector operator *(const cinterval &s, const cvector &rv) noexcept { return _vsmult<cvector,cinterval,civector>(rv,s); }
	INLINE civector operator *(const cinterval &s, const cvector_slice &sl) noexcept { return _vssmult<cvector_slice,cinterval,civector>(sl,s); }

	INLINE civector operator /(const cvector &rv, const cinterval &s) noexcept { return _vsdiv<cvector,cinterval,civector>(rv,s); }
	INLINE civector operator /(const cvector_slice &sl, const cinterval &s) noexcept { return _vssdiv<cvector_slice,cinterval,civector>(sl,s); }

//---------------------------- interval --------------------------------------

	INLINE civector operator *(const civector &rv, const interval &s) noexcept { return _vsmult<civector,interval,civector>(rv,s); }
	INLINE civector operator *(const civector_slice &sl, const interval &s) noexcept { return _vssmult<civector_slice,interval,civector>(sl,s); }
	INLINE civector operator *(const interval &s, const civector &rv) noexcept { return _vsmult<civector,interval,civector>(rv,s); }
	INLINE civector operator *(const interval &s, const civector_slice &sl) noexcept { return _vssmult<civector_slice,interval,civector>(sl,s); }
	INLINE civector &operator *=(civector &rv,const interval &r) noexcept { return _vsmultassign(rv,r); }
	INLINE civector_slice &civector_slice::operator *=(const interval &r) noexcept { return _vssmultassign(*this,r); }

	INLINE civector operator /(const civector &rv, const interval &s) noexcept { return _vsdiv<civector,interval,civector>(rv,s); }
	INLINE civector operator /(const civector_slice &sl, const interval &s) noexcept { return _vssdiv<civector_slice,interval,civector>(sl,s); }
	INLINE civector &operator /=(civector &rv,const interval &r) noexcept { return _vsdivassign(rv,r); }
	INLINE civector_slice &civector_slice::operator /=(const interval &r) noexcept { return _vssdivassign(*this,r); }

	INLINE civector operator *(const ivector &rv, const cinterval &s) noexcept { return _vsmult<ivector,cinterval,civector>(rv,s); }
	INLINE civector operator *(const ivector_slice &sl, const cinterval &s) noexcept { return _vssmult<ivector_slice,cinterval,civector>(sl,s); }
	INLINE civector operator *(const cinterval &s, const ivector &rv) noexcept { return _vsmult<ivector,cinterval,civector>(rv,s); }
	INLINE civector operator *(const cinterval &s, const ivector_slice &sl) noexcept { return _vssmult<ivector_slice,cinterval,civector>(sl,s); }

	INLINE civector operator /(const ivector &rv, const cinterval &s) noexcept { return _vsdiv<ivector,cinterval,civector>(rv,s); }
	INLINE civector operator /(const ivector_slice &sl, const cinterval &s) noexcept { return _vssdiv<ivector_slice,cinterval,civector>(sl,s); }

//======================= Vector / Vector ===============================


	INLINE std::ostream &operator <<(std::ostream &s, const civector &rv) noexcept { return _vout(s,rv); }
	INLINE std::ostream &operator <<(std::ostream &o, const civector_slice &sl) noexcept { return _vsout(o,sl); }
	INLINE std::istream &operator >>(std::istream &s, civector &rv) noexcept { return _vin(s,rv); }
	INLINE std::istream &operator >>(std::istream &s, civector_slice &rv) noexcept { return _vsin(s,rv); }
	
//----------------------- cinterval / cinterval ---------------------------
	INLINE civector & civector::operator =(const civector_slice &sl) noexcept { return _vvsassign<civector,civector_slice,cinterval>(*this,sl); }
	...
	INLINE const civector &operator +(const civector &rv) noexcept { return rv; }
	INLINE civector operator +(const civector_slice &sl) noexcept { return sl; }
	...
	INLINE civector operator -(const civector &rv) noexcept { return _vminus(rv); }
	INLINE civector operator -(const civector_slice &sl) noexcept { return _vsminus<civector_slice,civector>(sl); }
	INLINE civector operator -(const civector &rv1, const civector &rv2)
#if(CXSC_INDEX_CHECK)
	noexcept(false)
#else
	...
	INLINE bool operator ==(const civector &rv1, const civector &rv2) noexcept { return _vveq(rv1,rv2); }
	INLINE bool operator ==(const civector_slice &sl1, const civector_slice &sl2) noexcept { return _vsvseq(sl1,sl2); }
	INLINE bool operator ==(const civector_slice &sl, const civector &rv) noexcept { return _vsveq(sl,rv); }
	INLINE bool operator ==(const civector &rv, const civector_slice &sl) noexcept { return _vsveq(sl,rv); }
	INLINE bool operator !=(const civector &rv1, const civector &rv2) noexcept { return _vvneq(rv1,rv2); }
	INLINE bool operator !=(const civector_slice &sl1, const civector_slice &sl2) noexcept { return _vsvsneq(sl1,sl2); }
	INLINE bool operator !=(const civector_slice &sl, const civector &rv) noexcept { return _vsvneq(sl,rv); }
	INLINE bool operator !=(const civector &rv, const civector_slice &sl) noexcept { return _vsvneq(sl,rv); }
	INLINE bool operator <(const civector &rv1, const civector &rv2) noexcept { return _vvless(rv1,rv2); }
	INLINE bool operator <(const civector_slice &sl1, const civector_slice &sl2) noexcept { return _vsvsless(sl1,sl2); }
	INLINE bool operator < (const civector_slice &sl, const civector &rv) noexcept { return _vsvless(sl,rv); }
	INLINE bool operator < (const civector &rv, const civector_slice &sl) noexcept { return _vvsless(rv,sl); }
	INLINE bool operator <=(const civector &rv1, const civector &rv2) noexcept { return _vvleq(rv1,rv2); }
	INLINE bool operator <=(const civector_slice &sl1, const civector_slice &sl2) noexcept { return _vsvsleq(sl1,sl2); }
	INLINE bool operator <=(const civector_slice &sl, const civector &rv) noexcept { return _vsvleq(sl,rv); }
	INLINE bool operator <=(const civector &rv, const civector_slice &sl) noexcept { return _vvsleq(rv,sl); }
	INLINE bool operator >(const civector &rv1, const civector &rv2) noexcept { return _vvless(rv2,rv1); }
	INLINE bool operator >(const civector_slice &sl1, const civector_slice &sl2) noexcept { return _vsvsless(sl2,sl1); }
	INLINE bool operator >(const civector_slice &sl, const civector &rv) noexcept { return _vvsless(rv,sl); }
	INLINE bool operator >(const civector &rv, const civector_slice &sl) noexcept { return _vsvless(sl,rv); }
	INLINE bool operator >=(const civector &rv1, const civector &rv2) noexcept { return _vvleq(rv2,rv1); }
	INLINE bool operator >=(const civector_slice &sl1, const civector_slice &sl2) noexcept { return _vsvsleq(sl2,sl1); }
	INLINE bool operator >=(const civector_slice &sl, const civector &rv) noexcept { return _vvsleq(rv,sl); }
	INLINE bool operator >=(const civector &rv, const civector_slice &sl) noexcept { return _vsvleq(sl,rv); }

//-------------------------------- cinterval / Real --------------------------------

	INLINE civector &civector::operator =(const rvector &rv) noexcept { return _vvassign<civector,rvector,cinterval>(*this,rv); }
	INLINE civector &civector::operator =(const real &r) noexcept { return _vsassign<civector,real>(*this,r); }
	INLINE civector & civector::operator =(const rvector_slice &sl) noexcept { return _vvsassign<civector,rvector_slice,cinterval>(*this,sl); }
...
#endif
	{ return _vsvassign(*this,rv); }
	INLINE civector_slice &civector_slice::operator =(const real &r) noexcept { return _vssassign<civector_slice,real>(*this,r); }
...
//-------------------------------- cinterval / complex --------------------------------
	...
	INLINE civector &civector::operator =(const cvector &rv) noexcept { return _vvassign<civector,cvector,cinterval>(*this,rv); }
	INLINE civector &civector::operator =(const complex &r) noexcept { return _vsassign<civector,complex>(*this,r); }
	INLINE civector & civector::operator =(const cvector_slice &sl) noexcept { return _vvsassign<civector,cvector_slice,cinterval>(*this,sl); }
...
#endif
	{ return _vsvassign(*this,rv); }
	INLINE civector_slice &civector_slice::operator =(const complex &r) noexcept { return _vssassign<civector_slice,complex>(*this,r); }
...
//-------------------------------- cinterval / interval --------------------------------
	...
	INLINE civector &civector::operator =(const ivector &rv) noexcept { return _vvassign<civector,ivector,cinterval>(*this,rv); }
	INLINE civector &civector::operator =(const interval &r) noexcept { return _vsassign<civector,interval>(*this,r); }
	INLINE civector & civector::operator =(const ivector_slice &sl) noexcept { return _vvsassign<civector,ivector_slice,cinterval>(*this,sl); }
...
#endif
	{ return _vsvassign(*this,rv); }
	INLINE civector_slice &civector_slice::operator =(const interval &r) noexcept { return _vssassign<civector_slice,interval>(*this,r); }
