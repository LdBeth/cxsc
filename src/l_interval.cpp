...
/*l_interval::operator void *(void) noexcept
{
   idotakku[0]=0.0;
...
/* void accumulate(idotprecision & d, const l_interval & li1, const l_interval & li2) noexcept
{
...
/* void l_interval::_akku_out() noexcept
{  
