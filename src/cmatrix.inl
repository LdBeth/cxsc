...
INLINE cmatrix::cmatrix() noexcept:dat(NULL),lb1(1),ub1(0),lb2(1),ub2(0),xsize(0),ysize(0)
{
}

INLINE cmatrix::cmatrix(const complex &r) noexcept:lb1(1),ub1(1),lb2(1),ub2(1),xsize(1),ysize(1)
{
	dat=new complex[1];
	*dat=r;
}

INLINE cmatrix::cmatrix(const real &r) noexcept:lb1(1),ub1(1),lb2(1),ub2(1),xsize(1),ysize(1)
{
	dat=new complex[1];
	*dat=r;
}

INLINE cmatrix::cmatrix(const cmatrix &rm) noexcept:lb1(rm.lb1),ub1(rm.ub1),lb2(rm.lb2),ub2(rm.ub2),xsize(rm.xsize),ysize(rm.ysize)
{
...
INLINE cmatrix::cmatrix(const rmatrix &rm) noexcept:lb1(rm.lb1),ub1(rm.ub1),lb2(rm.lb2),ub2(rm.ub2),xsize(rm.xsize),ysize(rm.ysize)
{
	dat=new complex[xsize*ysize];
	for(int i=0;i<xsize*ysize;i++)
		dat[i]=rm.dat[i];
...
INLINE cvector::cvector(const cmatrix_subv &v) noexcept:l(v.lb),u(v.ub),size(v.size)
{
...
INLINE cmatrix::cmatrix(const cvector &v) noexcept:lb1(v.l),ub1(v.u),lb2(1),ub2(1),xsize(1),ysize(v.size)
{
...
INLINE cmatrix::cmatrix(const rvector &v) noexcept:lb1(v.l),ub1(v.u),lb2(1),ub2(1),xsize(1),ysize(v.size)
{
	dat=new complex[v.size];
	for(int i=0;i<v.size;i++)
		dat[i]=v.dat[i];
...
INLINE cmatrix::cmatrix(const cvector_slice &v) noexcept:lb1(v.start),ub1(v.end),lb2(1),ub2(1),xsize(1),ysize(v.size)
{
	dat=new complex[v.size];
...
INLINE cmatrix::cmatrix(const rvector_slice &v) noexcept:lb1(v.start),ub1(v.end),lb2(1),ub2(1),xsize(1),ysize(v.size)
{
	dat=new complex[v.size];
	for(int i=0,j=v.start-v.l;i<v.size;i++,j++)
		dat[i]=v.dat[j];
	...
	INLINE cmatrix::cmatrix(const cmatrix_slice &sl) noexcept:lb1(sl.start1),ub1(sl.end1),lb2(sl.start2),ub2(sl.end2),xsize(sl.sxsize),ysize(sl.sysize)
	{
		int i,j;
	...
	INLINE cmatrix::cmatrix(const rmatrix_slice &sl) noexcept:lb1(sl.start1),ub1(sl.end1),lb2(sl.start2),ub2(sl.end2),xsize(sl.sxsize),ysize(sl.sysize)
	{
		int i,j;
...
#endif
{
	...
	INLINE cmatrix_subv &cmatrix_subv::operator =(const cmatrix_subv &rv) noexcept { return _mvmvassign(*this,rv); }
	INLINE cmatrix_subv &cmatrix_subv::operator =(const complex &r) noexcept { return _mvsassign(*this,r); }
	...
	INLINE cmatrix_subv &cmatrix_subv::operator =(const rmatrix_subv &rv) noexcept { return _mvvassign(*this,rvector(rv)); }
	INLINE cmatrix_subv &cmatrix_subv::operator =(const real &r) noexcept { return _mvsassign(*this,r); }
...
#endif
	{ return _mvvassign(*this,cvector(v)); }
	INLINE cmatrix &cmatrix::operator =(const complex &r) noexcept { return _msassign(*this,r); }
	INLINE cmatrix &cmatrix::operator =(const cmatrix &m) noexcept { return _mmassign<cmatrix,cmatrix,complex>(*this,m, complex(0,0)); }
	INLINE cmatrix &cmatrix::operator =(const cmatrix_slice &ms) noexcept { return _mmsassign<cmatrix,cmatrix_slice,complex>(*this,ms); }
	INLINE cmatrix &cmatrix::operator =(const cvector &v) noexcept { return _mvassign<cmatrix,cvector,complex>(*this,v); }
	INLINE cmatrix &cmatrix::operator =(const cvector_slice &v) noexcept { return _mvassign<cmatrix,cvector,complex>(*this,cvector(v)); }
	INLINE cmatrix &cmatrix::operator =(const real &r) noexcept { return _msassign(*this,complex(r)); }
	INLINE cmatrix &cmatrix::operator =(const rmatrix &m) noexcept { return _mmassign<cmatrix,rmatrix,complex>(*this,m,complex(0,0)); }
	INLINE cmatrix &cmatrix::operator =(const rmatrix_slice &ms) noexcept { return _mmsassign<cmatrix,rmatrix_slice,complex>(*this,ms); }
	INLINE cmatrix &cmatrix::operator =(const rvector &v) noexcept { return _mvassign<cmatrix,rvector,complex>(*this,v); }
	INLINE cmatrix &cmatrix::operator =(const rvector_slice &v) noexcept { return _mvassign<cmatrix,rvector,complex>(*this,rvector(v)); }
	
	INLINE cmatrix::operator void*() noexcept { return _mvoid(*this); }
	...
	INLINE cmatrix_slice &cmatrix_slice::operator =(const complex &r) noexcept { return _mssassign(*this,r); }
...
#endif
	{ return _msmsassign(*this,ms); }
	INLINE cmatrix_slice &cmatrix_slice::operator =(const real &r) noexcept { return _mssassign(*this,r); }
	...
	INLINE cmatrix_slice::operator void*() noexcept { return _msvoid(*this); }
	INLINE cvector operator /(const cmatrix_subv &rv, const complex &s) noexcept { return _mvsdiv<cmatrix_subv,complex,cvector>(rv,s); }
	INLINE cvector operator *(const cmatrix_subv &rv, const complex &s) noexcept { return _mvsmult<cmatrix_subv,complex,cvector>(rv,s); }
	INLINE cvector operator *(const complex &s, const cmatrix_subv &rv) noexcept { return _mvsmult<cmatrix_subv,complex,cvector>(rv,s); }
	INLINE cmatrix_subv &cmatrix_subv::operator *=(const complex &c) noexcept { return _mvsmultassign(*this,c); }
	INLINE cmatrix_subv &cmatrix_subv::operator +=(const complex &c) noexcept { return _mvsplusassign(*this,c); }
	INLINE cmatrix_subv &cmatrix_subv::operator -=(const complex &c) noexcept { return _mvsminusassign(*this,c); }
	INLINE cmatrix_subv &cmatrix_subv::operator /=(const complex &c) noexcept { return _mvsdivassign(*this,c); }
	INLINE rvector abs(const cmatrix_subv &mv) noexcept { return _mvabs<cmatrix_subv,rvector>(mv); }
	INLINE rvector Im(const cmatrix_subv &mv) noexcept { return _mvim<cmatrix_subv,rvector>(mv); }
	INLINE rvector Re(const cmatrix_subv &mv) noexcept { return _mvre<cmatrix_subv,rvector>(mv); }
	...
	INLINE cmatrix_subv &SetRe(cmatrix_subv &iv,const real &r) noexcept { return _mvssetre(iv,r); }
	INLINE cmatrix_subv &SetIm(cmatrix_subv &iv,const real &r) noexcept { return _mvssetim(iv,r); }
	INLINE cvector &cvector::operator =(const cmatrix_subv &mv) noexcept { return _vmvassign<cvector,cmatrix_subv,complex>(*this,mv); }
	INLINE cvector_slice &cvector_slice::operator =(const cmatrix_subv &mv) noexcept { return _vsvassign(*this,cvector(mv)); }
...
// matrix x matrix	
	...
	*/
	INLINE cmatrix _cmatrix(const cmatrix &rm) noexcept { return rm; }
	/*!
	\deprecated use standard contructors for typecasting

	\sa cxsc::cmatrix::cmatrix(const cvector &v)
	*/
	INLINE cmatrix _cmatrix(const cvector &v) noexcept { return cmatrix(v); }
	/*!
	\deprecated use standard contructors for typecasting

	\sa cxsc::cmatrix::cmatrix(const cvector_slice &v)
	*/
	INLINE cmatrix _cmatrix(const cvector_slice &v) noexcept { return cmatrix(v); }
	/*!
	\deprecated use standard contructors for typecasting

	\sa cxsc::cmatrix::cmatrix(const complex &r)
	*/
	INLINE cmatrix _cmatrix(const complex &r) noexcept { return cmatrix(r); }
	...
	INLINE void Resize(cmatrix &A) noexcept { _mresize(A);}
	...
	INLINE rmatrix abs(const cmatrix &m) noexcept { return _mabs<cmatrix,rmatrix>(m); }
	INLINE rmatrix abs(const cmatrix_slice &ms) noexcept { return _msabs<cmatrix_slice,rmatrix>(ms); }
	INLINE rmatrix Im(const cmatrix &m) noexcept { return _mim<cmatrix,rmatrix>(m); }
	INLINE rmatrix Re(const cmatrix &m) noexcept { return _mre<cmatrix,rmatrix>(m); }
	INLINE rmatrix Im(const cmatrix_slice &m) noexcept { return _msim<cmatrix_slice,rmatrix>(m); }
	INLINE rmatrix Re(const cmatrix_slice &m) noexcept { return _msre<cmatrix_slice,rmatrix>(m); }
...
#endif
	{ _smconstr(*this,m); }
//	INLINE complex complex::_complex(const cmatrix &m) noexcept(false) { _smconstr(*this,m); return *this; }
	INLINE cmatrix operator *(const complex &c, const cmatrix &m) noexcept { return _smmult<complex,cmatrix,cmatrix>(c,m); }
	INLINE cmatrix operator *(const complex &c, const cmatrix_slice &ms) noexcept { return _smsmult<complex,cmatrix_slice,cmatrix>(c,ms); }
	INLINE cmatrix operator *(const cmatrix &m,const complex &c) noexcept { return _smmult<complex,cmatrix,cmatrix>(c,m); }
	INLINE cmatrix operator *(const cmatrix_slice &ms,const complex &c) noexcept { return _smsmult<complex,cmatrix_slice,cmatrix>(c,ms); }
	INLINE cmatrix &operator *=(cmatrix &m,const complex &c) noexcept { return _msmultassign(m,c); }
	INLINE cmatrix_slice &cmatrix_slice::operator *=(const cmatrix &m)
#if(CXSC_INDEX_CHECK)
	noexcept(false)
#else
...
#endif
	{ return (*this=*this*m); }
	INLINE cmatrix_slice &cmatrix_slice::operator *=(const complex &c) noexcept { return _mssmultassign(*this,c); }
	INLINE cmatrix operator /(const cmatrix &m,const complex &c) noexcept { return _msdiv<cmatrix,complex,cmatrix>(m,c); }
	INLINE cmatrix operator /(const cmatrix_slice &ms, const complex &c) noexcept { return _mssdiv<cmatrix_slice,complex,cmatrix>(ms,c); }
	INLINE cmatrix &operator /=(cmatrix &m,const complex &c) noexcept { return _msdivassign(m,c); }
	INLINE cmatrix_slice &cmatrix_slice::operator /=(const complex &c) noexcept { return _mssdivassign(*this,c); }
	INLINE cmatrix operator *(const real &c, const cmatrix &m) noexcept { return _smmult<real,cmatrix,cmatrix>(c,m); }
	INLINE cmatrix operator *(const real &c, const cmatrix_slice &ms) noexcept { return _smsmult<real,cmatrix_slice,cmatrix>(c,ms); }
	INLINE cmatrix operator *(const cmatrix &m,const real &c) noexcept { return _smmult<real,cmatrix,cmatrix>(c,m); }
	INLINE cmatrix operator *(const cmatrix_slice &ms,const real &c) noexcept { return _smsmult<real,cmatrix_slice,cmatrix>(c,ms); }
	INLINE cmatrix &operator *=(cmatrix &m,const real &c) noexcept { return _msmultassign(m,c); }
	INLINE cmatrix_slice &cmatrix_slice::operator *=(const rmatrix &m)
#if(CXSC_INDEX_CHECK)
	noexcept(false)
#else
...
#endif
	{ return (*this=*this*m); }
	INLINE cmatrix_slice &cmatrix_slice::operator *=(const real &c) noexcept { return _mssmultassign(*this,c); }
	INLINE cmatrix operator /(const cmatrix &m,const real &c) noexcept { return _msdiv<cmatrix,real,cmatrix>(m,c); }
	INLINE cmatrix operator /(const cmatrix_slice &ms, const real &c) noexcept { return _mssdiv<cmatrix_slice,real,cmatrix>(ms,c); }
	INLINE cmatrix &operator /=(cmatrix &m,const real &c) noexcept { return _msdivassign(m,c); }
	INLINE cmatrix_slice &cmatrix_slice::operator /=(const real &c) noexcept { return _mssdivassign(*this,c); }
//	INLINE complex::complex(const rmatrix &m) noexcept(false) { _smconstr(*this,m); }
//	INLINE complex complex::_complex(const cmatrix &m) noexcept(false) { _smconstr(*this,m); return *this; }
	INLINE cmatrix operator *(const complex &c, const rmatrix &m) noexcept { return _smmult<complex,rmatrix,cmatrix>(c,m); }
	INLINE cmatrix operator *(const complex &c, const rmatrix_slice &ms) noexcept { return _smsmult<complex,rmatrix_slice,cmatrix>(c,ms); }
	INLINE cmatrix operator *(const rmatrix &m,const complex &c) noexcept { return _smmult<complex,rmatrix,cmatrix>(c,m); }
	INLINE cmatrix operator *(const rmatrix_slice &ms,const complex &c) noexcept { return _smsmult<complex,rmatrix_slice,cmatrix>(c,ms); }
	INLINE cmatrix operator /(const rmatrix &m,const complex &c) noexcept { return _msdiv<rmatrix,complex,cmatrix>(m,c); }
	INLINE cmatrix operator /(const rmatrix_slice &ms, const complex &c) noexcept { return _mssdiv<rmatrix_slice,complex,cmatrix>(ms,c); }
	...
	INLINE const cmatrix &operator +(const cmatrix &m) noexcept { return m; }
	INLINE cmatrix operator +(const cmatrix_slice &m) noexcept { return cmatrix(m); }
	...
	INLINE cmatrix operator -(const cmatrix &m) noexcept { return _mminus(m); }
	INLINE cmatrix operator -(const cmatrix_slice &m) noexcept { return _msminus<cmatrix_slice,cmatrix>(m); }
	INLINE cmatrix operator -(const cmatrix &m1,const cmatrix &m2)
#if(CXSC_INDEX_CHECK)
	noexcept(false)
#else
	...
	INLINE bool operator ==(const cmatrix &m1,const cmatrix &m2) noexcept { return _mmeq(m1,m2); }
	INLINE bool operator !=(const cmatrix &m1,const cmatrix &m2) noexcept { return _mmneq(m1,m2); }
/*	INLINE bool operator <(const cmatrix &m1,const cmatrix &m2) noexcept { return _mmless(m1,m2); }
	INLINE bool operator <=(const cmatrix &m1,const cmatrix &m2) noexcept { return _mmleq(m1,m2); }
	INLINE bool operator >(const cmatrix &m1,const cmatrix &m2) noexcept { return _mmless(m2,m1); }
	INLINE bool operator >=(const cmatrix &m1,const cmatrix &m2) noexcept { return _mmleq(m2,m1); }
*/
	INLINE bool operator ==(const cmatrix &m1,const cmatrix_slice &ms) noexcept { return _mmseq(m1,ms); }
	INLINE bool operator !=(const cmatrix &m1,const cmatrix_slice &ms) noexcept { return _mmsneq(m1,ms); }
/*	INLINE bool operator <(const cmatrix &m1,const cmatrix_slice &ms) noexcept { return _mmsless(m1,ms); }
	INLINE bool operator <=(const cmatrix &m1,const cmatrix_slice &ms) noexcept { return _mmsleq(m1,ms); }
	INLINE bool operator >(const cmatrix &m1,const cmatrix_slice &ms) noexcept { return _msmless(ms,m1); }
	INLINE bool operator >=(const cmatrix &m1,const cmatrix_slice &ms) noexcept { return _msmleq(ms,m1); }
*/
	INLINE bool operator ==(const cmatrix_slice &m1,const cmatrix_slice &m2) noexcept { return _msmseq(m1,m2); }
	INLINE bool operator !=(const cmatrix_slice &m1,const cmatrix_slice &m2) noexcept { return _msmsneq(m1,m2); }
/*	INLINE bool operator <(const cmatrix_slice &m1,const cmatrix_slice &m2) noexcept { return _msmsless(m1,m2); }
	INLINE bool operator <=(const cmatrix_slice &m1,const cmatrix_slice &m2) noexcept { return _msmsleq(m1,m2); }
	INLINE bool operator >(const cmatrix_slice &m1,const cmatrix_slice &m2) noexcept { return _msmsless(m2,m1); }
	INLINE bool operator >=(const cmatrix_slice &m1,const cmatrix_slice &m2) noexcept { return _msmsleq(m2,m1); }
*/
	INLINE bool operator !(const cmatrix &ms) noexcept { return _mnot(ms); }
	INLINE bool operator !(const cmatrix_slice &ms) noexcept { return _msnot(ms); }
	INLINE std::ostream &operator <<(std::ostream &s,const cmatrix &r) noexcept { return _mout(s,r); }
	INLINE std::ostream &operator <<(std::ostream &s,const cmatrix_slice &r) noexcept { return _msout(s,r); }
	INLINE std::istream &operator >>(std::istream &s,cmatrix &r) noexcept { return _min(s,r); }
	INLINE std::istream &operator >>(std::istream &s,cmatrix_slice &r) noexcept { return _msin(s,r); }
