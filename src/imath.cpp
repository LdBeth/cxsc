...
interval sqrt1px2(const interval& x) noexcept
...
//********************************************************************
//  Constants for:   interval sqrtp1m1(const interval& x) noexcept
//  Blomquist 05.08.03
...
//********************************************************************
interval sqrtp1m1(const interval& x) noexcept
...
interval lnp1(const interval& x) noexcept
...
interval pow    (const interval &a, const interval &b) noexcept
       { 
         interval res; 
         if(Inf(a)==0 && Inf(b)>=0)
         {
...
inline int round_g(const real& x) noexcept 
