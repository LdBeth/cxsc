...
INLINE imatrix::imatrix() noexcept:dat(NULL),lb1(1),ub1(0),lb2(1),ub2(0),xsize(0),ysize(0)
{
}

INLINE imatrix::imatrix(const interval &r) noexcept:lb1(1),ub1(1),lb2(1),ub2(1),xsize(1),ysize(1)
{
	dat=new interval[1];
	*dat=r;
}

INLINE imatrix::imatrix(const real &r) noexcept:lb1(1),ub1(1),lb2(1),ub2(1),xsize(1),ysize(1)
{
	dat=new interval[1];
	*dat=r;
}

INLINE imatrix::imatrix(const imatrix &rm) noexcept:lb1(rm.lb1),ub1(rm.ub1),lb2(rm.lb2),ub2(rm.ub2),xsize(rm.xsize),ysize(rm.ysize)
{
...
INLINE imatrix::imatrix(const rmatrix &rm) noexcept:lb1(rm.lb1),ub1(rm.ub1),lb2(rm.lb2),ub2(rm.ub2),xsize(rm.xsize),ysize(rm.ysize)
{
	dat=new interval[xsize*ysize];
	for(int i=0;i<xsize*ysize;i++)
		dat[i]=rm.dat[i];
...
INLINE ivector::ivector(const imatrix_subv &v) noexcept:l(v.lb),u(v.ub),size(v.size)
{
...
INLINE imatrix::imatrix(const ivector &v) noexcept:lb1(v.l),ub1(v.u),lb2(1),ub2(1),xsize(1),ysize(v.size)
{
...
INLINE imatrix::imatrix(const rvector &v) noexcept:lb1(v.l),ub1(v.u),lb2(1),ub2(1),xsize(1),ysize(v.size)
{
	dat=new interval[v.size];
	for(int i=0;i<v.size;i++)
		dat[i]=v.dat[i];
...
INLINE imatrix::imatrix(const ivector_slice &v) noexcept:lb1(v.start),ub1(v.end),lb2(1),ub2(1),xsize(1),ysize(v.size)
{
	dat=new interval[v.size];
...
INLINE imatrix::imatrix(const rvector_slice &v) noexcept:lb1(v.start),ub1(v.end),lb2(1),ub2(1),xsize(1),ysize(v.size)
{
	dat=new interval[v.size];
	for(int i=0,j=v.start-v.l;i<v.size;i++,j++)
		dat[i]=v.dat[j];
	...
	INLINE imatrix::imatrix(const imatrix_slice &sl) noexcept:lb1(sl.start1),ub1(sl.end1),lb2(sl.start2),ub2(sl.end2),xsize(sl.sxsize),ysize(sl.sysize)
	{
		int i,j;
	...
	INLINE imatrix::imatrix(const rmatrix_slice &sl) noexcept:lb1(sl.start1),ub1(sl.end1),lb2(sl.start2),ub2(sl.end2),xsize(sl.sxsize),ysize(sl.sysize)
	{
		int i,j;
...
#endif
{
	...
	INLINE imatrix_subv &imatrix_subv::operator =(const imatrix_subv &rv) noexcept { return _mvmvassign(*this,rv); }
	INLINE imatrix_subv &imatrix_subv::operator =(const interval &r) noexcept { return _mvsassign(*this,r); }
	...
	INLINE imatrix_subv &imatrix_subv::operator =(const rmatrix_subv &rv) noexcept { return _mvvassign(*this,rvector(rv)); }
	INLINE imatrix_subv &imatrix_subv::operator =(const real &r) noexcept { return _mvsassign(*this,r); }
...
#endif
	{ return _mvvassign(*this,ivector(v)); }
	INLINE imatrix_subv &imatrix_subv::operator *=(const real &c) noexcept { return _mvsmultassign(*this,c); }
	INLINE imatrix_subv &imatrix_subv::operator +=(const real &c) noexcept { return _mvsplusassign(*this,c); }
	INLINE imatrix_subv &imatrix_subv::operator -=(const real &c) noexcept { return _mvsminusassign(*this,c); }
	INLINE imatrix_subv &imatrix_subv::operator /=(const real &c) noexcept { return _mvsdivassign(*this,c); }
	INLINE imatrix &imatrix::operator =(const interval &r) noexcept { return _msassign(*this,r); }
	INLINE imatrix &imatrix::operator =(const imatrix &m) noexcept { return _mmassign<imatrix,imatrix,interval>(*this,m,interval(0,0)); }
	INLINE imatrix &imatrix::operator =(const imatrix_slice &ms) noexcept { return _mmsassign<imatrix,imatrix_slice,interval>(*this,ms); }
	INLINE imatrix &imatrix::operator =(const ivector &v) noexcept { return _mvassign<imatrix,ivector,interval>(*this,v); }
	INLINE imatrix &imatrix::operator =(const ivector_slice &v) noexcept { return _mvassign<imatrix,ivector,interval>(*this,ivector(v)); }
	INLINE imatrix &imatrix::operator =(const real &r) noexcept { return _msassign(*this,interval(r)); }
	INLINE imatrix &imatrix::operator =(const rmatrix &m) noexcept { return _mmassign<imatrix,rmatrix,interval>(*this,m,interval(0,0)); }
	INLINE imatrix &imatrix::operator =(const rmatrix_slice &ms) noexcept { return _mmsassign<imatrix,rmatrix_slice,interval>(*this,ms); }
	INLINE imatrix &imatrix::operator =(const rvector &v) noexcept { return _mvassign<imatrix,rvector,interval>(*this,v); }
	INLINE imatrix &imatrix::operator =(const rvector_slice &v) noexcept { return _mvassign<imatrix,rvector,interval>(*this,rvector(v)); }
	INLINE imatrix::operator void*() noexcept { return _mvoid(*this); }
	...
	INLINE imatrix_slice &imatrix_slice::operator =(const interval &r) noexcept { return _mssassign(*this,r); }
...
#endif
	{ return _msmsassign(*this,ms); }
	INLINE imatrix_slice &imatrix_slice::operator =(const real &r) noexcept { return _mssassign(*this,r); }
	...
	INLINE imatrix_slice::operator void*() noexcept { return _msvoid(*this); }
	
	INLINE ivector operator /(const imatrix_subv &rv, const interval &s) noexcept { return _mvsdiv<imatrix_subv,interval,ivector>(rv,s); }
	INLINE ivector operator *(const imatrix_subv &rv, const interval &s) noexcept { return _mvsmult<imatrix_subv,interval,ivector>(rv,s); }
	INLINE ivector operator *(const interval &s, const imatrix_subv &rv) noexcept { return _mvsmult<imatrix_subv,interval,ivector>(rv,s); }
	INLINE imatrix_subv &imatrix_subv::operator *=(const interval &c) noexcept { return _mvsmultassign(*this,c); }
	INLINE imatrix_subv &imatrix_subv::operator +=(const interval &c) noexcept { return _mvsplusassign(*this,c); }
	INLINE imatrix_subv &imatrix_subv::operator -=(const interval &c) noexcept { return _mvsminusassign(*this,c); }
	INLINE imatrix_subv &imatrix_subv::operator /=(const interval &c) noexcept { return _mvsdivassign(*this,c); }
	INLINE ivector abs(const imatrix_subv &mv) noexcept { return _mvabs<imatrix_subv,ivector>(mv); }
	...
	INLINE rvector diam(const imatrix_subv &mv) noexcept { return _mvdiam<imatrix_subv,rvector>(mv); }
	INLINE rvector mid(const imatrix_subv &mv) noexcept { return _mvmid<imatrix_subv,rvector>(mv); }
	INLINE rvector Inf(const imatrix_subv &mv) noexcept { return _mvinf<imatrix_subv,rvector>(mv); }
	INLINE rvector Sup(const imatrix_subv &mv) noexcept { return _mvsup<imatrix_subv,rvector>(mv); }
	...
	INLINE imatrix_subv &SetSup(imatrix_subv &iv,const real &r) noexcept { return _mvssetsup(iv,r); }
	INLINE imatrix_subv &SetInf(imatrix_subv &iv,const real &r) noexcept { return _mvssetinf(iv,r); }
	INLINE imatrix_subv &UncheckedSetSup(imatrix_subv &iv,const real &r) noexcept { return _mvsusetsup(iv,r); }
	INLINE imatrix_subv &SetUncheckedInf(imatrix_subv &iv,const real &r) noexcept { return _mvsusetinf(iv,r); }
	INLINE ivector &ivector::operator =(const imatrix_subv &mv) noexcept { return _vmvassign<ivector,imatrix_subv,interval>(*this,mv); }
	INLINE ivector_slice &ivector_slice::operator =(const imatrix_subv &mv) noexcept { return _vsvassign(*this,ivector(mv)); }
	...
	*/
	INLINE imatrix _imatrix(const imatrix &rm) noexcept { return rm; }
	/*!
	\deprecated use standard contructors for typecasting

	\sa cxsc::imatrix::imatrix(const ivector &v)
	*/
	INLINE imatrix _imatrix(const ivector &v) noexcept { return imatrix(v); }
	/*!
	\deprecated use standard contructors for typecasting

	\sa cxsc::imatrix::imatrix(const ivector_slice &v)
	*/
	INLINE imatrix _imatrix(const ivector_slice &v) noexcept { return imatrix(v); }
	/*!
	\deprecated use standard contructors for typecasting

	\sa cxsc::imatrix::imatrix(const interval &r)
	*/
	INLINE imatrix _imatrix(const interval &r) noexcept { return imatrix(r); }
	...
	INLINE void Resize(imatrix &A) noexcept { _mresize(A);}
	...
	INLINE imatrix abs(const imatrix &m) noexcept { return _mabs<imatrix,imatrix>(m); }
	...
	INLINE imatrix abs(const imatrix_slice &ms) noexcept { return _msabs<imatrix_slice,imatrix>(ms); }
	INLINE rmatrix absmin(const imatrix_slice &m) noexcept { 
           rmatrix A(Lb(m,1),Ub(m,1),Lb(m,2),Ub(m,2));
           for(int i=Lb(m,1) ; i<=Ub(m,1) ; i++)
             for(int j=Lb(m,2) ; j<=Ub(m,2) ; j++)
               A[i][j] = AbsMin(m[i][j]);
	...
	INLINE rmatrix absmax(const imatrix_slice &m) noexcept { 
           rmatrix A(Lb(m,1),Ub(m,1),Lb(m,2),Ub(m,2));
           for(int i=Lb(m,1) ; i<=Ub(m,1) ; i++)
             for(int j=Lb(m,2) ; j<=Ub(m,2) ; j++)
               A[i][j] = AbsMax(m[i][j]);
	...
	INLINE rmatrix diam(const imatrix &m) noexcept { return _mdiam<imatrix,rmatrix>(m); }
	INLINE rmatrix diam(const imatrix_slice &ms) noexcept { return _msdiam<imatrix_slice,rmatrix>(ms); }
	INLINE rmatrix mid(const imatrix &m) noexcept { return _mmid<imatrix,rmatrix>(m); }
	INLINE rmatrix mid(const imatrix_slice &ms) noexcept { return _msmid<imatrix_slice,rmatrix>(ms); }
	INLINE rmatrix Inf(const imatrix &m) noexcept { return _minf<imatrix,rmatrix>(m); }
	INLINE rmatrix Sup(const imatrix &m) noexcept { return _msup<imatrix,rmatrix>(m); }
	INLINE rmatrix Inf(const imatrix_slice &m) noexcept { return _msinf<imatrix_slice,rmatrix>(m); }
	INLINE rmatrix Sup(const imatrix_slice &m) noexcept { return _mssup<imatrix_slice,rmatrix>(m); }
...
#endif
	{ _smconstr(*this,m); }
//	INLINE interval interval::_interval(const imatrix &m) noexcept(false) { _smconstr(*this,m); return *this; }
	INLINE imatrix operator *(const interval &c, const imatrix &m) noexcept { return _smmult<interval,imatrix,imatrix>(c,m); }
	INLINE imatrix operator *(const interval &c, const imatrix_slice &ms) noexcept { return _smsmult<interval,imatrix_slice,imatrix>(c,ms); }
	INLINE imatrix operator *(const imatrix &m,const interval &c) noexcept { return _smmult<interval,imatrix,imatrix>(c,m); }
	INLINE imatrix operator *(const imatrix_slice &ms,const interval &c) noexcept { return _smsmult<interval,imatrix_slice,imatrix>(c,ms); }
	INLINE imatrix &operator *=(imatrix &m,const interval &c) noexcept { return _msmultassign(m,c); }
	INLINE imatrix_slice &imatrix_slice::operator *=(const imatrix &m)
#if(CXSC_INDEX_CHECK)
	noexcept(false)
#else
...
#endif
	{ return (*this=*this*m); }
	INLINE imatrix_slice &imatrix_slice::operator *=(const interval &c) noexcept { return _mssmultassign(*this,c); }
	INLINE imatrix operator /(const imatrix &m,const interval &c) noexcept { return _msdiv<imatrix,interval,imatrix>(m,c); }
	INLINE imatrix operator /(const imatrix_slice &ms, const interval &c) noexcept { return _mssdiv<imatrix_slice,interval,imatrix>(ms,c); }
	INLINE imatrix &operator /=(imatrix &m,const interval &c) noexcept { return _msdivassign(m,c); }
	INLINE imatrix_slice &imatrix_slice::operator /=(const interval &c) noexcept { return _mssdivassign(*this,c); }
	INLINE imatrix operator *(const real &c, const imatrix &m) noexcept { return _smmult<real,imatrix,imatrix>(c,m); }
	INLINE imatrix operator *(const real &c, const imatrix_slice &ms) noexcept { return _smsmult<real,imatrix_slice,imatrix>(c,ms); }
	INLINE imatrix operator *(const imatrix &m,const real &c) noexcept { return _smmult<real,imatrix,imatrix>(c,m); }
	INLINE imatrix operator *(const imatrix_slice &ms,const real &c) noexcept { return _smsmult<real,imatrix_slice,imatrix>(c,ms); }
	INLINE imatrix &operator *=(imatrix &m,const real &c) noexcept { return _msmultassign(m,c); }
	INLINE imatrix_slice &imatrix_slice::operator *=(const rmatrix &m)
#if(CXSC_INDEX_CHECK)
	noexcept(false)
#else
...
#endif
	{ return (*this=*this*m); }
	INLINE imatrix_slice &imatrix_slice::operator *=(const real &c) noexcept { return _mssmultassign(*this,c); }
	INLINE imatrix operator /(const imatrix &m,const real &c) noexcept { return _msdiv<imatrix,real,imatrix>(m,c); }
	INLINE imatrix operator /(const imatrix_slice &ms, const real &c) noexcept { return _mssdiv<imatrix_slice,real,imatrix>(ms,c); }
	INLINE imatrix &operator /=(imatrix &m,const real &c) noexcept { return _msdivassign(m,c); }
	INLINE imatrix_slice &imatrix_slice::operator /=(const real &c) noexcept { return _mssdivassign(*this,c); }
//	INLINE interval::interval(const rmatrix &m) noexcept(false) { _smconstr(*this,m); }
//	INLINE interval interval::_interval(const imatrix &m) noexcept(false) { _smconstr(*this,m); return *this; }
	INLINE imatrix operator *(const interval &c, const rmatrix &m) noexcept { return _smmult<interval,rmatrix,imatrix>(c,m); }
	INLINE imatrix operator *(const interval &c, const rmatrix_slice &ms) noexcept { return _smsmult<interval,rmatrix_slice,imatrix>(c,ms); }
	INLINE imatrix operator *(const rmatrix &m,const interval &c) noexcept { return _smmult<interval,rmatrix,imatrix>(c,m); }
	INLINE imatrix operator *(const rmatrix_slice &ms,const interval &c) noexcept { return _smsmult<interval,rmatrix_slice,imatrix>(c,ms); }
	INLINE imatrix operator /(const rmatrix &m,const interval &c) noexcept { return _msdiv<rmatrix,interval,imatrix>(m,c); }
	INLINE imatrix operator /(const rmatrix_slice &ms, const interval &c) noexcept { return _mssdiv<rmatrix_slice,interval,imatrix>(ms,c); }
	...
	INLINE const imatrix &operator +(const imatrix &m1) noexcept { return m1; }
	INLINE imatrix operator +(const imatrix_slice &ms) noexcept { return imatrix(ms); }
	...
	INLINE imatrix operator -(const imatrix &m) noexcept { return _mminus(m); }
	INLINE imatrix operator -(const imatrix_slice &ms) noexcept { return _msminus<imatrix_slice,imatrix>(ms); }
	INLINE imatrix operator -(const imatrix &m1,const imatrix &m2)
#if(CXSC_INDEX_CHECK)
	noexcept(false)
#else
...
#endif
	{ return _msmssectassign(*this,ms2); }
	INLINE bool operator ==(const imatrix &m1,const imatrix &m2) noexcept { return _mmeq(m1,m2); }
	INLINE bool operator !=(const imatrix &m1,const imatrix &m2) noexcept { return _mmneq(m1,m2); }
	INLINE bool operator <(const imatrix &m1,const imatrix &m2) noexcept { return _mmless(m1,m2); }
	INLINE bool operator <=(const imatrix &m1,const imatrix &m2) noexcept { return _mmleq(m1,m2); }
	INLINE bool operator >(const imatrix &m1,const imatrix &m2) noexcept { return _mmless(m2,m1); }
	INLINE bool operator >=(const imatrix &m1,const imatrix &m2) noexcept { return _mmleq(m2,m1); }
	INLINE bool operator ==(const imatrix &m1,const imatrix_slice &ms) noexcept { return _mmseq(m1,ms); }
	INLINE bool operator !=(const imatrix &m1,const imatrix_slice &ms) noexcept { return _mmsneq(m1,ms); }
	INLINE bool operator <(const imatrix &m1,const imatrix_slice &ms) noexcept { return _mmsless(m1,ms); }
	INLINE bool operator <=(const imatrix &m1,const imatrix_slice &ms) noexcept { return _mmsleq(m1,ms); }
	INLINE bool operator >(const imatrix &m1,const imatrix_slice &ms) noexcept { return _msmless(ms,m1); }
	INLINE bool operator >=(const imatrix &m1,const imatrix_slice &ms) noexcept { return _msmleq(ms,m1); }
	INLINE bool operator ==(const imatrix_slice &m1,const imatrix_slice &m2) noexcept { return _msmseq(m1,m2); }
	INLINE bool operator !=(const imatrix_slice &m1,const imatrix_slice &m2) noexcept { return _msmsneq(m1,m2); }
	INLINE bool operator <(const imatrix_slice &m1,const imatrix_slice &m2) noexcept { return _msmsless(m1,m2); }
	INLINE bool operator <=(const imatrix_slice &m1,const imatrix_slice &m2) noexcept { return _msmsleq(m1,m2); }
	INLINE bool operator >(const imatrix_slice &m1,const imatrix_slice &m2) noexcept { return _msmsless(m2,m1); }
	INLINE bool operator >=(const imatrix_slice &m1,const imatrix_slice &m2) noexcept { return _msmsleq(m2,m1); }
	INLINE bool operator !(const imatrix &ms) noexcept { return _mnot(ms); }
	INLINE bool operator !(const imatrix_slice &ms) noexcept { return _msnot(ms); }
	INLINE std::ostream &operator <<(std::ostream &s,const imatrix &r) noexcept { return _mout(s,r); }
	INLINE std::ostream &operator <<(std::ostream &s,const imatrix_slice &r) noexcept { return _msout(s,r); }
	INLINE std::istream &operator >>(std::istream &s,imatrix &r) noexcept { return _min(s,r); }
	INLINE std::istream &operator >>(std::istream &s,imatrix_slice &r) noexcept { return _msin(s,r); }
