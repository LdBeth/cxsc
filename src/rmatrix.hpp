...
template <class V,class MV> friend  V &_vmvsetre(V &rv,const MV &v)
	...
	explicit INLINE rmatrix_subv (real *d, const int &l, const int &u, const int &s, const int &st, const int &o) noexcept:dat(d),lb(l),ub(u),size(s),start(st),offset(o) { }
        public: 
	//! Constructor of class rmatrix_subv
	INLINE rmatrix_subv(const rmatrix_subv &v) noexcept:dat(v.dat),lb(v.lb),ub(v.ub),size(v.size),start(v.start),offset(v.offset) { }
	public:

	//---------------------- Standardfunktionen ------------------------

	friend INLINE rvector::rvector(const rmatrix_subv &) noexcept;
	//! Implementation of standard assigning operator
	INLINE rmatrix_subv &operator =(const rmatrix_subv &rv) noexcept;
	//! Implementation of standard assigning operator
	INLINE rmatrix_subv &operator =(const real &r) noexcept;
	//! Implementation of standard assigning operator
	...
	friend INLINE int Lb(const rmatrix_subv &rv) noexcept { return rv.lb; }
	//! Returns the upper bound of the vector
	friend INLINE int Ub(const rmatrix_subv &rv) noexcept { return rv.ub; }
	//! Returns the size of the vector
	friend INLINE int VecLen(const rmatrix_subv &rv) noexcept { return rv.size; }
	...
	INLINE rmatrix_subv &operator ()() noexcept { return *this; }
	...
	INLINE rmatrix_subv &operator *=(const real &c) noexcept;
...
template <class MV,class V> friend  MV &_mvvassign(MV &v,const V &rv)
 ...
 template <class VS,class M,class S> friend 	 VS &_vsmlimultassign(VS &v,const M &m)
	...
	INLINE rmatrix(const rmatrix &rm) noexcept;
	//! Constructor of class rmatrix
	INLINE rmatrix(const rmatrix_slice &rm) noexcept;
	//! Constructor of class rmatrix
	INLINE rmatrix() noexcept;
	//! Constructor of class rmatrix
...
#endif
	//! Constructor of class rmatrix
	explicit INLINE rmatrix(const rvector &v) noexcept;
	//! Constructor of class rmatrix
	explicit INLINE rmatrix(const rvector_slice &v) noexcept;
	//! Constructor of class rmatrix
	explicit INLINE rmatrix(const real &r) noexcept;
	//! Constructor of class rmatrix
	...
	//! Implementation of standard assigning operator
	INLINE rmatrix &operator =(const real &r) noexcept;
	//! Implementation of standard assigning operator
	INLINE rmatrix &operator =(const rmatrix &m) noexcept;
	//! Implementation of standard assigning operator
	INLINE rmatrix &operator =(const rmatrix_slice &ms) noexcept;
	//! Implementation of standard assigning operator
	INLINE rmatrix &operator =(const rvector &v) noexcept;
	//! Implementation of standard assigning operator
	INLINE rmatrix &operator =(const rvector_slice &v) noexcept;
	//! Implementation of standard assigning operator
	...
	INLINE ~rmatrix() noexcept { delete [] dat; }
	...
	INLINE rmatrix &operator ()() noexcept { return *this; }
...
template <class V,class MS,class S> friend void _vmsconstr(V &v,const MS &m)
 ...
 template <class MS1,class MS2,class E> friend 	 E _msmslimult(const MS1 &ms1, const MS2 &ms2)
	...
	explicit INLINE rmatrix_slice(rmatrix &a,const int &l1,const int &u1,const int &l2, const int &u2) noexcept:dat(a.dat),offset1(l1-a.lb1),offset2(l2-a.lb2),mxsize(a.xsize),mysize(a.ysize),start1(l1),end1(u1),start2(l2),end2(u2),sxsize(u2-l2+1),sysize(u1-l1+1) { }
	//! Constructor of class rmatrix_slice
	explicit INLINE rmatrix_slice(rmatrix_slice &a,const int &l1,const int &u1,const int &l2, const int &u2) noexcept:dat(a.dat),offset1(a.offset1+l1-a.start1),offset2(a.offset2+l2-a.start2),mxsize(a.mxsize),mysize(a.mysize),start1(l1),end1(u1),start2(l2),end2(u2),sxsize(u2-l2+1),sysize(u1-l1+1) { }
	public: 
	//! Constructor of class rmatrix_slice
	INLINE rmatrix_slice(const rmatrix_slice &ms) noexcept:dat(ms.dat),offset1(ms.offset1),offset2(ms.offset2),mxsize(ms.mxsize),mysize(ms.mysize),start1(ms.start1),end1(ms.end1),start2(ms.start2),end2(ms.end2),sxsize(ms.sxsize),sysize(ms.sysize) { }
	public:
	...
	noexcept;
#endif
	friend INLINE rmatrix::rmatrix(const rmatrix_slice &) noexcept;
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE rmatrix_slice &operator =(const real &r) noexcept;
	//! Implementation of standard assigning operator
...
#endif
	//! Operator for accessing the whole matrix
	INLINE rmatrix_slice &operator ()() noexcept { return *this; }
	//! Operator for accessing a part of the matrix
	INLINE rmatrix_slice operator ()(const int &m, const int &n)
#if(CXSC_INDEX_CHECK)
	noexcept(false);
...
#endif
	//! Implementation of multiplication and allocation operation
	INLINE rmatrix_slice &operator *=(const real &c) noexcept;
	//! Implementation of division and allocation operation
	INLINE rmatrix_slice &operator /=(const real &c) noexcept;
	INLINE operator void*() noexcept;
//#else
...
//=======================Vector / Scalar =========================
	...
	INLINE rvector operator /(const rmatrix_subv &rv, const real &s) noexcept;
	//! Implementation of multiplication operation
	INLINE rvector operator *(const rmatrix_subv &rv, const real &s) noexcept;
	//! Implementation of multiplication operation
	INLINE rvector operator *(const real &s, const rmatrix_subv &rv) noexcept;
	//! Returns the absolute value of the matrix
	INLINE rvector abs(const rmatrix_subv &mv) noexcept;
...
//===================== Matrix Functions =============================
	...
	INLINE rmatrix _rmatrix(const rmatrix &rm) noexcept;
	//! Deprecated typecast, which only exist for the reason of compatibility with older versions of C-XSC
	INLINE rmatrix _rmatrix(const rvector &v) noexcept;
	//! Deprecated typecast, which only exist for the reason of compatibility with older versions of C-XSC
	INLINE rmatrix _rmatrix(const rvector_slice &v) noexcept;
	//! Deprecated typecast, which only exist for the reason of compatibility with older versions of C-XSC
	INLINE rmatrix _rmatrix(const real &r) noexcept;
...
#endif
	//! Resizes the matrix
	INLINE void Resize(rmatrix &A) noexcept;
	//! Resizes the matrix
	...
	//! Returns the absolute value of the matrix
	INLINE rmatrix abs(const rmatrix &m) noexcept;
	//! Returns the absolute value of the matrix
	INLINE rmatrix abs(const rmatrix_slice &ms) noexcept;
	//! Returns Ostrowski comparison matrix
	INLINE rmatrix CompMat(const rmatrix &m) noexcept;

//===================== Matrix / Scalar ===============================

	//! Implementation of multiplication operation
	INLINE rmatrix operator *(const real &c, const rmatrix &m) noexcept;
	//! Implementation of multiplication operation
	INLINE rmatrix operator *(const real &c, const rmatrix_slice &ms) noexcept;
	//! Implementation of multiplication operation
	INLINE rmatrix operator *(const rmatrix &m,const real &c) noexcept;
	//! Implementation of multiplication operation
	INLINE rmatrix operator *(const rmatrix_slice &ms,const real &c) noexcept;
	//! Implementation of multiplication and allocation operation
	INLINE rmatrix &operator *=(rmatrix &m,const real &c) noexcept;
	//! Implementation of division operation
	INLINE rmatrix operator /(const rmatrix &m,const real &c) noexcept;
	//! Implementation of division operation
	INLINE rmatrix operator /(const rmatrix_slice &ms, const real &c) noexcept;
...
//================ Matrix / Matrix ============================
	...
	INLINE const rmatrix &operator +(const rmatrix &m1) noexcept;
	//! Implementation of positive sign operation
	INLINE rmatrix operator +(const rmatrix_slice &ms) noexcept;
	//! Implementation of addition operation
...
//-------------- Matrix - Matrix   -------------------------
	...
	INLINE bool operator ==(const rmatrix &m1,const rmatrix &m2) noexcept;
	...
	INLINE bool operator >=(const rmatrix &m1,const rmatrix &m2) noexcept;
	//! Implementation of standard equality operation
	INLINE bool operator ==(const rmatrix &m1,const rmatrix_slice &ms) noexcept;
	//! Implementation of standard negated equality operation
	INLINE bool operator !=(const rmatrix &m1,const rmatrix_slice &ms) noexcept;
	//! Implementation of standard less-than operation
	INLINE bool operator <(const rmatrix &m1,const rmatrix_slice &ms) noexcept;
...
//---------------- Matrix - Matrix_slice ----------------------
	...
	//! Implementation of standard equality operation
	INLINE bool operator ==(const rmatrix_slice &m1,const rmatrix_slice &m2) noexcept;
	//! Implementation of standard negated equality operation
	INLINE bool operator !=(const rmatrix_slice &m1,const rmatrix_slice &m2) noexcept;
	//! Implementation of standard less-than operation
	INLINE bool operator <(const rmatrix_slice &m1,const rmatrix_slice &m2) noexcept;
...
//=================== Not Operator =============================
	...
	INLINE bool operator !(const rmatrix &ms) noexcept;
	//! Implementation of standard negation operation
	INLINE bool operator !(const rmatrix_slice &ms) noexcept;

//======================== Input / Output ========================

	//! Implementation of standard output method
	INLINE std::ostream &operator <<(std::ostream &s,const rmatrix &r) noexcept;
	//! Implementation of standard output method
	INLINE std::ostream &operator <<(std::ostream &s,const rmatrix_slice &r) noexcept;
	//! Implementation of standard input method
	INLINE std::istream &operator >>(std::istream &s,rmatrix &r) noexcept;
	//! Implementation of standard input method
	INLINE std::istream &operator >>(std::istream &s,rmatrix_slice &r) noexcept;
