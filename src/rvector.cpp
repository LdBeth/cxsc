...
//	INLINE void accumulate(dotprecision &dp, const rvector & rv1, const rmatrix_subv &rv2) noexcept(false);
//	INLINE void accumulate(dotprecision &dp, const rmatrix_subv & rv1, const rvector &rv2) noexcept(false);
...
//	INLINE void accumulate(idotprecision &dp, const rvector & rv1, const rmatrix_subv &rv2) noexcept(false);
//	INLINE void accumulate(idotprecision &dp, const rmatrix_subv & rv1, const rvector &rv2) noexcept(false);
...
//	INLINE void accumulate(cdotprecision &dp, const rvector & rv1, const rmatrix_subv &rv2) noexcept(false);
//	INLINE void accumulate(cdotprecision &dp, const rmatrix_subv & rv1, const rvector &rv2) noexcept(false);
...
//	INLINE void accumulate(cidotprecision &dp, const rvector & rv1, const rmatrix_subv &rv2) noexcept(false);
//	INLINE void accumulate(cidotprecision &dp, const rmatrix_subv & rv1, const rvector &rv2) noexcept(false);
