...
rmatrix<U> _ms_mult(const rmatrix<S> &m,const S &s,const U &u=0) noexcept;

template <class S,class S,class R>
cxscvector<R> _mv_mult(const rmatrix<S> &m,const rvector &v,R) noexcept;

template <class S,class S, class R>
rvector _vm_mult(const rvector &v,const rmatrix<S> &m,R) noexcept;
*/
