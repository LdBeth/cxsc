...
template <class V,class MV> friend  V &_vmvsectassign(V &rv,const MV &v)
	...
	explicit INLINE cimatrix_subv (cinterval *d, const int &l, const int &u, const int &s, const int &st, const int &o) noexcept:dat(d),lb(l),ub(u),size(s),start(st),offset(o) { }
        public:
	//! Constructor of class cimatrix_subv
	INLINE cimatrix_subv(const cimatrix_subv &v) noexcept:dat(v.dat),lb(v.lb),ub(v.ub),size(v.size),start(v.start),offset(v.offset) { }
	public:
	...
	//! Implementation of standard assigning operator
	cimatrix_subv &operator =(const cimatrix_subv &rv) noexcept;
	//! Implementation of standard assigning operator
	cimatrix_subv &operator =(const cinterval &r) noexcept;
	//! Implementation of standard assigning operator
	...
	// Real
	//! Implementation of standard assigning operator
	INLINE cimatrix_subv &operator =(const real &r) noexcept;
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE cimatrix_subv &operator =(const rmatrix_subv &rv) noexcept;

	// complex
	//! Implementation of standard assigning operator
	INLINE cimatrix_subv &operator =(const complex &r) noexcept;
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE cimatrix_subv &operator =(const cmatrix_subv &rv) noexcept;

	// interval
	//! Implementation of standard assigning operator
	INLINE cimatrix_subv &operator =(const interval &r) noexcept;
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE cimatrix_subv &operator =(const imatrix_subv &rv) noexcept;

	//! Returns the lower bound of the vector
	friend INLINE int Lb(const cimatrix_subv &rv) noexcept { return rv.lb; }
	//! Returns the upper bound of the vector
	friend INLINE int Ub(const cimatrix_subv &rv) noexcept { return rv.ub; }
	//! Returns the size of the vector
	friend INLINE int VecLen(const cimatrix_subv &rv) noexcept { return rv.size; }
	...
	INLINE cimatrix_subv &operator ()() noexcept { return *this; }
	...
	INLINE cimatrix_subv &operator *=(const cinterval &c) noexcept;
	...
	// real
	//! Implementation of multiplication and allocation operation
	INLINE cimatrix_subv &operator *=(const real &c) noexcept;
	//! Implementation of addition and allocation operation
	INLINE cimatrix_subv &operator +=(const real &c) noexcept;
	//! Implementation of subtraction and allocation operation
	INLINE cimatrix_subv &operator -=(const real &c) noexcept;
	...
	// complex
	//! Implementation of multiplication and allocation operation
	INLINE cimatrix_subv &operator *=(const complex &c) noexcept;
	//! Implementation of addition and allocation operation
	INLINE cimatrix_subv &operator +=(const complex &c) noexcept;
	//! Implementation of subtraction and allocation operation
	INLINE cimatrix_subv &operator -=(const complex &c) noexcept;
	...
	// interval
	//! Implementation of multiplication and allocation operation
	INLINE cimatrix_subv &operator *=(const interval &c) noexcept;
	//! Implementation of addition and allocation operation
	INLINE cimatrix_subv &operator +=(const interval &c) noexcept;
	//! Implementation of subtraction and allocation operation
	INLINE cimatrix_subv &operator -=(const interval &c) noexcept;
...
template <class M,class V,class S> friend  M &_mvassign(M &m,const V &v) noexcept;
 ...
 template <class M,class E> friend 	 E _mim(const M &m) noexcept;
	friend INLINE rmatrix SupRe(const cimatrix &v) noexcept;
	friend INLINE rmatrix SupIm(const cimatrix &v) noexcept;
	friend INLINE rmatrix InfRe(const cimatrix &v) noexcept;
	friend INLINE rmatrix InfIm(const cimatrix &v) noexcept;
...
// cinterval
	...
	INLINE cimatrix(const cimatrix &rm) noexcept;
	//! Constructor of class cimatrix
	INLINE cimatrix(const cimatrix_slice &rm) noexcept;
	//! Constructor of class cimatrix
	INLINE cimatrix(const scimatrix &rm);
	//! Constructor of class cimatrix
	INLINE cimatrix(const scimatrix_slice &rm);
	//! Constructor of class cimatrix
	INLINE cimatrix() noexcept;
	//! Constructor of class cimatrix
...
#endif
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const civector &v) noexcept;
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const civector_slice &v) noexcept;
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const cinterval &r) noexcept;
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const cinterval &r) noexcept;
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const cimatrix &m) noexcept;
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const cimatrix_slice &ms) noexcept;
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const scimatrix &m);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const scimatrix_slice &ms);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const civector &v) noexcept;
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const civector_slice &v) noexcept;
//  real
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const real &r) noexcept;
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const rmatrix &rm) noexcept;
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const rmatrix_slice &rm) noexcept;
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const srmatrix &rm);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const srmatrix_slice &rm);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const rvector &v) noexcept;
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const rvector_slice &v) noexcept;
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const real &r) noexcept;
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const rmatrix &m) noexcept;
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const rmatrix_slice &ms) noexcept;
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const srmatrix &m);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const srmatrix_slice &ms);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const rvector &v) noexcept;
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const rvector_slice &v) noexcept;

//  complex
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const complex &r) noexcept;
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const cmatrix &rm) noexcept;
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const cmatrix_slice &rm) noexcept;
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const scmatrix &rm);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const scmatrix_slice &rm);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const cvector &v) noexcept;
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const cvector_slice &v) noexcept;
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const complex &r) noexcept;
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const cmatrix &m) noexcept;
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const cmatrix_slice &ms) noexcept;
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const scmatrix &m);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const scmatrix_slice &ms);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const cvector &v) noexcept;
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const cvector_slice &v) noexcept;

//  interval
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const interval &r) noexcept;
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const imatrix &rm) noexcept;
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const imatrix_slice &rm) noexcept;
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const simatrix &rm);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const simatrix_slice &rm);
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const ivector &v) noexcept;
	//! Constructor of class cimatrix
	explicit INLINE cimatrix(const ivector_slice &v) noexcept;
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const interval &r) noexcept;
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const imatrix &m) noexcept;
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const imatrix_slice &ms) noexcept;
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const simatrix &m);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const simatrix_slice &ms);
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const ivector &v) noexcept;
	//! Implementation of standard assigning operator
	INLINE cimatrix &operator =(const ivector_slice &v) noexcept;

	//--------------------------- Destruktoren -----------------------------

	INLINE ~cimatrix() noexcept { delete [] dat; }
	...
	INLINE cimatrix &operator ()() noexcept { return *this; }
...
template <class V,class MS,class S> friend  void _vmsconstr(V &v,const MS &m)
 ...
 template <class MS,class E> friend 	 E _msim(const MS &ms) noexcept;
	friend INLINE rmatrix SupRe(const cimatrix_slice &v) noexcept;
	friend INLINE rmatrix SupIm(const cimatrix_slice &v) noexcept;
	friend INLINE rmatrix InfRe(const cimatrix_slice &v) noexcept;
	friend INLINE rmatrix InfIm(const cimatrix_slice &v) noexcept;
 ...
 template <class MS> friend 	std::istream &_msin(std::istream &s,MS &r) noexcept;
	...
	explicit INLINE cimatrix_slice(cimatrix &a,const int &l1,const int &u1,const int &l2, const int &u2) noexcept:dat(a.dat),offset1(l1-a.lb1),offset2(l2-a.lb2),mxsize(a.xsize),mysize(a.ysize),start1(l1),end1(u1),start2(l2),end2(u2),sxsize(u2-l2+1),sysize(u1-l1+1) { }
	//! Constructor of class cimatrix_slice
	explicit INLINE cimatrix_slice(cimatrix_slice &a,const int &l1,const int &u1,const int &l2, const int &u2) noexcept:dat(a.dat),offset1(a.offset1+l1-a.start1),offset2(a.offset2+l2-a.start2),mxsize(a.mxsize),mysize(a.mysize),start1(l1),end1(u1),start2(l2),end2(u2),sxsize(u2-l2+1),sysize(u1-l1+1) { }
	public: 
	//! Constructor of class cimatrix_slice
	INLINE cimatrix_slice(const cimatrix_slice &ms) noexcept:dat(ms.dat),offset1(ms.offset1),offset2(ms.offset2),mxsize(ms.mxsize),mysize(ms.mysize),start1(ms.start1),end1(ms.end1),start2(ms.start2),end2(ms.end2),sxsize(ms.sxsize),sysize(ms.sysize) { }
	public:
	...
	noexcept;
#endif
	friend INLINE cimatrix::cimatrix(const cimatrix_slice &) noexcept;
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE cimatrix_slice &operator =(const cinterval &r) noexcept;
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE cimatrix_slice &operator =(const real &r) noexcept;
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE cimatrix_slice &operator =(const interval &r) noexcept;
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE cimatrix_slice &operator =(const complex &r) noexcept;
	//! Implementation of standard assigning operator
	...
	//! Operator for accessing the whole matrix
	INLINE cimatrix_slice &operator ()() noexcept { return *this; }
	//! Operator for accessing a part of the matrix
	INLINE cimatrix_slice operator ()(const int &m, const int &n)
#if(CXSC_INDEX_CHECK)
	noexcept(false);
	...
	//! Implementation of addition and allocation operation
	INLINE cimatrix_slice &operator +=(const cinterval &c) noexcept;
	//! Implementation of subtraction and allocation operation
	INLINE cimatrix_slice &operator -=(const cinterval &c) noexcept;
	//! Implementation of multiplication and allocation operation
	INLINE cimatrix_slice &operator *=(const cinterval &c) noexcept;
	...
	//! Implementation of addition and allocation operation
	INLINE cimatrix_slice &operator +=(const real &c) noexcept;
	//! Implementation of subtraction and allocation operation
	INLINE cimatrix_slice &operator -=(const real &c) noexcept;
	//! Implementation of multiplication and allocation operation
	INLINE cimatrix_slice &operator *=(const real &c) noexcept;
	...
	//! Implementation of addition and allocation operation
	INLINE cimatrix_slice &operator +=(const complex &c) noexcept;
	//! Implementation of subtraction and allocation operation
	INLINE cimatrix_slice &operator -=(const complex &c) noexcept;
	//! Implementation of multiplication and allocation operation
	INLINE cimatrix_slice &operator *=(const complex &c) noexcept;
	...
	//! Implementation of addition and allocation operation
	INLINE cimatrix_slice &operator +=(const interval &c) noexcept;
	//! Implementation of subtraction and allocation operation
	INLINE cimatrix_slice &operator -=(const interval &c) noexcept;
	//! Implementation of multiplication and allocation operation
	INLINE cimatrix_slice &operator *=(const interval &c) noexcept;
...
//=======================Vector / Scalar =========================
	...
	INLINE civector operator /(const cimatrix_subv &rv, const cinterval &s) noexcept;
	//! Implementation of multiplication operation
	INLINE civector operator *(const cimatrix_subv &rv, const cinterval &s) noexcept;
	//! Implementation of multiplication operation
	INLINE civector operator *(const cinterval &s, const cimatrix_subv &rv) noexcept;
	//! Returns the absolute value of the matrix
	INLINE ivector abs(const cimatrix_subv &mv) noexcept;
	//! Returns the diameter of the matrix
	INLINE cvector diam(const cimatrix_subv &mv) noexcept;
	//! Returns the middle of the matrix
	INLINE cvector mid(const cimatrix_subv &mv) noexcept;
	//! Returns the infimum of the matrix
	INLINE cvector Inf(const cimatrix_subv &mv) noexcept;
	//! Returns the supremum of the matrix
	INLINE cvector Sup(const cimatrix_subv &mv) noexcept;
	//! Returns the imaginary part of the matrix
	INLINE ivector Im(const cimatrix_subv &mv) noexcept;
	//! Returns the real part of the matrix
	INLINE ivector Re(const cimatrix_subv &mv) noexcept;
	//! Returns the supremum of real part of the matrix
	INLINE rmatrix SupRe(const cimatrix &v) noexcept;
	//! Returns the supremum of imaginary part of the matrix
	INLINE rmatrix SupIm(const cimatrix &v) noexcept;
	//! Returns the infimum of real part of the matrix
	INLINE rmatrix InfRe(const cimatrix &v) noexcept;
	//! Returns the infimum of imaginary part of the matrix
	INLINE rmatrix InfIm(const cimatrix &v) noexcept;
	//! Returns the supremum of real part of the matrix
	INLINE rmatrix SupRe(const cimatrix_slice &v) noexcept;
	//! Returns the supremum of imaginary part of the matrix
	INLINE rmatrix SupIm(const cimatrix_slice &v) noexcept;
	//! Returns the infimum of real part of the matrix
	INLINE rmatrix InfRe(const cimatrix_slice &v) noexcept;
	//! Returns the infimum of imaginary part of the matrix
	INLINE rmatrix InfIm(const cimatrix_slice &v) noexcept;
	...
	//! Returns the matrix with the new given supremum value
	INLINE cimatrix_subv &SetSup(cimatrix_subv &iv,const complex &r) noexcept;
	//! Returns the matrix with the new given infimum value
	INLINE cimatrix_subv &SetInf(cimatrix_subv &iv,const complex &r) noexcept;
	//! Returns the matrix with the new unchecked given supremum value
	INLINE cimatrix_subv &UncheckedSetSup(cimatrix_subv &iv,const complex &r) noexcept;
	//! Returns the matrix with the new unchecked given infimum value
	INLINE cimatrix_subv &SetUncheckedInf(cimatrix_subv &iv,const complex &r) noexcept;
	//! Sets componentwise the real parts of the matrix
	INLINE cimatrix_subv &SetRe(cimatrix_subv &iv,const interval &r) noexcept;
	//! Sets componentwise the imaginary parts of the matrix
	INLINE cimatrix_subv &SetIm(cimatrix_subv &iv,const interval &r) noexcept;
...
//===================== Matrix Functions =============================
	...
	INLINE cimatrix _imatrix(const cimatrix &rm) noexcept;
	//! Deprecated typecast, which only exist for the reason of compatibility with older versions of C-XSC
	INLINE cimatrix _imatrix(const civector &v) noexcept;
	//! Deprecated typecast, which only exist for the reason of compatibility with older versions of C-XSC
	INLINE cimatrix _imatrix(const civector_slice &v) noexcept;
	//! Deprecated typecast, which only exist for the reason of compatibility with older versions of C-XSC
	INLINE cimatrix _imatrix(const cinterval &r) noexcept;
...
#endif
	//! Resizes the matrix
	INLINE void Resize(cimatrix &A) noexcept;
	//! Resizes the matrix
	...
	//! Returns the absolute value of the matrix
	INLINE imatrix abs(const cimatrix &m) noexcept;
	//! Returns the absolute value of the matrix
	INLINE imatrix abs(const cimatrix_slice &ms) noexcept;
	//! Returns the rounded diameter of the matrix
	INLINE cmatrix diam(const cimatrix &m) noexcept;
	//! Returns the rounded diameter of the matrix
	INLINE cmatrix diam(const cimatrix_slice &m) noexcept;
	//! Returns the rounded middle of the matrix
	INLINE cmatrix mid(const cimatrix &m) noexcept;
	//! Returns the rounded middle of the matrix
	INLINE cmatrix mid(const cimatrix_slice &m) noexcept;
	//! Returns the infimum of the matrix
	INLINE cmatrix Inf(const cimatrix &m) noexcept;
	//! Returns the supremum of the matrix
	INLINE cmatrix Sup(const cimatrix &m) noexcept;
	//! Returns the infimum of the matrix
	INLINE cmatrix Inf(const cimatrix_slice &m) noexcept;
	//! Returns the supremum of the matrix
	INLINE cmatrix Sup(const cimatrix_slice &m) noexcept;
	//! Returns the matrix with the new given infimum value
	...
	//! Returns the imaginary part of the matrix
	INLINE imatrix Im(const cimatrix &m) noexcept;
	//! Returns the real part of the matrix
	INLINE imatrix Re(const cimatrix &m) noexcept;
	//! Returns the imaginary part of the matrix
	INLINE imatrix Im(const cimatrix_slice &m) noexcept;
	//! Returns the real part of the matrix
	INLINE imatrix Re(const cimatrix_slice &m) noexcept;
	//! Sets componentwise the imaginary parts of the matrix
...
//===================== Matrix / Scalar ===============================
	...
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cinterval &c, const cimatrix &m) noexcept;
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cinterval &c, const cimatrix_slice &ms) noexcept;
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cimatrix &m,const cinterval &c) noexcept;
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cimatrix_slice &ms,const cinterval &c) noexcept;
	//! Implementation of multiplication and allocation operation
	INLINE cimatrix &operator *=(cimatrix &m,const cinterval &c) noexcept;
	//! Implementation of division operation
	INLINE cimatrix operator /(const cimatrix &m,const cinterval &c) noexcept;
	//! Implementation of division operation
	INLINE cimatrix operator /(const cimatrix_slice &ms, const cinterval &c) noexcept;
...
//------------ real - cimatrix -----------------------------------------------
	...
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const real &c, const cimatrix &m) noexcept;
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const real &c, const cimatrix_slice &ms) noexcept;
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cimatrix &m,const real &c) noexcept;
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cimatrix_slice &ms,const real &c) noexcept;
	//! Implementation of multiplication and allocation operation
	INLINE cimatrix &operator *=(cimatrix &m,const real &c) noexcept;
	//! Implementation of division operation
	INLINE cimatrix operator /(const cimatrix &m,const real &c) noexcept;
	//! Implementation of division operation
	INLINE cimatrix operator /(const cimatrix_slice &ms, const real &c) noexcept;
...
//----------------- rmatrix - cinterval ----------------
	...
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cinterval &c, const rmatrix &m) noexcept;
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cinterval &c, const rmatrix_slice &ms) noexcept;
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const rmatrix &m,const cinterval &c) noexcept;
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const rmatrix_slice &ms,const cinterval &c) noexcept;
	//! Implementation of division operation
	INLINE cimatrix operator /(const rmatrix &m,const cinterval &c) noexcept;
	//! Implementation of division operation
	INLINE cimatrix operator /(const rmatrix_slice &ms, const cinterval &c) noexcept;
...
//------------ complex - cimatrix -----------------------------------------------
	...
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const complex &c, const cimatrix &m) noexcept;
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const complex &c, const cimatrix_slice &ms) noexcept;
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cimatrix &m,const complex &c) noexcept;
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cimatrix_slice &ms,const complex &c) noexcept;
	//! Implementation of multiplication and allocation operation
	INLINE cimatrix &operator *=(cimatrix &m,const complex &c) noexcept;
	//! Implementation of division operation
	INLINE cimatrix operator /(const cimatrix &m,const complex &c) noexcept;
	//! Implementation of division operation
	INLINE cimatrix operator /(const cimatrix_slice &ms, const complex &c) noexcept;
...
//----------------- cmatrix - cinterval ----------------
	...
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cinterval &c, const cmatrix &m) noexcept;
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cinterval &c, const cmatrix_slice &ms) noexcept;
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cmatrix &m,const cinterval &c) noexcept;
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cmatrix_slice &ms,const cinterval &c) noexcept;
	//! Implementation of division operation
	INLINE cimatrix operator /(const cmatrix &m,const cinterval &c) noexcept;
	//! Implementation of division operation
	INLINE cimatrix operator /(const cmatrix_slice &ms, const cinterval &c) noexcept;
...
//------------ interval - cimatrix -----------------------------------------------
	...
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const interval &c, const cimatrix &m) noexcept;
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const interval &c, const cimatrix_slice &ms) noexcept;
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cimatrix &m,const interval &c) noexcept;
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cimatrix_slice &ms,const interval &c) noexcept;
	//! Implementation of multiplication and allocation operation
	INLINE cimatrix &operator *=(cimatrix &m,const interval &c) noexcept;
	//! Implementation of division operation
	INLINE cimatrix operator /(const cimatrix &m,const interval &c) noexcept;
	//! Implementation of division operation
	INLINE cimatrix operator /(const cimatrix_slice &ms, const interval &c) noexcept;
...
//----------------- imatrix - cinterval ----------------
	...
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cinterval &c, const imatrix &m) noexcept;
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const cinterval &c, const imatrix_slice &ms) noexcept;
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const imatrix &m,const cinterval &c) noexcept;
	//! Implementation of multiplication operation
	INLINE cimatrix operator *(const imatrix_slice &ms,const cinterval &c) noexcept;
	//! Implementation of division operation
	INLINE cimatrix operator /(const imatrix &m,const cinterval &c) noexcept;
	//! Implementation of division operation
	INLINE cimatrix operator /(const imatrix_slice &ms, const cinterval &c) noexcept;
...
//================ Matrix / Matrix ============================
	...
	INLINE const cimatrix &operator +(const cimatrix &m1) noexcept;
	//! Implementation of positive sign operation
	INLINE cimatrix operator +(const cimatrix_slice &ms) noexcept;
	//! Implementation of addition operation
...
//-------------- Matrix - Matrix   -------------------------
	...
	INLINE bool operator ==(const cimatrix &m1,const cimatrix &m2) noexcept;
	...
	INLINE bool operator >=(const cimatrix &m1,const cimatrix &m2) noexcept;
	//! Implementation of standard equality operation
	INLINE bool operator ==(const cimatrix &m1,const cimatrix_slice &ms) noexcept;
	//! Implementation of standard negated equality operation
	INLINE bool operator !=(const cimatrix &m1,const cimatrix_slice &ms) noexcept;
	//! Implementation of standard less-than operation
	INLINE bool operator <(const cimatrix &m1,const cimatrix_slice &ms) noexcept;
...
//---------------- Matrix - Matrix_slice ----------------------
	...
	//! Implementation of standard equality operation
	INLINE bool operator ==(const cimatrix_slice &m1,const cimatrix_slice &m2) noexcept;
	//! Implementation of standard negated equality operation
	INLINE bool operator !=(const cimatrix_slice &m1,const cimatrix_slice &m2) noexcept;
	//! Implementation of standard less-than operation
	INLINE bool operator <(const cimatrix_slice &m1,const cimatrix_slice &m2) noexcept;
...
//=================== Not Operator =============================
	...
	INLINE bool operator !(const cimatrix &ms) noexcept;
	//! Implementation of standard negation operation
	INLINE bool operator !(const cimatrix_slice &ms) noexcept;

//======================== Input / Output ========================

	//! Implementation of standard output method
	INLINE std::ostream &operator <<(std::ostream &s,const cimatrix &r) noexcept;
	//! Implementation of standard output method
	INLINE std::ostream &operator <<(std::ostream &s,const cimatrix_slice &r) noexcept;
	//! Implementation of standard input method
	INLINE std::istream &operator >>(std::istream &s,cimatrix &r) noexcept;
	//! Implementation of standard input method
	INLINE std::istream &operator >>(std::istream &s,cimatrix_slice &r) noexcept;
