...
class l_real
{
   ...
   public:
      ...
      //! Implementation of standard assigning operator
      l_real & operator =(const lx_real &) noexcept; // Blomquist, 12.11.2008;
      ...
      // ---- Type casting ----
      //! Constructor of class l_real
      explicit l_real(int)          noexcept;
      //! Constructor of class l_real
      explicit l_real(long)          noexcept;
      //! Constructor of class l_real
      explicit l_real(const real &) noexcept;
      //! Constructor of class l_real
      explicit l_real(const dotprecision &) noexcept;
      //! Constructor of class l_real
      explicit l_real(const double &) noexcept; // Blomquist 10.09.02. {l_real.cpp}
      
      friend real::real(const l_real &) noexcept;
      friend dotprecision::dotprecision(const l_real &) noexcept;
      friend dotprecision & dotprecision::operator =(const l_real &) noexcept;

//      friend real _real(const l_real & a) noexcept { return real(a); }
//      friend l_real _l_real(const real & a) noexcept  { return l_real(a); }
//      friend dotprecision _dotprecision(const l_real & a) noexcept
//                                               { return dotprecision(a); }
//      friend l_real _l_real(const dotprecision & a) noexcept 
//                                               { return l_real(a); }
      ...
      */
      ...
      //! Implementation of standard output method
      friend std::string & operator <<(std::string &,const l_real &)   noexcept;
      //! Implementation of standard input method
      friend std::string & operator >>(std::string &,l_real &)         noexcept;
      //! Implementation of standard input method
      friend void          operator >>(const std::string &,l_real &)   noexcept;
      //! Implementation of standard input method
      friend void          operator >>(const char *,l_real &)          noexcept;
      ...
      //! Implementation of standard algebraic addition operation
      friend     l_real operator +(const l_real &,const real &) noexcept;
      //! Implementation of standard algebraic addition operation
      friend     l_real operator +(const real &,const l_real &) noexcept;
      //! Implementation of standard algebraic subtraction operation
      friend     l_real operator -(const l_real &,const real &) noexcept;
      //! Implementation of standard algebraic subtraction operation
      friend     l_real operator -(const real &,const l_real &) noexcept;
      ...
      friend     l_real operator /(const real &,const l_real &) noexcept;
      //! Returns the convex hull of the arguments
      friend inline l_interval operator |(const real &,const l_real &) noexcept;
      //! Returns the convex hull of the arguments
      friend inline l_interval operator |(const l_real &,const real &) noexcept;

      //! Implementation of standard algebraic addition operation
      friend  dotprecision operator +(const l_real &,const dotprecision &) noexcept;
      //! Implementation of standard algebraic addition operation
      friend  dotprecision operator +(const dotprecision &,const l_real &) noexcept;
      //! Implementation of standard algebraic subtraction operation
      friend  dotprecision operator -(const l_real &,const dotprecision &) noexcept;
      //! Implementation of standard algebraic subtraction operation
      friend  dotprecision operator -(const dotprecision &,const l_real &) noexcept;
      //! Returns the convex hull of the arguments
      friend inline idotprecision operator |(const dotprecision &,const l_real &) noexcept;
      //! Returns the convex hull of the arguments
      friend inline idotprecision operator |(const l_real &,const dotprecision &) noexcept;
      ...
      //! Implementation of standard algebraic addition and allocation operation
      friend     l_real & operator +=(l_real &,const real &) noexcept;      
      //! Implementation of standard algebraic subtraction and allocation operation
      friend     l_real & operator -=(l_real &,const real &) noexcept;
      //! Implementation of standard algebraic multiplication and allocation operation
      friend     l_real & operator *=(l_real &,const real &) noexcept;      
      ...
      //! Implementation of standard algebraic addition and allocation operation
      friend     real   & operator +=(real &,const l_real &) noexcept;
      //! Implementation of standard algebraic subtraction and allocation operation
      friend     real   & operator -=(real &,const l_real &) noexcept;
      //! Implementation of standard algebraic multiplication and allocation operation
      friend     real   & operator *=(real &,const l_real &) noexcept;
	//! Implementation of standard algebraic division and allocation operation
      ...
      //! Implementation of standard algebraic addition and allocation operation
      friend     inline dotprecision & operator +=(dotprecision &d,const l_real &lr) noexcept { lr._akku_add(d); return d; }
      //! Implementation of standard algebraic subtraction and allocation operation
      friend     inline dotprecision & operator -=(dotprecision &d,const l_real &lr) noexcept { lr._akku_sub(d); return d; }
      ...
      //! Implementation of standard equality operation
      friend bool operator ==(const real &,const l_real &) noexcept;
      //! Implementation of standard negated equality operation
      friend bool operator !=(const real &,const l_real &) noexcept;
      //! Implementation of standard less-than operation
      friend bool operator  <(const real &,const l_real &) noexcept;
      ...
      //! Implementation of standard equality operation
      friend bool operator ==(const l_real &,const real &) noexcept;
      //! Implementation of standard negated equality operation
      friend bool operator !=(const l_real &,const real &) noexcept;
      //! Implementation of standard less-than operation
      friend bool operator  <(const l_real &,const real &) noexcept;
      ...
      //! Implementation of standard equality operation
      friend bool operator ==(const dotprecision &,const l_real &) noexcept;
      //! Implementation of standard negated equality operation
      friend bool operator !=(const dotprecision &,const l_real &) noexcept;
      //! Implementation of standard less-than operation
      friend bool operator  <(const dotprecision &,const l_real &) noexcept;
      ...
      //! Implementation of standard equality operation
      friend bool operator ==(const l_real &,const dotprecision &) noexcept;
      //! Implementation of standard negated equality operation
      friend bool operator !=(const l_real &,const dotprecision &) noexcept;
      //! Implementation of standard less-than operation
      friend bool operator  <(const l_real &,const dotprecision &) noexcept;
      ...
      //! Implementation of standard equality operation
      friend bool operator ==(const interval &,const l_real &) noexcept;
      //! Implementation of standard negated equality operation
      friend bool operator !=(const interval &,const l_real &) noexcept;
      //! Implementation of standard less-than operation
      friend bool operator  <(const interval &,const l_real &) noexcept;
      ...
      //! Implementation of standard equality operation
      friend bool operator ==(const l_real &,const interval &) noexcept;
      //! Implementation of standard negated equality operation
      friend bool operator !=(const l_real &,const interval &) noexcept;
      //! Implementation of standard less-than operation
      friend bool operator  <(const l_real &,const interval &) noexcept;
      ...
      //! Implementation of standard equality operation
      friend bool operator ==(const idotprecision &,const l_real &) noexcept;
      //! Implementation of standard negated equality operation
      friend bool operator !=(const idotprecision &,const l_real &) noexcept;
      //! Implementation of standard less-than operation
      friend bool operator  <(const idotprecision &,const l_real &) noexcept;
      ...
      //! Implementation of standard equality operation
      friend bool operator ==(const l_real &,const idotprecision &) noexcept;
      //! Implementation of standard negated equality operation
      friend bool operator !=(const l_real &,const idotprecision &) noexcept;
      //! Implementation of standard less-than operation
      friend bool operator  <(const l_real &,const idotprecision &) noexcept;
	...
	//! The accurate scalar product of the last two arguments added to the value of the first argument
      friend void accumulate(dotprecision&, const l_real&, const real&) noexcept;
	//! The accurate scalar product of the last two arguments added to the value of the first argument
      friend void accumulate(dotprecision&, const l_real&, const l_real&) noexcept;
      
	//! The accurate scalar product of the last two arguments added to the value of the first argument
      friend void accumulate(idotprecision&,const real&, const l_real&) noexcept;
	//! The accurate scalar product of the last two arguments added to the value of the first argument
      friend void accumulate(idotprecision&,const l_real&,const real&) noexcept;
	//! The accurate scalar product of the last two arguments added to the value of the first argument
      friend void accumulate(idotprecision&,const l_real&, const l_real&) noexcept;
    ...
    // Calculating expo(x[k]) of the greatest |x[k]|.
      ...
      friend inline bool zero_(const l_real &) noexcept; // Blomquist,27.11.02
   private:
      void _clear(int) noexcept; // filling a l_real number from element int p
                                //  up to the end with zero.
      void _akku_out(const dotprecision&) noexcept; // The dotprecision value is rounded to the
                        // activated l_real number in its own precision.
      void _akku_out_up(const dotprecision&) noexcept; // The dotprecision value is rounded up to 
                      // the activated l_real number in its own precision.
      void _akku_out_down(const dotprecision&) noexcept; // The dotprecision value is rounded down 
                      // to the activated l_real number in its own precision.
      void _akku_add(dotprecision&) const noexcept; // adding the activated
                                     // l_real number to the accumulator d.
      void _akku_sub(dotprecision&) const noexcept; // subtracting the 
      // activated l_real number to the accumulator d of type dotprecision.
      inline real& elem(int i) const noexcept {  return data[i-1];  }
};



      // ---- Compare operators ----
      bool operator ==(const l_real &,const l_real &) noexcept;
      bool operator !=(const l_real &,const l_real &) noexcept;
      bool operator  <(const l_real &,const l_real &) noexcept;
      bool operator  >(const l_real &,const l_real &) noexcept;
      bool operator <=(const l_real &,const l_real &) noexcept;
      ...
      bool operator ==(const real &,const l_real &) noexcept;
      bool operator !=(const real &,const l_real &) noexcept;
      bool operator  <(const real &,const l_real &) noexcept;
      bool operator  >(const real &,const l_real &) noexcept;
      bool operator <=(const real &,const l_real &) noexcept;
      ...
      bool operator ==(const l_real &,const real &) noexcept;
      bool operator !=(const l_real &,const real &) noexcept;
      bool operator  <(const l_real &,const real &) noexcept;
      bool operator  >(const l_real &,const real &) noexcept;
      bool operator <=(const l_real &,const real &) noexcept;
      ...
      bool operator ==(const dotprecision &,const l_real &) noexcept;
      bool operator !=(const dotprecision &,const l_real &) noexcept;
      bool operator  <(const dotprecision &,const l_real &) noexcept;
      bool operator  >(const dotprecision &,const l_real &) noexcept;
      bool operator <=(const dotprecision &,const l_real &) noexcept;
      ...
      bool operator ==(const l_real &,const dotprecision &) noexcept;
      bool operator !=(const l_real &,const dotprecision &) noexcept;
      bool operator  <(const l_real &,const dotprecision &) noexcept;
      bool operator  >(const l_real &,const dotprecision &) noexcept;
      bool operator <=(const l_real &,const dotprecision &) noexcept;
      ...
      bool operator ==(const interval &,const l_real &) noexcept;
      bool operator !=(const interval &,const l_real &) noexcept;
      bool operator  <(const interval &,const l_real &) noexcept;
      bool operator  >(const interval &,const l_real &) noexcept;
      bool operator <=(const interval &,const l_real &) noexcept;
      ...
      bool operator ==(const l_real &,const interval &) noexcept;
      bool operator !=(const l_real &,const interval &) noexcept;
      bool operator  <(const l_real &,const interval &) noexcept;
      bool operator  >(const l_real &,const interval &) noexcept;
      bool operator <=(const l_real &,const interval &) noexcept;
      ...
      bool operator ==(const idotprecision &,const l_real &) noexcept;
      bool operator !=(const idotprecision &,const l_real &) noexcept;
      bool operator  <(const idotprecision &,const l_real &) noexcept;
      bool operator  >(const idotprecision &,const l_real &) noexcept;
      bool operator <=(const idotprecision &,const l_real &) noexcept;
      ...
      bool operator ==(const l_real &,const idotprecision &) noexcept;
      bool operator !=(const l_real &,const idotprecision &) noexcept;
      bool operator  <(const l_real &,const idotprecision &) noexcept;
      bool operator  >(const l_real &,const idotprecision &) noexcept;
      bool operator <=(const l_real &,const idotprecision &) noexcept;
      ...
      bool operator!(const l_real& lr) noexcept;


inline real _real(const l_real & a) noexcept { return real(a); }
inline l_real _l_real(const real & a) noexcept  { return l_real(a); }
inline dotprecision _dotprecision(const l_real & a) noexcept
                                               { return dotprecision(a); }
inline l_real _l_real(const dotprecision & a) noexcept 
                                               { return l_real(a); }
...
//! Fast calculation of \f$ 2^n \f$
    inline l_real l_pow2n(const int n) noexcept
...
inline void times2pown(l_real& lr, const int n) noexcept // Blomquist 03.10.02
...
*/
inline void times2pown(l_real& lr, interval& z, const int n) noexcept 
{  // Blomquist 03.10.02;
...
*/
inline void Times2pown(l_real& a, interval& z, int n) noexcept
...
*/
inline void Times2pown(l_real& a, const real& p) noexcept
...
inline bool zero_(const l_real& lr) noexcept
...
l_real Ln2_l_real()   noexcept;   // ln(2) 
//! Approximation of \f$ \ln 10 \f$
l_real Ln10_l_real()  noexcept;   // ln(10)
//! Approximation of \f$ \frac{1}{\ln 10} \f$
l_real Ln10r_l_real() noexcept;   // 1/ln(10)
//! Approximation of \f$ \frac{\pi}{4} \f$
l_real Pid4_l_real()  noexcept;   // Pi/4
//! Approximation of \f$ \sqrt{2} \f$
l_real Sqrt2_l_real() noexcept;   // sqrt(2)
//! Approximation of \f$ \sqrt{5} \f$
l_real Sqrt5_l_real() noexcept;   // sqrt(5)
//! Approximation of \f$ \sqrt{7} \f$
l_real Sqrt7_l_real() noexcept;   // sqrt(7)
//! Approximation of \f$ \frac{1}{\ln 2} \f$
l_real Ln2r_l_real() noexcept;     // 1/ln(2)
//! Approximation of \f$ \pi \f$
l_real Pi_l_real() noexcept;       // Pi
//! Approximation of \f$ \frac{\pi}{2} \f$
l_real Pid2_l_real() noexcept;     // Pi/2
//! Approximation of \f$ 2\pi \f$
l_real Pi2_l_real() noexcept;      // 2*Pi
//! Approximation of \f$ \frac{\pi}{3} \f$
l_real Pid3_l_real() noexcept;     // Pi/3
//! Approximation of \f$ \frac{1}{\pi} \f$
l_real Pir_l_real() noexcept;      // 1/Pi
//! Approximation of \f$ \frac{1}{2\pi} \f$
l_real Pi2r_l_real() noexcept;     // 1/(2*Pi)
//! Approximation of \f$ \sqrt{\pi} \f$
l_real SqrtPi_l_real() noexcept;   // sqrt(Pi)
//! Approximation of \f$ \sqrt{2\pi} \f$
l_real Sqrt2Pi_l_real() noexcept;  // sqrt(2*Pi)
//! Approximation of \f$ \frac{1}{\sqrt{\pi}} \f$
l_real SqrtPir_l_real() noexcept;  // 1/sqrt(Pi)
//! Approximation of \f$ \frac{1}{\sqrt{2\pi}} \f$
l_real Sqrt2Pir_l_real() noexcept; // 1/sqrt(2*Pi)
//! Approximation of \f$ 2^\pi \f$
l_real Pip2_l_real() noexcept;     // Pi^2
//! Approximation of \f$ \frac{1}{\sqrt{2}} \f$
l_real Sqrt2r_l_real() noexcept;   // 1/sqrt(2)
//! Approximation of \f$ \sqrt{3} \f$
l_real Sqrt3_l_real() noexcept;    // sqrt(3)
//! Approximation of \f$ \frac{\sqrt{3}}{2} \f$
l_real Sqrt3d2_l_real() noexcept;  // sqrt(3)/2
//! Approximation of \f$ \frac{1}{\sqrt{3}} \f$
l_real Sqrt3r_l_real() noexcept;   // 1/sqrt(3)
//! Approximation of \f$ \ln \pi \f$
l_real LnPi_l_real() noexcept;     // ln(Pi)
//! Approximation of \f$ \ln 2\pi \f$
l_real Ln2Pi_l_real() noexcept;    // ln(2*Pi)
//! Approximation of \f$ e \f$
l_real E_l_real() noexcept;        // e = exp(1)
//! Approximation of \f$ \frac{1}{e} \f$
l_real Er_l_real() noexcept;       // 1/e
//! Approximation of \f$ e^2 \f$
l_real Ep2_l_real() noexcept;      // e^2
//! Approximation of \f$ \frac{1}{e^2} \f$
l_real Ep2r_l_real() noexcept;     // 1/e^2
//! Approximation of \f$ e^\pi \f$
l_real EpPi_l_real() noexcept;     // e^Pi
//! Approximation of \f$ e^{2\pi} \f$
l_real Ep2Pi_l_real() noexcept;    // e^(2*Pi)
//! Approximation of \f$ e^{\frac{\pi}{2}} \f$
l_real EpPid2_l_real() noexcept;   // e^(Pi/2)
//! Approximation of \f$ e^{\frac{\pi}{4}} \f$
l_real EpPid4_l_real() noexcept;   // e^(Pi/4)
//! Approximation of Euler Gamma
l_real EulerGa_l_real() noexcept;  // EulerGamma
//! Approximation of Catalan Numbers
l_real Catalan_l_real() noexcept;  // Catalan
