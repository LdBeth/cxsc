...
l_interval atan    (const l_interval&) noexcept; // ATan(x)
//! Calculates \f$ \mbox{arccot}([x]) \f$
l_interval acot    (const l_interval&) noexcept; // ACot(x)
...
l_interval expm1(const l_interval & x) noexcept; // exp(x)-1;
...
l_interval lnp1    (const l_interval&) noexcept; // ln(1+x)
...
l_interval tanh    (const l_interval&) noexcept; // Tanh(x)
//! Calculates \f$ \coth([x]) \f$
l_interval coth    (const l_interval&) noexcept; // Coth(x)           
 
//! Calculates \f$ \mbox{arcsinh}([x]) \f$
l_interval asinh   (const l_interval&) noexcept(false);  
                                                // ASinh(x)
//! Calculates \f$ \mbox{arccosh}([x]) \f$
l_interval acosh   (const l_interval&) noexcept; // ACosh(x)
...
l_interval sqrt1px2(const l_interval&) noexcept; // Sqrt(1+x^2); 
//! Calculates \f$ \sqrt{[x]^2+[y]^2} \f$
l_interval sqrtx2y2(const l_interval&, const l_interval&) noexcept; 
                                                // Sqrt(x^2+y^2); 
...
l_interval ln_sqrtx2y2(const l_interval&, const l_interval&) noexcept;

// some constants as functions for l_interval
// l_interval li_ln2() noexcept;                    // ln(2)
// l_interval li_ln10() noexcept;                   // ln(10)
// l_interval li_Rln10() noexcept;                  // 1/ln(10)
// l_interval li_pi4() noexcept;                    // Pi/4
// l_interval li_sqrt2() noexcept;                  // sqrt(2)
//! Enclosure-Interval for \f$ \ln 2 \f$
l_interval Ln2_l_interval()   noexcept;   // ln(2) 
//! Enclosure-Interval for \f$ \ln 10 \f$
l_interval Ln10_l_interval()  noexcept;   // ln(10)
//! Enclosure-Interval for \f$ \frac{1}{\ln 10} \f$
l_interval Ln10r_l_interval() noexcept;   // 1/ln(10)
//! Enclosure-Interval for \f$ \frac{\pi}{4} \f$
l_interval Pid4_l_interval()  noexcept;   // Pi/4
//! Enclosure-Interval for \f$ \sqrt{2} \f$
l_interval Sqrt2_l_interval() noexcept;   // sqrt(2)
//! Enclosure-Interval for \f$ \sqrt{5} \f$
l_interval Sqrt5_l_interval() noexcept;   // sqrt(5)
//! Enclosure-Interval for \f$ \sqrt{7} \f$
l_interval Sqrt7_l_interval() noexcept;   // sqrt(7)
...
l_interval Ln2r_l_interval() noexcept;     // 1/ln(2)
      //! Enclosure-Interval for \f$ \pi \f$
l_interval Pi_l_interval() noexcept;       // Pi
      //! Enclosure-Interval for \f$ \frac{\pi}{2} \f$
l_interval Pid2_l_interval() noexcept;     // Pi/2
      //! Enclosure-Interval for \f$ 2\pi \f$
l_interval Pi2_l_interval() noexcept;      // 2*Pi
      //! Enclosure-Interval for \f$ \frac{\pi}{3} \f$
l_interval Pid3_l_interval() noexcept;     // Pi/3
      //! Enclosure-Interval for \f$ \frac{1}{\pi} \f$
l_interval Pir_l_interval() noexcept;      // 1/Pi
      //! Enclosure-Interval for \f$ \frac{1}{2\pi} \f$
l_interval Pi2r_l_interval() noexcept;     // 1/(2*Pi)
      //! Enclosure-Interval for \f$ \sqrt{\pi} \f$
l_interval SqrtPi_l_interval() noexcept;   // sqrt(Pi)
      //! Enclosure-Interval for \f$ \sqrt{2\pi} \f$
l_interval Sqrt2Pi_l_interval() noexcept;  // sqrt(2*Pi)
      //! Enclosure-Interval for \f$ \frac{1}{\sqrt{\pi}} \f$
l_interval SqrtPir_l_interval() noexcept;  // 1/sqrt(Pi)
      //! Enclosure-Interval for \f$ \frac{1}{\sqrt{2\pi}} \f$
l_interval Sqrt2Pir_l_interval() noexcept; // 1/sqrt(2*Pi)
      //! Enclosure-Interval for \f$ 2^\pi \f$
l_interval Pip2_l_interval() noexcept;     // Pi^2
      //! Enclosure-Interval for \f$ \frac{1}{\sqrt{2}} \f$
l_interval Sqrt2r_l_interval() noexcept;   // 1/sqrt(2)
      //! Enclosure-Interval for \f$ \sqrt{3} \f$
l_interval Sqrt3_l_interval() noexcept;    // sqrt(3)
      //! Enclosure-Interval for \f$ \frac{\sqrt{3}}{2} \f$
l_interval Sqrt3d2_l_interval() noexcept;  // sqrt(3)/2
      //! Enclosure-Interval for \f$ \frac{1}{\sqrt{3}} \f$
l_interval Sqrt3r_l_interval() noexcept;   // 1/sqrt(3)
      //! Enclosure-Interval for \f$ \ln \pi \f$
l_interval LnPi_l_interval() noexcept;     // ln(Pi)
      //! Enclosure-Interval for \f$ \ln 2\pi \f$
l_interval Ln2Pi_l_interval() noexcept;    // ln(2*Pi)
      //! Enclosure-Interval for \f$ e \f$
l_interval E_l_interval() noexcept;        // e = exp(1)
      //! Enclosure-Interval for \f$ \frac{1}{e} \f$
l_interval Er_l_interval() noexcept;       // 1/e
      //! Enclosure-Interval for \f$ e^2 \f$
l_interval Ep2_l_interval() noexcept;      // e^2
      //! Enclosure-Interval for \f$ \frac{1}{e^2} \f$
l_interval Ep2r_l_interval() noexcept;     // 1/e^2
      //! Enclosure-Interval for \f$ e^\pi \f$
l_interval EpPi_l_interval() noexcept;     // e^Pi
      //! Enclosure-Interval for \f$ e^{2\pi} \f$
l_interval Ep2Pi_l_interval() noexcept;    // e^(2*Pi)
      //! Enclosure-Interval for \f$ e^{\frac{\pi}{2}} \f$
l_interval EpPid2_l_interval() noexcept;   // e^(Pi/2)
      //! Enclosure-Interval for \f$ e^{\frac{\pi}{4}} \f$
l_interval EpPid4_l_interval() noexcept;   // e^(Pi/4)
      //! Enclosure-Interval for Euler Gamma
l_interval EulerGa_l_interval() noexcept;  // EulerGamma
      //! Enclosure-Interval for Catalan Numbers
l_interval Catalan_l_interval() noexcept;  // Catalan
} // namespace cxsc 
