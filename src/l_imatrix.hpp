...
template <class V,class MV> friend  V &_vmvsectassign(V &rv,const MV &v)
	...
	explicit INLINE l_imatrix_subv (l_interval *d, const int &l, const int &u, const int &s, const int &st, const int &o) noexcept:dat(d),lb(l),ub(u),size(s),start(st),offset(o) { }
	public:
	//! Constructor of class l_imatrix_subv
	INLINE l_imatrix_subv(const l_imatrix_subv &v) noexcept:dat(v.dat),lb(v.lb),ub(v.ub),size(v.size),start(v.start),offset(v.offset) { }
	public:

	//---------------------- Standardfunktionen ------------------------

	//! Implementation of standard assigning operator
	INLINE l_imatrix_subv &operator =(const l_imatrix_subv &rv) noexcept;
	//! Implementation of standard assigning operator
	INLINE l_imatrix_subv &operator =(const l_interval &r) noexcept;
	//! Implementation of standard assigning operator
	...
	// Real
	//! Implementation of standard assigning operator
	INLINE l_imatrix_subv &operator =(const real &r) noexcept;
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE l_imatrix_subv &operator =(const rmatrix_subv &rv) noexcept;

	// l_real
	//! Implementation of standard assigning operator
	INLINE l_imatrix_subv &operator =(const l_real &r) noexcept;
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE l_imatrix_subv &operator =(const l_rmatrix_subv &rv) noexcept;

	// interval
	//! Implementation of standard assigning operator
	INLINE l_imatrix_subv &operator =(const interval &r) noexcept;
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE l_imatrix_subv &operator =(const imatrix_subv &rv) noexcept;

	//! Returns the lower bound of the vector
	friend INLINE int Lb(const l_imatrix_subv &rv) noexcept { return rv.lb; }
	//! Returns the upper bound of the vector
	friend INLINE int Ub(const l_imatrix_subv &rv) noexcept { return rv.ub; }
	...
	INLINE l_imatrix_subv &operator ()() noexcept { return *this; }
	...
	INLINE l_imatrix_subv &operator *=(const l_interval &c) noexcept;
	...
	// real
	//! Implementation of multiplication and allocation operation
	INLINE l_imatrix_subv &operator *=(const real &c) noexcept;
	//! Implementation of addition and allocation operation
	INLINE l_imatrix_subv &operator +=(const real &c) noexcept;
	//! Implementation of subtraction and allocation operation
	INLINE l_imatrix_subv &operator -=(const real &c) noexcept;
	...
	// l_real
	//! Implementation of multiplication and allocation operation
	INLINE l_imatrix_subv &operator *=(const l_real &c) noexcept;
	//! Implementation of addition and allocation operation
	INLINE l_imatrix_subv &operator +=(const l_real &c) noexcept;
	//! Implementation of subtraction and allocation operation
	INLINE l_imatrix_subv &operator -=(const l_real &c) noexcept;
	...
	// interval
	//! Implementation of multiplication and allocation operation
	INLINE l_imatrix_subv &operator *=(const interval &c) noexcept;
	//! Implementation of addition and allocation operation
	INLINE l_imatrix_subv &operator +=(const interval &c) noexcept;
	//! Implementation of subtraction and allocation operation
	INLINE l_imatrix_subv &operator -=(const interval &c) noexcept;
...
// l_interval
	...
	INLINE l_imatrix(const l_imatrix &rm) noexcept;
	//! Constructor of class l_imatrix
	INLINE l_imatrix(const l_imatrix_slice &rm) noexcept;
	//! Constructor of class l_imatrix
	INLINE l_imatrix() noexcept;
	//! Constructor of class l_imatrix
...
#endif
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const l_ivector &v) noexcept;
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const l_ivector_slice &v) noexcept;
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const l_interval &r) noexcept;
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const l_interval &r) noexcept;
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const l_imatrix &m) noexcept;
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const l_imatrix_slice &ms) noexcept;
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const l_ivector &v) noexcept;
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const l_ivector_slice &v) noexcept;
//  real
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const real &r) noexcept;
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const rmatrix &rm) noexcept;
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const rmatrix_slice &rm) noexcept;
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const rvector &v) noexcept;
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const rvector_slice &v) noexcept;
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const real &r) noexcept;
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const rmatrix &m) noexcept;
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const rmatrix_slice &ms) noexcept;
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const rvector &v) noexcept;
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const rvector_slice &v) noexcept;

//  l_real
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const l_real &r) noexcept;
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const l_rmatrix &rm) noexcept;
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const l_rmatrix_slice &rm) noexcept;
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const l_rvector &v) noexcept;
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const l_rvector_slice &v) noexcept;
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const l_real &r) noexcept;
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const l_rmatrix &m) noexcept;
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const l_rmatrix_slice &ms) noexcept;
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const l_rvector &v) noexcept;
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const l_rvector_slice &v) noexcept;

//  interval
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const interval &r) noexcept;
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const imatrix &rm) noexcept;
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const imatrix_slice &rm) noexcept;
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const ivector &v) noexcept;
	//! Constructor of class l_imatrix
	explicit INLINE l_imatrix(const ivector_slice &v) noexcept;
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const interval &r) noexcept;
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const imatrix &m) noexcept;
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const imatrix_slice &ms) noexcept;
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const ivector &v) noexcept;
	//! Implementation of standard assigning operator
	INLINE l_imatrix &operator =(const ivector_slice &v) noexcept;

	//--------------------------- Destruktoren -----------------------------

	INLINE ~l_imatrix() noexcept { delete [] dat; }
	...
	INLINE l_imatrix &operator ()() noexcept { return *this; }
...
template <class V,class MS,class S> friend  void _vmsconstr(V &v,const MS &m)
 ...
 template <class MS> friend 	std::istream &_msin(std::istream &s,MS &r) noexcept;
	...
	explicit INLINE l_imatrix_slice(l_imatrix &a,const int &l1,const int &u1,const int &l2, const int &u2) noexcept:dat(a.dat),offset1(l1-a.lb1),offset2(l2-a.lb2),mxsize(a.xsize),mysize(a.ysize),start1(l1),end1(u1),start2(l2),end2(u2),sxsize(u2-l2+1),sysize(u1-l1+1) { }
	//! Constructor of class l_imatrix_slice
	explicit INLINE l_imatrix_slice(l_imatrix_slice &a,const int &l1,const int &u1,const int &l2, const int &u2) noexcept:dat(a.dat),offset1(a.offset1+l1-a.start1),offset2(a.offset2+l2-a.start2),mxsize(a.mxsize),mysize(a.mysize),start1(l1),end1(u1),start2(l2),end2(u2),sxsize(u2-l2+1),sysize(u1-l1+1) { }
	public: 
	//! Constructor of class l_imatrix_slice
	INLINE l_imatrix_slice(const l_imatrix_slice &ms) noexcept:dat(ms.dat),offset1(ms.offset1),offset2(ms.offset2),mxsize(ms.mxsize),mysize(ms.mysize),start1(ms.start1),end1(ms.end1),start2(ms.start2),end2(ms.end2),sxsize(ms.sxsize),sysize(ms.sysize) { }
	public:
	...
	noexcept;
#endif
	friend INLINE l_imatrix::l_imatrix(const l_imatrix_slice &) noexcept;
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE l_imatrix_slice &operator =(const l_interval &r) noexcept;
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE l_imatrix_slice &operator =(const real &r) noexcept;
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE l_imatrix_slice &operator =(const interval &r) noexcept;
	//! Implementation of standard assigning operator
...
#endif
	//! Implementation of standard assigning operator
	INLINE l_imatrix_slice &operator =(const l_real &r) noexcept;
	//! Implementation of standard assigning operator
...
#endif
	//! Operator for accessing the whole matrix
	INLINE l_imatrix_slice &operator ()() noexcept { return *this; }
	//! Operator for accessing a part of the matrix
	INLINE l_imatrix_slice operator ()(const int &m, const int &n)
#if(CXSC_INDEX_CHECK)
	noexcept(false);
	...
	//! Implementation of addition and allocation operation
	INLINE l_imatrix_slice &operator +=(const l_interval &c) noexcept;
	//! Implementation of subtraction and allocation operation
	INLINE l_imatrix_slice &operator -=(const l_interval &c) noexcept;
	//! Implementation of multiplication and allocation operation
	INLINE l_imatrix_slice &operator *=(const l_interval &c) noexcept;
	...
	//! Implementation of addition and allocation operation
	INLINE l_imatrix_slice &operator +=(const real &c) noexcept;
	//! Implementation of subtraction and allocation operation
	INLINE l_imatrix_slice &operator -=(const real &c) noexcept;
	//! Implementation of multiplication and allocation operation
	INLINE l_imatrix_slice &operator *=(const real &c) noexcept;
	...
	//! Implementation of addition and allocation operation
	INLINE l_imatrix_slice &operator +=(const l_real &c) noexcept;
	//! Implementation of subtraction and allocation operation
	INLINE l_imatrix_slice &operator -=(const l_real &c) noexcept;
	//! Implementation of multiplication and allocation operation
	INLINE l_imatrix_slice &operator *=(const l_real &c) noexcept;
	...
	//! Implementation of addition and allocation operation
	INLINE l_imatrix_slice &operator +=(const interval &c) noexcept;
	//! Implementation of subtraction and allocation operation
	INLINE l_imatrix_slice &operator -=(const interval &c) noexcept;
	//! Implementation of multiplication and allocation operation
	INLINE l_imatrix_slice &operator *=(const interval &c) noexcept;
...
//=======================Vector / Scalar =========================
	...
	INLINE l_ivector operator /(const l_imatrix_subv &rv, const l_interval &s) noexcept;
	//! Implementation of multiplication operation
	INLINE l_ivector operator *(const l_imatrix_subv &rv, const l_interval &s) noexcept;
	//! Implementation of multiplication operation
	INLINE l_ivector operator *(const l_interval &s, const l_imatrix_subv &rv) noexcept;
	//! Returns the absolute value of the matrix
	INLINE l_ivector abs(const l_imatrix_subv &mv) noexcept;
	//! Returns the rounded diameter of the matrix
	INLINE l_rvector diam(const l_imatrix_subv &mv) noexcept;
	//! Returns the rounded middle of the matrix
	INLINE l_rvector mid(const l_imatrix_subv &mv) noexcept;
	//! Returns the infimum of the matrix
	INLINE l_rvector Inf(const l_imatrix_subv &mv) noexcept;
	//! Returns the supremum of the matrix
	INLINE l_rvector Sup(const l_imatrix_subv &mv) noexcept;
	...
	//! Returns the matrix with the new given supremum value
	INLINE l_imatrix_subv &SetSup(l_imatrix_subv &iv,const l_real &r) noexcept;
	//! Returns the matrix with the new given infimum value
	INLINE l_imatrix_subv &SetInf(l_imatrix_subv &iv,const l_real &r) noexcept;
	//! Returns the matrix with the new unchecked given supremum value
	INLINE l_imatrix_subv &UncheckedSetSup(l_imatrix_subv &iv,const l_real &r) noexcept;
	//! Returns the matrix with the new unchecked given infimum value
	INLINE l_imatrix_subv &SetUncheckedInf(l_imatrix_subv &iv,const l_real &r) noexcept;
...
//===================== Matrix Functions =============================
	...
	INLINE l_imatrix _imatrix(const l_imatrix &rm) noexcept;
	//! Deprecated typecast, which only exist for the reason of compatibility with older versions of C-XSC
	INLINE l_imatrix _imatrix(const l_ivector &v) noexcept;
	//! Deprecated typecast, which only exist for the reason of compatibility with older versions of C-XSC
	INLINE l_imatrix _imatrix(const l_ivector_slice &v) noexcept;
	//! Deprecated typecast, which only exist for the reason of compatibility with older versions of C-XSC
	INLINE l_imatrix _imatrix(const l_interval &r) noexcept;
...
#endif
	//! Resizes the matrix
	INLINE void Resize(l_imatrix &A) noexcept;
	//! Resizes the matrix
	...
	//! Returns the absolute value of the matrix
	INLINE l_imatrix abs(const l_imatrix &m) noexcept;
	//! Returns the absolute value of the matrix
	INLINE l_imatrix abs(const l_imatrix_slice &ms) noexcept;
	//! Returns the rounded diameter of the matrix
	INLINE l_rmatrix diam(const l_imatrix &m) noexcept;
	//! Returns the rounded diameter of the matrix
	INLINE l_rmatrix diam(const l_imatrix_slice &m) noexcept;
	//! Returns the rounded middle of the matrix
	INLINE l_rmatrix mid(const l_imatrix &m) noexcept;
	//! Returns the rounded middle of the matrix
	INLINE l_rmatrix mid(const l_imatrix_slice &m) noexcept;
	//! Returns the infimum of the matrix
	INLINE l_rmatrix Inf(const l_imatrix &m) noexcept;
	//! Returns the supremum of the matrix
	INLINE l_rmatrix Sup(const l_imatrix &m) noexcept;
	//! Returns the infimum of the matrix
	INLINE l_rmatrix Inf(const l_imatrix_slice &m) noexcept;
	//! Returns the supremum of the matrix
	INLINE l_rmatrix Sup(const l_imatrix_slice &m) noexcept;
	//! Returns the matrix with the new given infimum value
...
//===================== Matrix / Scalar ===============================
	...
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_interval &c, const l_imatrix &m) noexcept;
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_interval &c, const l_imatrix_slice &ms) noexcept;
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_imatrix &m,const l_interval &c) noexcept;
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_imatrix_slice &ms,const l_interval &c) noexcept;
	//! Implementation of multiplication and allocation operation
	INLINE l_imatrix &operator *=(l_imatrix &m,const l_interval &c) noexcept;
	//! Implementation of division operation
	INLINE l_imatrix operator /(const l_imatrix &m,const l_interval &c) noexcept;
	//! Implementation of division operation
	INLINE l_imatrix operator /(const l_imatrix_slice &ms, const l_interval &c) noexcept;
...
//------------ real - l_imatrix -----------------------------------------------
	...
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const real &c, const l_imatrix &m) noexcept;
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const real &c, const l_imatrix_slice &ms) noexcept;
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_imatrix &m,const real &c) noexcept;
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_imatrix_slice &ms,const real &c) noexcept;
	//! Implementation of multiplication and allocation operation
	INLINE l_imatrix &operator *=(l_imatrix &m,const real &c) noexcept;
	//! Implementation of division operation
	INLINE l_imatrix operator /(const l_imatrix &m,const real &c) noexcept;
	//! Implementation of division operation
	INLINE l_imatrix operator /(const l_imatrix_slice &ms, const real &c) noexcept;
...
//----------------- rmatrix - l_interval ----------------
	...
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_interval &c, const rmatrix &m) noexcept;
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_interval &c, const rmatrix_slice &ms) noexcept;
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const rmatrix &m,const l_interval &c) noexcept;
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const rmatrix_slice &ms,const l_interval &c) noexcept;
	//! Implementation of division operation
	INLINE l_imatrix operator /(const rmatrix &m,const l_interval &c) noexcept;
	//! Implementation of division operation
	INLINE l_imatrix operator /(const rmatrix_slice &ms, const l_interval &c) noexcept;
...
//------------ l_real - l_imatrix -----------------------------------------------
	...
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_real &c, const l_imatrix &m) noexcept;
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_real &c, const l_imatrix_slice &ms) noexcept;
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_imatrix &m,const l_real &c) noexcept;
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_imatrix_slice &ms,const l_real &c) noexcept;
	//! Implementation of multiplication and allocation operation
	INLINE l_imatrix &operator *=(l_imatrix &m,const l_real &c) noexcept;
	//! Implementation of division operation
	INLINE l_imatrix operator /(const l_imatrix &m,const l_real &c) noexcept;
	//! Implementation of division operation
	INLINE l_imatrix operator /(const l_imatrix_slice &ms, const l_real &c) noexcept;
...
//----------------- l_rmatrix - l_interval ----------------
	...
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_interval &c, const l_rmatrix &m) noexcept;
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_interval &c, const l_rmatrix_slice &ms) noexcept;
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_rmatrix &m,const l_interval &c) noexcept;
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_rmatrix_slice &ms,const l_interval &c) noexcept;
	//! Implementation of division operation
	INLINE l_imatrix operator /(const l_rmatrix &m,const l_interval &c) noexcept;
	//! Implementation of division operation
	INLINE l_imatrix operator /(const l_rmatrix_slice &ms, const l_interval &c) noexcept;
...
//------------ interval - l_imatrix -----------------------------------------------
	...
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const interval &c, const l_imatrix &m) noexcept;
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const interval &c, const l_imatrix_slice &ms) noexcept;
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_imatrix &m,const interval &c) noexcept;
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_imatrix_slice &ms,const interval &c) noexcept;
	//! Implementation of multiplication and allocation operation
	INLINE l_imatrix &operator *=(l_imatrix &m,const interval &c) noexcept;
	//! Implementation of division operation
	INLINE l_imatrix operator /(const l_imatrix &m,const interval &c) noexcept;
	//! Implementation of division operation
	INLINE l_imatrix operator /(const l_imatrix_slice &ms, const interval &c) noexcept;
...
//----------------- imatrix - l_interval ----------------
	...
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_interval &c, const imatrix &m) noexcept;
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const l_interval &c, const imatrix_slice &ms) noexcept;
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const imatrix &m,const l_interval &c) noexcept;
	//! Implementation of multiplication operation
	INLINE l_imatrix operator *(const imatrix_slice &ms,const l_interval &c) noexcept;
	//! Implementation of division operation
	INLINE l_imatrix operator /(const imatrix &m,const l_interval &c) noexcept;
	//! Implementation of division operation
	INLINE l_imatrix operator /(const imatrix_slice &ms, const l_interval &c) noexcept;
...
//================ Matrix / Matrix ============================
	...
	INLINE const l_imatrix &operator +(const l_imatrix &m1) noexcept;
	//! Implementation of positive sign operation
	INLINE l_imatrix operator +(const l_imatrix_slice &ms) noexcept;
	//! Implementation of addition operation
...
//-------------- Matrix - Matrix   -------------------------
	...
	INLINE bool operator ==(const l_imatrix &m1,const l_imatrix &m2) noexcept;
	...
	INLINE bool operator >=(const l_imatrix &m1,const l_imatrix &m2) noexcept;
	//! Implementation of standard equality operation
	INLINE bool operator ==(const l_imatrix &m1,const l_imatrix_slice &ms) noexcept;
	//! Implementation of standard negated equality operation
	INLINE bool operator !=(const l_imatrix &m1,const l_imatrix_slice &ms) noexcept;
	//! Implementation of standard less-than operation
	INLINE bool operator <(const l_imatrix &m1,const l_imatrix_slice &ms) noexcept;
...
//---------------- Matrix - Matrix_slice ----------------------
	...
	//! Implementation of standard equality operation
	INLINE bool operator ==(const l_imatrix_slice &m1,const l_imatrix_slice &m2) noexcept;
	//! Implementation of standard negated equality operation
	INLINE bool operator !=(const l_imatrix_slice &m1,const l_imatrix_slice &m2) noexcept;
	//! Implementation of standard less-than operation
	INLINE bool operator <(const l_imatrix_slice &m1,const l_imatrix_slice &m2) noexcept;
...
//=================== Not Operator =============================
	...
	INLINE bool operator !(const l_imatrix &ms) noexcept;
	//! Implementation of standard negation operation
	INLINE bool operator !(const l_imatrix_slice &ms) noexcept;

//======================== Input / Output ========================

	//! Implementation of standard output method
	INLINE std::ostream &operator <<(std::ostream &s,const l_imatrix &r) noexcept;
	//! Implementation of standard output method
	INLINE std::ostream &operator <<(std::ostream &s,const l_imatrix_slice &r) noexcept;
	//! Implementation of standard input method
	INLINE std::istream &operator >>(std::istream &s,l_imatrix &r) noexcept;
	//! Implementation of standard input method
	INLINE std::istream &operator >>(std::istream &s,l_imatrix_slice &r) noexcept;
