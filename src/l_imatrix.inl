...
INLINE l_imatrix::l_imatrix() noexcept:dat(NULL),lb1(1),ub1(0),lb2(1),ub2(0),xsize(0),ysize(0)
{
}

INLINE l_imatrix::l_imatrix(const l_interval &r) noexcept:lb1(1),ub1(1),lb2(1),ub2(1),xsize(1),ysize(1)
{
	dat=new l_interval[1];
	*dat=r;
}

INLINE l_imatrix::l_imatrix(const real &r) noexcept:lb1(1),ub1(1),lb2(1),ub2(1),xsize(1),ysize(1)
{
	dat=new l_interval[1];
	*dat=r;
}

INLINE l_imatrix::l_imatrix(const l_real &r) noexcept:lb1(1),ub1(1),lb2(1),ub2(1),xsize(1),ysize(1)
{
	dat=new l_interval[1];
	*dat=r;
}

INLINE l_imatrix::l_imatrix(const interval &r) noexcept:lb1(1),ub1(1),lb2(1),ub2(1),xsize(1),ysize(1)
{
	dat=new l_interval[1];
	*dat=r;
}

INLINE l_imatrix::l_imatrix(const rmatrix &rm) noexcept:lb1(rm.lb1),ub1(rm.ub1),lb2(rm.lb2),ub2(rm.ub2),xsize(rm.xsize),ysize(rm.ysize)
{
...
INLINE l_imatrix::l_imatrix(const l_rmatrix &rm) noexcept:lb1(rm.lb1),ub1(rm.ub1),lb2(rm.lb2),ub2(rm.ub2),xsize(rm.xsize),ysize(rm.ysize)
{
	dat=new l_interval[xsize*ysize];
	for(int i=0;i<xsize*ysize;i++)
		dat[i]=rm.dat[i];
...
INLINE l_imatrix::l_imatrix(const imatrix &rm) noexcept:lb1(rm.lb1),ub1(rm.ub1),lb2(rm.lb2),ub2(rm.ub2),xsize(rm.xsize),ysize(rm.ysize)
{
	dat=new l_interval[xsize*ysize];
	for(int i=0;i<xsize*ysize;i++)
		dat[i]=rm.dat[i];
...
INLINE l_imatrix::l_imatrix(const l_imatrix &rm) noexcept:lb1(rm.lb1),ub1(rm.ub1),lb2(rm.lb2),ub2(rm.ub2),xsize(rm.xsize),ysize(rm.ysize)
{
	dat=new l_interval[xsize*ysize];
	for(int i=0;i<xsize*ysize;i++)
		dat[i]=rm.dat[i];
...
INLINE l_ivector::l_ivector(const l_imatrix_subv &v) noexcept:l(v.lb),u(v.ub),size(v.size)
{
...
INLINE l_imatrix::l_imatrix(const l_ivector &v) noexcept:lb1(v.l),ub1(v.u),lb2(1),ub2(1),xsize(1),ysize(v.size)
{
...
INLINE l_imatrix::l_imatrix(const rvector &v) noexcept:lb1(v.l),ub1(v.u),lb2(1),ub2(1),xsize(1),ysize(v.size)
{
	dat=new l_interval[v.size];
	for(int i=0;i<v.size;i++)
		dat[i]=v.dat[i];
...
INLINE l_imatrix::l_imatrix(const l_rvector &v) noexcept:lb1(v.l),ub1(v.u),lb2(1),ub2(1),xsize(1),ysize(v.size)
{
	dat=new l_interval[v.size];
	for(int i=0;i<v.size;i++)
		dat[i]=v.dat[i];
...
INLINE l_imatrix::l_imatrix(const ivector &v) noexcept:lb1(v.l),ub1(v.u),lb2(1),ub2(1),xsize(1),ysize(v.size)
{
	dat=new l_interval[v.size];
	for(int i=0;i<v.size;i++)
		dat[i]=v.dat[i];
...
INLINE l_imatrix::l_imatrix(const l_ivector_slice &v) noexcept:lb1(v.start),ub1(v.end),lb2(1),ub2(1),xsize(1),ysize(v.size)
{
	dat=new l_interval[v.size];
...
INLINE l_imatrix::l_imatrix(const rvector_slice &v) noexcept:lb1(v.start),ub1(v.end),lb2(1),ub2(1),xsize(1),ysize(v.size)
{
	dat=new l_interval[v.size];
	for(int i=0,j=v.start-v.l;i<v.size;i++,j++)
		dat[i]=v.dat[j];
...
INLINE l_imatrix::l_imatrix(const ivector_slice &v) noexcept:lb1(v.start),ub1(v.end),lb2(1),ub2(1),xsize(1),ysize(v.size)
{
	dat=new l_interval[v.size];
	for(int i=0,j=v.start-v.l;i<v.size;i++,j++)
		dat[i]=v.dat[j];
...
INLINE l_imatrix::l_imatrix(const l_rvector_slice &v) noexcept:lb1(v.start),ub1(v.end),lb2(1),ub2(1),xsize(1),ysize(v.size)
{
	dat=new l_interval[v.size];
	for(int i=0,j=v.start-v.l;i<v.size;i++,j++)
		dat[i]=v.dat[j];
	...
	INLINE l_imatrix::l_imatrix(const l_imatrix_slice &sl) noexcept:lb1(sl.start1),ub1(sl.end1),lb2(sl.start2),ub2(sl.end2),xsize(sl.sxsize),ysize(sl.sysize)
	{
		int i,j;
	...
	INLINE l_imatrix::l_imatrix(const rmatrix_slice &sl) noexcept:lb1(sl.start1),ub1(sl.end1),lb2(sl.start2),ub2(sl.end2),xsize(sl.sxsize),ysize(sl.sysize)
	{
		int i,j;
	...
	INLINE l_imatrix::l_imatrix(const l_rmatrix_slice &sl) noexcept:lb1(sl.start1),ub1(sl.end1),lb2(sl.start2),ub2(sl.end2),xsize(sl.sxsize),ysize(sl.sysize)
	{
		int i,j;
	...
	INLINE l_imatrix::l_imatrix(const imatrix_slice &sl) noexcept:lb1(sl.start1),ub1(sl.end1),lb2(sl.start2),ub2(sl.end2),xsize(sl.sxsize),ysize(sl.sysize)
	{
		int i,j;
...
#endif
{
	...
	INLINE l_imatrix_subv &l_imatrix_subv::operator =(const l_imatrix_subv &rv) noexcept { return _mvmvassign(*this,rv); }
	INLINE l_imatrix_subv &l_imatrix_subv::operator =(const l_interval &r) noexcept { return _mvsassign(*this,r); }
	...
	INLINE l_imatrix_subv &l_imatrix_subv::operator =(const rmatrix_subv &rv) noexcept { return _mvvassign(*this,rvector(rv)); }
	INLINE l_imatrix_subv &l_imatrix_subv::operator =(const real &r) noexcept { return _mvsassign(*this,r); }
	...
	INLINE l_imatrix_subv &l_imatrix_subv::operator =(const l_rmatrix_subv &rv) noexcept { return _mvvassign(*this,l_rvector(rv)); }
	INLINE l_imatrix_subv &l_imatrix_subv::operator =(const l_real &r) noexcept { return _mvsassign(*this,r); }
	...
	INLINE l_imatrix_subv &l_imatrix_subv::operator =(const imatrix_subv &rv) noexcept { return _mvvassign(*this,ivector(rv)); }
	INLINE l_imatrix_subv &l_imatrix_subv::operator =(const interval &r) noexcept { return _mvsassign(*this,r); }
	...
	INLINE l_imatrix &l_imatrix::operator =(const l_interval &r) noexcept { return _msassign(*this,r); }
	INLINE l_imatrix &l_imatrix::operator =(const l_imatrix &m) noexcept { return _mmassign<l_imatrix,l_imatrix,l_interval>(*this,m, l_interval()); }
	INLINE l_imatrix &l_imatrix::operator =(const l_imatrix_slice &ms) noexcept { return _mmsassign<l_imatrix,l_imatrix_slice,l_interval>(*this,ms); }
	INLINE l_imatrix &l_imatrix::operator =(const l_ivector &v) noexcept { return _mvassign<l_imatrix,l_ivector,l_interval>(*this,v); }
	INLINE l_imatrix &l_imatrix::operator =(const l_ivector_slice &v) noexcept { return _mvassign<l_imatrix,l_ivector,l_interval>(*this,l_ivector(v)); }
	
	INLINE l_imatrix &l_imatrix::operator =(const real &r) noexcept { return _msassign(*this,l_interval(r)); }
	INLINE l_imatrix &l_imatrix::operator =(const rmatrix &m) noexcept { return _mmassign<l_imatrix,rmatrix,l_interval>(*this,m, l_interval()); }
	INLINE l_imatrix &l_imatrix::operator =(const rmatrix_slice &ms) noexcept { return _mmsassign<l_imatrix,rmatrix_slice,l_interval>(*this,ms); }
	INLINE l_imatrix &l_imatrix::operator =(const rvector &v) noexcept { return _mvassign<l_imatrix,rvector,l_interval>(*this,v); }
	INLINE l_imatrix &l_imatrix::operator =(const rvector_slice &v) noexcept { return _mvassign<l_imatrix,rvector,l_interval>(*this,rvector(v)); }
	
	INLINE l_imatrix &l_imatrix::operator =(const l_real &r) noexcept { return _msassign(*this,l_interval(r)); }
	INLINE l_imatrix &l_imatrix::operator =(const l_rmatrix &m) noexcept { return _mmassign<l_imatrix,l_rmatrix,l_interval>(*this,m, l_interval()); }
	INLINE l_imatrix &l_imatrix::operator =(const l_rmatrix_slice &ms) noexcept { return _mmsassign<l_imatrix,l_rmatrix_slice,l_interval>(*this,ms); }
	INLINE l_imatrix &l_imatrix::operator =(const l_rvector &v) noexcept { return _mvassign<l_imatrix,l_rvector,l_interval>(*this,v); }
	INLINE l_imatrix &l_imatrix::operator =(const l_rvector_slice &v) noexcept { return _mvassign<l_imatrix,l_rvector,l_interval>(*this,l_rvector(v)); }
	
	INLINE l_imatrix &l_imatrix::operator =(const interval &r) noexcept { return _msassign(*this,l_interval(r)); }
	INLINE l_imatrix &l_imatrix::operator =(const imatrix &m) noexcept { return _mmassign<l_imatrix,imatrix,l_interval>(*this,m, l_interval()); }
	INLINE l_imatrix &l_imatrix::operator =(const imatrix_slice &ms) noexcept { return _mmsassign<l_imatrix,imatrix_slice,l_interval>(*this,ms); }
	INLINE l_imatrix &l_imatrix::operator =(const ivector &v) noexcept { return _mvassign<l_imatrix,ivector,l_interval>(*this,v); }
	INLINE l_imatrix &l_imatrix::operator =(const ivector_slice &v) noexcept { return _mvassign<l_imatrix,ivector,l_interval>(*this,ivector(v)); }
	
	INLINE l_imatrix::operator void*() noexcept { return _mvoid(*this); }
	...
	INLINE l_imatrix_slice &l_imatrix_slice::operator =(const l_interval &r) noexcept { return _mssassign(*this,r); }
...
#endif
	{ return _msmsassign(*this,ms); }
	INLINE l_imatrix_slice &l_imatrix_slice::operator =(const real &r) noexcept { return _mssassign(*this,r); }
...
#endif
	{ return _msmsassign(*this,ms); }
	INLINE l_imatrix_slice &l_imatrix_slice::operator =(const l_real &r) noexcept { return _mssassign(*this,r); }
...
#endif
	{ return _msmsassign(*this,ms); }
	INLINE l_imatrix_slice &l_imatrix_slice::operator =(const interval &r) noexcept { return _mssassign(*this,r); }
	...
	INLINE l_imatrix_slice::operator void*() noexcept { return _msvoid(*this); }
	INLINE l_ivector operator /(const l_imatrix_subv &rv, const l_interval &s) noexcept { return _mvsdiv<l_imatrix_subv,l_interval,l_ivector>(rv,s); }
	INLINE l_ivector operator *(const l_imatrix_subv &rv, const l_interval &s) noexcept { return _mvsmult<l_imatrix_subv,l_interval,l_ivector>(rv,s); }
	INLINE l_ivector operator *(const l_interval &s, const l_imatrix_subv &rv) noexcept { return _mvsmult<l_imatrix_subv,l_interval,l_ivector>(rv,s); }
	INLINE l_imatrix_subv &l_imatrix_subv::operator *=(const l_interval &c) noexcept { return _mvsmultassign(*this,c); }
	INLINE l_imatrix_subv &l_imatrix_subv::operator +=(const l_interval &c) noexcept { return _mvsplusassign(*this,c); }
	INLINE l_imatrix_subv &l_imatrix_subv::operator -=(const l_interval &c) noexcept { return _mvsminusassign(*this,c); }
	INLINE l_imatrix_subv &l_imatrix_subv::operator /=(const l_interval &c) noexcept { return _mvsdivassign(*this,c); }
	INLINE l_ivector abs(const l_imatrix_subv &mv) noexcept { return _mvabs<l_imatrix_subv,l_ivector>(mv); }
	INLINE l_rvector diam(const l_imatrix_subv &mv) noexcept { return _mvdiam<l_imatrix_subv,l_rvector>(mv); }
	INLINE l_rvector mid(const l_imatrix_subv &mv) noexcept { return _mvmid<l_imatrix_subv,l_rvector>(mv); }
	INLINE l_rvector Inf(const l_imatrix_subv &mv) noexcept { return _mvinf<l_imatrix_subv,l_rvector>(mv); }
	INLINE l_rvector Sup(const l_imatrix_subv &mv) noexcept { return _mvsup<l_imatrix_subv,l_rvector>(mv); }
	...
	INLINE l_imatrix_subv &SetSup(l_imatrix_subv &iv,const l_real &r) noexcept { return _mvssetsup(iv,r); }
	INLINE l_imatrix_subv &SetInf(l_imatrix_subv &iv,const l_real &r) noexcept { return _mvssetinf(iv,r); }
	INLINE l_imatrix_subv &UncheckedSetSup(l_imatrix_subv &iv,const l_real &r) noexcept { return _mvsusetsup(iv,r); }
	INLINE l_imatrix_subv &SetUncheckedInf(l_imatrix_subv &iv,const l_real &r) noexcept { return _mvsusetinf(iv,r); }
	INLINE l_ivector &l_ivector::operator =(const l_imatrix_subv &mv) noexcept { return _vmvassign<l_ivector,l_imatrix_subv,l_interval>(*this,mv); }
	INLINE l_ivector_slice &l_ivector_slice::operator =(const l_imatrix_subv &mv) noexcept { return _vsvassign(*this,l_ivector(mv)); }
...
//  matrix x matrix
	...
	*/
	INLINE l_imatrix _imatrix(const l_imatrix &rm) noexcept { return rm; }
	/*!
	\deprecated use standard contructors for typecasting

	\sa l_imatrix(const l_ivector &v)
	*/
	INLINE l_imatrix _imatrix(const l_ivector &v) noexcept { return l_imatrix(v); }
	/*!
	\deprecated use standard contructors for typecasting

	\sa l_imatrix(const l_ivector_slice &v)
	*/
	INLINE l_imatrix _imatrix(const l_ivector_slice &v) noexcept { return l_imatrix(v); }
	/*!
	\deprecated use standard contructors for typecasting

	\sa l_imatrix(const l_interval &r)
	*/
	INLINE l_imatrix _imatrix(const l_interval &r) noexcept { return l_imatrix(r); }
	...
	INLINE void Resize(l_imatrix &A) noexcept { _mresize(A);}
	...
	INLINE l_imatrix abs(const l_imatrix &m) noexcept { return _mabs<l_imatrix,l_imatrix>(m); }
	INLINE l_imatrix abs(const l_imatrix_slice &ms) noexcept { return _msabs<l_imatrix_slice,l_imatrix>(ms); }
	INLINE l_rmatrix diam(const l_imatrix &m) noexcept { return _mdiam<l_imatrix,l_rmatrix>(m); }
	INLINE l_rmatrix diam(const l_imatrix_slice &m) noexcept { return _msdiam<l_imatrix_slice,l_rmatrix>(m); }
	INLINE l_rmatrix mid(const l_imatrix &m) noexcept { return _mmid<l_imatrix,l_rmatrix>(m); }
	INLINE l_rmatrix mid(const l_imatrix_slice &m) noexcept { return _msmid<l_imatrix_slice,l_rmatrix>(m); }
	INLINE l_rmatrix Inf(const l_imatrix &m) noexcept { return _minf<l_imatrix,l_rmatrix>(m); }
	INLINE l_rmatrix Sup(const l_imatrix &m) noexcept { return _msup<l_imatrix,l_rmatrix>(m); }
	INLINE l_rmatrix Inf(const l_imatrix_slice &m) noexcept { return _msinf<l_imatrix_slice,l_rmatrix>(m); }
	INLINE l_rmatrix Sup(const l_imatrix_slice &m) noexcept { return _mssup<l_imatrix_slice,l_rmatrix>(m); }
...
#endif
	{ _smconstr(*this,m); }
//	INLINE l_interval l_interval::_interval(const l_imatrix &m) noexcept(false) { _smconstr(*this,m); return *this; }

	INLINE l_imatrix_subv &l_imatrix_subv::operator *=(const real &c) noexcept { return _mvsmultassign(*this,c); }
	INLINE l_imatrix_subv &l_imatrix_subv::operator +=(const real &c) noexcept { return _mvsplusassign(*this,c); }
	INLINE l_imatrix_subv &l_imatrix_subv::operator -=(const real &c) noexcept { return _mvsminusassign(*this,c); }
	INLINE l_imatrix_subv &l_imatrix_subv::operator /=(const real &c) noexcept { return _mvsdivassign(*this,c); }
	...
	INLINE l_imatrix_subv &l_imatrix_subv::operator *=(const l_real &c) noexcept { return _mvsmultassign(*this,c); }
	INLINE l_imatrix_subv &l_imatrix_subv::operator +=(const l_real &c) noexcept { return _mvsplusassign(*this,c); }
	INLINE l_imatrix_subv &l_imatrix_subv::operator -=(const l_real &c) noexcept { return _mvsminusassign(*this,c); }
	INLINE l_imatrix_subv &l_imatrix_subv::operator /=(const l_real &c) noexcept { return _mvsdivassign(*this,c); }
	...
	INLINE l_imatrix_subv &l_imatrix_subv::operator *=(const interval &c) noexcept { return _mvsmultassign(*this,c); }
	INLINE l_imatrix_subv &l_imatrix_subv::operator +=(const interval &c) noexcept { return _mvsplusassign(*this,c); }
	INLINE l_imatrix_subv &l_imatrix_subv::operator -=(const interval &c) noexcept { return _mvsminusassign(*this,c); }
	INLINE l_imatrix_subv &l_imatrix_subv::operator /=(const interval &c) noexcept { return _mvsdivassign(*this,c); }
	...
	INLINE l_imatrix operator *(const l_interval &c, const l_imatrix &m) noexcept { return _smmult<l_interval,l_imatrix,l_imatrix>(c,m); }
	INLINE l_imatrix operator *(const l_interval &c, const l_imatrix_slice &ms) noexcept { return _smsmult<l_interval,l_imatrix_slice,l_imatrix>(c,ms); }
	INLINE l_imatrix operator *(const l_imatrix &m,const l_interval &c) noexcept { return _smmult<l_interval,l_imatrix,l_imatrix>(c,m); }
	INLINE l_imatrix operator *(const l_imatrix_slice &ms,const l_interval &c) noexcept { return _smsmult<l_interval,l_imatrix_slice,l_imatrix>(c,ms); }
	INLINE l_imatrix &operator *=(l_imatrix &m,const l_interval &c) noexcept { return _msmultassign(m,c); }
	INLINE l_imatrix_slice &l_imatrix_slice::operator *=(const l_imatrix &m)
#if(CXSC_INDEX_CHECK)
	noexcept(false)
#else
...
#endif
	{ return (*this=*this*m); }
	INLINE l_imatrix_slice &l_imatrix_slice::operator *=(const l_interval &c) noexcept { return _mssmultassign(*this,c); }
	INLINE l_imatrix operator /(const l_imatrix &m,const l_interval &c) noexcept { return _msdiv<l_imatrix,l_interval,l_imatrix>(m,c); }
	INLINE l_imatrix operator /(const l_imatrix_slice &ms, const l_interval &c) noexcept { return _mssdiv<l_imatrix_slice,l_interval,l_imatrix>(ms,c); }
	INLINE l_imatrix &operator /=(l_imatrix &m,const l_interval &c) noexcept { return _msdivassign(m,c); }
	INLINE l_imatrix_slice &l_imatrix_slice::operator /=(const l_interval &c) noexcept { return _mssdivassign(*this,c); }
	
	INLINE l_imatrix operator *(const real &c, const l_imatrix &m) noexcept { return _smmult<real,l_imatrix,l_imatrix>(c,m); }
	INLINE l_imatrix operator *(const real &c, const l_imatrix_slice &ms) noexcept { return _smsmult<real,l_imatrix_slice,l_imatrix>(c,ms); }
	INLINE l_imatrix operator *(const l_imatrix &m,const real &c) noexcept { return _smmult<real,l_imatrix,l_imatrix>(c,m); }
	INLINE l_imatrix operator *(const l_imatrix_slice &ms,const real &c) noexcept { return _smsmult<real,l_imatrix_slice,l_imatrix>(c,ms); }
	INLINE l_imatrix &operator *=(l_imatrix &m,const real &c) noexcept { return _msmultassign(m,c); }
	INLINE l_imatrix_slice &l_imatrix_slice::operator *=(const rmatrix &m)
#if(CXSC_INDEX_CHECK)
	noexcept(false)
#else
...
#endif
	{ return (*this=*this*m); }
	INLINE l_imatrix_slice &l_imatrix_slice::operator *=(const real &c) noexcept { return _mssmultassign(*this,c); }
	INLINE l_imatrix operator /(const l_imatrix &m,const real &c) noexcept { return _msdiv<l_imatrix,real,l_imatrix>(m,c); }
	INLINE l_imatrix operator /(const l_imatrix_slice &ms, const real &c) noexcept { return _mssdiv<l_imatrix_slice,real,l_imatrix>(ms,c); }
	INLINE l_imatrix &operator /=(l_imatrix &m,const real &c) noexcept { return _msdivassign(m,c); }
	INLINE l_imatrix_slice &l_imatrix_slice::operator /=(const real &c) noexcept { return _mssdivassign(*this,c); }

	INLINE l_imatrix operator *(const l_real &c, const l_imatrix &m) noexcept { return _smmult<l_real,l_imatrix,l_imatrix>(c,m); }
	INLINE l_imatrix operator *(const l_real &c, const l_imatrix_slice &ms) noexcept { return _smsmult<l_real,l_imatrix_slice,l_imatrix>(c,ms); }
	INLINE l_imatrix operator *(const l_imatrix &m,const l_real &c) noexcept { return _smmult<l_real,l_imatrix,l_imatrix>(c,m); }
	INLINE l_imatrix operator *(const l_imatrix_slice &ms,const l_real &c) noexcept { return _smsmult<l_real,l_imatrix_slice,l_imatrix>(c,ms); }
	INLINE l_imatrix &operator *=(l_imatrix &m,const l_real &c) noexcept { return _msmultassign(m,c); }
	INLINE l_imatrix_slice &l_imatrix_slice::operator *=(const l_rmatrix &m)
#if(CXSC_INDEX_CHECK)
	noexcept(false)
#else
...
#endif
	{ return (*this=*this*m); }
	INLINE l_imatrix_slice &l_imatrix_slice::operator *=(const l_real &c) noexcept { return _mssmultassign(*this,c); }
	INLINE l_imatrix operator /(const l_imatrix &m,const l_real &c) noexcept { return _msdiv<l_imatrix,l_real,l_imatrix>(m,c); }
	INLINE l_imatrix operator /(const l_imatrix_slice &ms, const l_real &c) noexcept { return _mssdiv<l_imatrix_slice,l_real,l_imatrix>(ms,c); }
	INLINE l_imatrix &operator /=(l_imatrix &m,const l_real &c) noexcept { return _msdivassign(m,c); }
	INLINE l_imatrix_slice &l_imatrix_slice::operator /=(const l_real &c) noexcept { return _mssdivassign(*this,c); }

	INLINE l_imatrix operator *(const interval &c, const l_imatrix &m) noexcept { return _smmult<interval,l_imatrix,l_imatrix>(c,m); }
	INLINE l_imatrix operator *(const interval &c, const l_imatrix_slice &ms) noexcept { return _smsmult<interval,l_imatrix_slice,l_imatrix>(c,ms); }
	INLINE l_imatrix operator *(const l_imatrix &m,const interval &c) noexcept { return _smmult<interval,l_imatrix,l_imatrix>(c,m); }
	INLINE l_imatrix operator *(const l_imatrix_slice &ms,const interval &c) noexcept { return _smsmult<interval,l_imatrix_slice,l_imatrix>(c,ms); }
	INLINE l_imatrix &operator *=(l_imatrix &m,const interval &c) noexcept { return _msmultassign(m,c); }
	INLINE l_imatrix_slice &l_imatrix_slice::operator *=(const imatrix &m)
#if(CXSC_INDEX_CHECK)
	noexcept(false)
#else
...
#endif
	{ return (*this=*this*m); }
	INLINE l_imatrix_slice &l_imatrix_slice::operator *=(const interval &c) noexcept { return _mssmultassign(*this,c); }
	INLINE l_imatrix operator /(const l_imatrix &m,const interval &c) noexcept { return _msdiv<l_imatrix,interval,l_imatrix>(m,c); }
	INLINE l_imatrix operator /(const l_imatrix_slice &ms, const interval &c) noexcept { return _mssdiv<l_imatrix_slice,interval,l_imatrix>(ms,c); }
	INLINE l_imatrix &operator /=(l_imatrix &m,const interval &c) noexcept { return _msdivassign(m,c); }
	INLINE l_imatrix_slice &l_imatrix_slice::operator /=(const interval &c) noexcept { return _mssdivassign(*this,c); }

//	INLINE l_interval::l_interval(const rmatrix &m) noexcept(false) { _smconstr(*this,m); }
//	INLINE l_interval l_interval::_interval(const l_imatrix &m) noexcept(false) { _smconstr(*this,m); return *this; }

	INLINE l_imatrix operator *(const l_interval &c, const rmatrix &m) noexcept { return _smmult<l_interval,rmatrix,l_imatrix>(c,m); }
	INLINE l_imatrix operator *(const l_interval &c, const rmatrix_slice &ms) noexcept { return _smsmult<l_interval,rmatrix_slice,l_imatrix>(c,ms); }
	INLINE l_imatrix operator *(const rmatrix &m,const l_interval &c) noexcept { return _smmult<l_interval,rmatrix,l_imatrix>(c,m); }
	INLINE l_imatrix operator *(const rmatrix_slice &ms,const l_interval &c) noexcept { return _smsmult<l_interval,rmatrix_slice,l_imatrix>(c,ms); }
	INLINE l_imatrix operator /(const rmatrix &m,const l_interval &c) noexcept { return _msdiv<rmatrix,l_interval,l_imatrix>(m,c); }
	INLINE l_imatrix operator /(const rmatrix_slice &ms, const l_interval &c) noexcept { return _mssdiv<rmatrix_slice,l_interval,l_imatrix>(ms,c); }

	INLINE l_imatrix operator *(const l_interval &c, const l_rmatrix &m) noexcept { return _smmult<l_interval,l_rmatrix,l_imatrix>(c,m); }
	INLINE l_imatrix operator *(const l_interval &c, const l_rmatrix_slice &ms) noexcept { return _smsmult<l_interval,l_rmatrix_slice,l_imatrix>(c,ms); }
	INLINE l_imatrix operator *(const l_rmatrix &m,const l_interval &c) noexcept { return _smmult<l_interval,l_rmatrix,l_imatrix>(c,m); }
	INLINE l_imatrix operator *(const l_rmatrix_slice &ms,const l_interval &c) noexcept { return _smsmult<l_interval,l_rmatrix_slice,l_imatrix>(c,ms); }
	INLINE l_imatrix operator /(const l_rmatrix &m,const l_interval &c) noexcept { return _msdiv<l_rmatrix,l_interval,l_imatrix>(m,c); }
	INLINE l_imatrix operator /(const l_rmatrix_slice &ms, const l_interval &c) noexcept { return _mssdiv<l_rmatrix_slice,l_interval,l_imatrix>(ms,c); }

	INLINE l_imatrix operator *(const l_interval &c, const imatrix &m) noexcept { return _smmult<l_interval,imatrix,l_imatrix>(c,m); }
	INLINE l_imatrix operator *(const l_interval &c, const imatrix_slice &ms) noexcept { return _smsmult<l_interval,imatrix_slice,l_imatrix>(c,ms); }
	INLINE l_imatrix operator *(const imatrix &m,const l_interval &c) noexcept { return _smmult<l_interval,imatrix,l_imatrix>(c,m); }
	INLINE l_imatrix operator *(const imatrix_slice &ms,const l_interval &c) noexcept { return _smsmult<l_interval,imatrix_slice,l_imatrix>(c,ms); }
	INLINE l_imatrix operator /(const imatrix &m,const l_interval &c) noexcept { return _msdiv<imatrix,l_interval,l_imatrix>(m,c); }
	INLINE l_imatrix operator /(const imatrix_slice &ms, const l_interval &c) noexcept { return _mssdiv<imatrix_slice,l_interval,l_imatrix>(ms,c); }
	...
	INLINE const l_imatrix &operator +(const l_imatrix &m) noexcept { return m; }
	INLINE l_imatrix operator +(const l_imatrix_slice &m) noexcept { return l_imatrix(m); }
	...
	INLINE l_imatrix operator -(const l_imatrix &m) noexcept { return _mminus(m); }
	INLINE l_imatrix operator -(const l_imatrix_slice &m) noexcept { return _msminus<l_imatrix_slice,l_imatrix>(m); }
	INLINE l_imatrix operator -(const l_imatrix &m1,const l_imatrix &m2)
#if(CXSC_INDEX_CHECK)
	noexcept(false)
#else
...
//------------- l_real x l_real ------------------------
	...
	INLINE bool operator ==(const l_imatrix &m1,const l_imatrix &m2) noexcept { return _mmeq(m1,m2); }
	INLINE bool operator !=(const l_imatrix &m1,const l_imatrix &m2) noexcept { return _mmneq(m1,m2); }
	INLINE bool operator <(const l_imatrix &m1,const l_imatrix &m2) noexcept { return _mmless(m1,m2); }
	INLINE bool operator <=(const l_imatrix &m1,const l_imatrix &m2) noexcept { return _mmleq(m1,m2); }
	INLINE bool operator >(const l_imatrix &m1,const l_imatrix &m2) noexcept { return _mmless(m2,m1); }
	INLINE bool operator >=(const l_imatrix &m1,const l_imatrix &m2) noexcept { return _mmleq(m2,m1); }
	INLINE bool operator ==(const l_imatrix &m1,const l_imatrix_slice &ms) noexcept { return _mmseq(m1,ms); }
	INLINE bool operator !=(const l_imatrix &m1,const l_imatrix_slice &ms) noexcept { return _mmsneq(m1,ms); }
	INLINE bool operator <(const l_imatrix &m1,const l_imatrix_slice &ms) noexcept { return _mmsless(m1,ms); }
	INLINE bool operator <=(const l_imatrix &m1,const l_imatrix_slice &ms) noexcept { return _mmsleq(m1,ms); }
	INLINE bool operator >(const l_imatrix &m1,const l_imatrix_slice &ms) noexcept { return _msmless(ms,m1); }
	INLINE bool operator >=(const l_imatrix &m1,const l_imatrix_slice &ms) noexcept { return _msmleq(ms,m1); }
	INLINE bool operator ==(const l_imatrix_slice &m1,const l_imatrix_slice &m2) noexcept { return _msmseq(m1,m2); }
	INLINE bool operator !=(const l_imatrix_slice &m1,const l_imatrix_slice &m2) noexcept { return _msmsneq(m1,m2); }
	INLINE bool operator <(const l_imatrix_slice &m1,const l_imatrix_slice &m2) noexcept { return _msmsless(m1,m2); }
	INLINE bool operator <=(const l_imatrix_slice &m1,const l_imatrix_slice &m2) noexcept { return _msmsleq(m1,m2); }
	INLINE bool operator >(const l_imatrix_slice &m1,const l_imatrix_slice &m2) noexcept { return _msmsless(m2,m1); }
	INLINE bool operator >=(const l_imatrix_slice &m1,const l_imatrix_slice &m2) noexcept { return _msmsleq(m2,m1); }
	INLINE bool operator !(const l_imatrix &ms) noexcept { return _mnot(ms); }
	INLINE bool operator !(const l_imatrix_slice &ms) noexcept { return _msnot(ms); }
	INLINE std::ostream &operator <<(std::ostream &s,const l_imatrix &r) noexcept { return _mout(s,r); }
	INLINE std::ostream &operator <<(std::ostream &s,const l_imatrix_slice &r) noexcept { return _msout(s,r); }
	INLINE std::istream &operator >>(std::istream &s,l_imatrix &r) noexcept { return _min(s,r); }
	INLINE std::istream &operator >>(std::istream &s,l_imatrix_slice &r) noexcept { return _msin(s,r); }
