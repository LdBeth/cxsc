...
namespace cxsc {
	...
	INLINE ivector::ivector(const rmatrix_subv &v) noexcept:l(v.lb),u(v.ub),size(v.size)
	{
	...
	*/
	...
	INLINE ivector &ivector::operator =(const rmatrix_subv &mv) noexcept { return _vmvassign<ivector,rmatrix_subv,interval>(*this,mv); }
	INLINE ivector_slice &ivector_slice::operator =(const rmatrix_subv &mv) noexcept { return _vsvassign(*this,rvector(mv)); }
