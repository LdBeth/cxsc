...
INLINE l_rmatrix::l_rmatrix() noexcept:dat(NULL),lb1(1),ub1(0),lb2(1),ub2(0),xsize(0),ysize(0)
{
}

INLINE l_rmatrix::l_rmatrix(const l_real &r) noexcept:lb1(1),ub1(1),lb2(1),ub2(1),xsize(1),ysize(1)
{
	dat=new l_real[1];
	*dat=r;
}

INLINE l_rmatrix::l_rmatrix(const real &r) noexcept:lb1(1),ub1(1),lb2(1),ub2(1),xsize(1),ysize(1)
{
	dat=new l_real[1];
	*dat=r;
}

INLINE l_rmatrix::l_rmatrix(const l_rmatrix &rm) noexcept:lb1(rm.lb1),ub1(rm.ub1),lb2(rm.lb2),ub2(rm.ub2),xsize(rm.xsize),ysize(rm.ysize)
{
...
INLINE l_rmatrix::l_rmatrix(const rmatrix &rm) noexcept:lb1(rm.lb1),ub1(rm.ub1),lb2(rm.lb2),ub2(rm.ub2),xsize(rm.xsize),ysize(rm.ysize)
{
	dat=new l_real[xsize*ysize];
	for(int i=0;i<xsize*ysize;i++)
		dat[i]=rm.dat[i];
...
INLINE l_rvector::l_rvector(const l_rmatrix_subv &v) noexcept:l(v.lb),u(v.ub),size(v.size)
{
	dat=new l_real[size];
...
INLINE l_rvector _l_rvector(const rmatrix_subv &rs) noexcept { return l_rvector(rs); }

INLINE l_rmatrix::l_rmatrix(const l_rvector &v) noexcept:lb1(v.l),ub1(v.u),lb2(1),ub2(1),xsize(1),ysize(v.size)
{
...
INLINE l_rmatrix::l_rmatrix(const rvector &v) noexcept:lb1(v.l),ub1(v.u),lb2(1),ub2(1),xsize(1),ysize(v.size)
{
	dat=new l_real[v.size];
	for(int i=0;i<v.size;i++)
		dat[i]=v.dat[i];
...
INLINE l_rmatrix::l_rmatrix(const l_rvector_slice &v) noexcept:lb1(v.start),ub1(v.end),lb2(1),ub2(1),xsize(1),ysize(v.size)
{
	dat=new l_real[v.size];
...
INLINE l_rmatrix::l_rmatrix(const rvector_slice &v) noexcept:lb1(v.start),ub1(v.end),lb2(1),ub2(1),xsize(1),ysize(v.size)
{
	dat=new l_real[v.size];
	for(int i=0,j=v.start-v.l;i<v.size;i++,j++)
		dat[i]=v.dat[j];
	...
	INLINE l_rmatrix::l_rmatrix(const l_rmatrix_slice &sl) noexcept:lb1(sl.start1),ub1(sl.end1),lb2(sl.start2),ub2(sl.end2),xsize(sl.sxsize),ysize(sl.sysize)
	{
		int i,j;
	...
	INLINE l_rmatrix::l_rmatrix(const rmatrix_slice &sl) noexcept:lb1(sl.start1),ub1(sl.end1),lb2(sl.start2),ub2(sl.end2),xsize(sl.sxsize),ysize(sl.sysize)
	{
		int i,j;
...
#endif
{
	...
	INLINE l_rmatrix_subv &l_rmatrix_subv::operator =(const l_rmatrix_subv &rv) noexcept { return _mvmvassign(*this,rv); }
	INLINE l_rmatrix_subv &l_rmatrix_subv::operator =(const l_real &r) noexcept { return _mvsassign(*this,r); }
	...
	INLINE l_rmatrix_subv &l_rmatrix_subv::operator =(const rmatrix_subv &rv) noexcept { return _mvvassign(*this,rvector(rv)); }
	INLINE l_rmatrix_subv &l_rmatrix_subv::operator =(const real &r) noexcept { return _mvsassign(*this,r); }
...
#endif
	{ return _mvvassign(*this,l_rvector(v)); }
	INLINE l_rmatrix &l_rmatrix::operator =(const l_real &r) noexcept { return _msassign(*this,r); }
	INLINE l_rmatrix &l_rmatrix::operator =(const l_rmatrix &m) noexcept { return _mmassign<l_rmatrix,l_rmatrix,l_real>(*this,m, l_real(0)); }
	INLINE l_rmatrix &l_rmatrix::operator =(const l_rmatrix_slice &ms) noexcept { return _mmsassign<l_rmatrix,l_rmatrix_slice,l_real>(*this,ms); }
	INLINE l_rmatrix &l_rmatrix::operator =(const l_rvector &v) noexcept { return _mvassign<l_rmatrix,l_rvector,l_real>(*this,v); }
	INLINE l_rmatrix &l_rmatrix::operator =(const l_rvector_slice &v) noexcept { return _mvassign<l_rmatrix,l_rvector,l_real>(*this,l_rvector(v)); }
	INLINE l_rmatrix &l_rmatrix::operator =(const real &r) noexcept { return _msassign(*this,l_real(r)); }
	INLINE l_rmatrix &l_rmatrix::operator =(const rmatrix &m) noexcept { return _mmassign<l_rmatrix,rmatrix,l_real>(*this,m, l_real(0)); }
	INLINE l_rmatrix &l_rmatrix::operator =(const rmatrix_slice &ms) noexcept { return _mmsassign<l_rmatrix,rmatrix_slice,l_real>(*this,ms); }
	INLINE l_rmatrix &l_rmatrix::operator =(const rvector &v) noexcept { return _mvassign<l_rmatrix,rvector,l_real>(*this,v); }
	INLINE l_rmatrix &l_rmatrix::operator =(const rvector_slice &v) noexcept { return _mvassign<l_rmatrix,rvector,l_real>(*this,rvector(v)); }
	
	INLINE l_rmatrix::operator void*() noexcept { return _mvoid(*this); }
	...
	INLINE l_rmatrix_slice &l_rmatrix_slice::operator =(const l_real &r) noexcept { return _mssassign(*this,r); }
...
#endif
	{ return _msmsassign(*this,ms); }
	INLINE l_rmatrix_slice &l_rmatrix_slice::operator =(const real &r) noexcept { return _mssassign(*this,r); }
	...
	INLINE l_rmatrix_slice::operator void*() noexcept { return _msvoid(*this); }
	INLINE l_rvector operator /(const l_rmatrix_subv &rv, const l_real &s) noexcept { return _mvsdiv<l_rmatrix_subv,l_real,l_rvector>(rv,s); }
	INLINE l_rvector operator *(const l_rmatrix_subv &rv, const l_real &s) noexcept { return _mvsmult<l_rmatrix_subv,l_real,l_rvector>(rv,s); }
	INLINE l_rvector operator *(const l_real &s, const l_rmatrix_subv &rv) noexcept { return _mvsmult<l_rmatrix_subv,l_real,l_rvector>(rv,s); }
	INLINE l_rmatrix_subv &l_rmatrix_subv::operator *=(const l_real &c) noexcept { return _mvsmultassign(*this,c); }
	INLINE l_rmatrix_subv &l_rmatrix_subv::operator +=(const l_real &c) noexcept { return _mvsplusassign(*this,c); }
	INLINE l_rmatrix_subv &l_rmatrix_subv::operator -=(const l_real &c) noexcept { return _mvsminusassign(*this,c); }
	INLINE l_rmatrix_subv &l_rmatrix_subv::operator /=(const l_real &c) noexcept { return _mvsdivassign(*this,c); }
	INLINE l_rvector abs(const l_rmatrix_subv &mv) noexcept { return _mvabs<l_rmatrix_subv,l_rvector>(mv); }
	INLINE l_rvector &l_rvector::operator =(const l_rmatrix_subv &mv) noexcept { return _vmvassign<l_rvector,l_rmatrix_subv,l_real>(*this,mv); }
	INLINE l_rvector_slice &l_rvector_slice::operator =(const l_rmatrix_subv &mv) noexcept { return _vsvassign(*this,l_rvector(mv)); }
...
// l_rmatrix x l_rmatrix	
	...
	*/
	INLINE l_rmatrix _l_rmatrix(const l_rmatrix &rm) noexcept { return rm; }
	/*!
	\deprecated use standard contructors for typecasting

	\sa cxsc::l_rmatrix::l_rmatrix(const l_rvector &v)
	*/
	INLINE l_rmatrix _l_rmatrix(const l_rvector &v) noexcept { return l_rmatrix(v); }
	/*!
	\deprecated use standard contructors for typecasting

	\sa cxsc::l_rmatrix::l_rmatrix(const l_rvector_slice &v)
	*/
	INLINE l_rmatrix _l_rmatrix(const l_rvector_slice &v) noexcept { return l_rmatrix(v); }
	/*!
	\deprecated use standard contructors for typecasting

	\sa cxsc::l_rmatrix::l_rmatrix(const l_real &r)
	*/
	INLINE l_rmatrix _l_rmatrix(const l_real &r) noexcept { return l_rmatrix(r); }
	...
	INLINE void Resize(l_rmatrix &A) noexcept { _mresize(A);}
	...
	INLINE l_rmatrix abs(const l_rmatrix &m) noexcept { return _mabs<l_rmatrix,l_rmatrix>(m); }
	INLINE l_rmatrix abs(const l_rmatrix_slice &ms) noexcept { return _msabs<l_rmatrix_slice,l_rmatrix>(ms); }
...
#endif
	{ _smconstr(*this,m); }
//	INLINE l_real l_real::_l_real(const l_rmatrix &m) noexcept(false) { _smconstr(*this,m); return *this; }
	INLINE l_rmatrix operator *(const l_real &c, const l_rmatrix &m) noexcept { return _smmult<l_real,l_rmatrix,l_rmatrix>(c,m); }
	INLINE l_rmatrix operator *(const l_real &c, const l_rmatrix_slice &ms) noexcept { return _smsmult<l_real,l_rmatrix_slice,l_rmatrix>(c,ms); }
	INLINE l_rmatrix operator *(const l_rmatrix &m,const l_real &c) noexcept { return _smmult<l_real,l_rmatrix,l_rmatrix>(c,m); }
	INLINE l_rmatrix operator *(const l_rmatrix_slice &ms,const l_real &c) noexcept { return _smsmult<l_real,l_rmatrix_slice,l_rmatrix>(c,ms); }
	INLINE l_rmatrix &operator *=(l_rmatrix &m,const l_real &c) noexcept { return _msmultassign(m,c); }
	INLINE l_rmatrix_slice &l_rmatrix_slice::operator *=(const l_rmatrix &m)
#if(CXSC_INDEX_CHECK)
	noexcept(false)
#else
...
#endif
	{ return (*this=*this*m); }
	INLINE l_rmatrix_slice &l_rmatrix_slice::operator *=(const l_real &c) noexcept { return _mssmultassign(*this,c); }
	INLINE l_rmatrix operator /(const l_rmatrix &m,const l_real &c) noexcept { return _msdiv<l_rmatrix,l_real,l_rmatrix>(m,c); }
	INLINE l_rmatrix operator /(const l_rmatrix_slice &ms, const l_real &c) noexcept { return _mssdiv<l_rmatrix_slice,l_real,l_rmatrix>(ms,c); }
	INLINE l_rmatrix &operator /=(l_rmatrix &m,const l_real &c) noexcept { return _msdivassign(m,c); }
	INLINE l_rmatrix_slice &l_rmatrix_slice::operator /=(const l_real &c) noexcept { return _mssdivassign(*this,c); }
	INLINE l_rmatrix operator *(const real &c, const l_rmatrix &m) noexcept { return _smmult<real,l_rmatrix,l_rmatrix>(c,m); }
	INLINE l_rmatrix operator *(const real &c, const l_rmatrix_slice &ms) noexcept { return _smsmult<real,l_rmatrix_slice,l_rmatrix>(c,ms); }
	INLINE l_rmatrix operator *(const l_rmatrix &m,const real &c) noexcept { return _smmult<real,l_rmatrix,l_rmatrix>(c,m); }
	INLINE l_rmatrix operator *(const l_rmatrix_slice &ms,const real &c) noexcept { return _smsmult<real,l_rmatrix_slice,l_rmatrix>(c,ms); }
	INLINE l_rmatrix &operator *=(l_rmatrix &m,const real &c) noexcept { return _msmultassign(m,c); }
	INLINE l_rmatrix_slice &l_rmatrix_slice::operator *=(const rmatrix &m)
#if(CXSC_INDEX_CHECK)
	noexcept(false)
#else
...
#endif
	{ return (*this=*this*m); }
	INLINE l_rmatrix_slice &l_rmatrix_slice::operator *=(const real &c) noexcept { return _mssmultassign(*this,c); }
	INLINE l_rmatrix operator /(const l_rmatrix &m,const real &c) noexcept { return _msdiv<l_rmatrix,real,l_rmatrix>(m,c); }
	INLINE l_rmatrix operator /(const l_rmatrix_slice &ms, const real &c) noexcept { return _mssdiv<l_rmatrix_slice,real,l_rmatrix>(ms,c); }
	INLINE l_rmatrix &operator /=(l_rmatrix &m,const real &c) noexcept { return _msdivassign(m,c); }
	INLINE l_rmatrix_slice &l_rmatrix_slice::operator /=(const real &c) noexcept { return _mssdivassign(*this,c); }
//	INLINE l_real::l_real(const rmatrix &m) noexcept(false) { _smconstr(*this,m); }
//	INLINE l_real l_real::_l_real(const l_rmatrix &m) noexcept(false) { _smconstr(*this,m); return *this; }
	INLINE l_rmatrix operator *(const l_real &c, const rmatrix &m) noexcept { return _smmult<l_real,rmatrix,l_rmatrix>(c,m); }
	INLINE l_rmatrix operator *(const l_real &c, const rmatrix_slice &ms) noexcept { return _smsmult<l_real,rmatrix_slice,l_rmatrix>(c,ms); }
	INLINE l_rmatrix operator *(const rmatrix &m,const l_real &c) noexcept { return _smmult<l_real,rmatrix,l_rmatrix>(c,m); }
	INLINE l_rmatrix operator *(const rmatrix_slice &ms,const l_real &c) noexcept { return _smsmult<l_real,rmatrix_slice,l_rmatrix>(c,ms); }
	INLINE l_rmatrix operator /(const rmatrix &m,const l_real &c) noexcept { return _msdiv<rmatrix,l_real,l_rmatrix>(m,c); }
	INLINE l_rmatrix operator /(const rmatrix_slice &ms, const l_real &c) noexcept { return _mssdiv<rmatrix_slice,l_real,l_rmatrix>(ms,c); }
	...
	INLINE const l_rmatrix &operator +(const l_rmatrix &m) noexcept { return m; }
	INLINE l_rmatrix operator +(const l_rmatrix_slice &m) noexcept { return l_rmatrix(m); }
	...
	INLINE l_rmatrix operator -(const l_rmatrix &m) noexcept { return _mminus(m); }
	INLINE l_rmatrix operator -(const l_rmatrix_slice &m) noexcept { return _msminus<l_rmatrix_slice,l_rmatrix>(m); }
	INLINE l_rmatrix operator -(const l_rmatrix &m1,const l_rmatrix &m2)
#if(CXSC_INDEX_CHECK)
	noexcept(false)
#else
	...
	INLINE bool operator ==(const l_rmatrix &m1,const l_rmatrix &m2) noexcept { return _mmeq(m1,m2); }
	INLINE bool operator !=(const l_rmatrix &m1,const l_rmatrix &m2) noexcept { return _mmneq(m1,m2); }
	INLINE bool operator <(const l_rmatrix &m1,const l_rmatrix &m2) noexcept { return _mmless(m1,m2); }
	INLINE bool operator <=(const l_rmatrix &m1,const l_rmatrix &m2) noexcept { return _mmleq(m1,m2); }
	INLINE bool operator >(const l_rmatrix &m1,const l_rmatrix &m2) noexcept { return _mmless(m2,m1); }
	INLINE bool operator >=(const l_rmatrix &m1,const l_rmatrix &m2) noexcept { return _mmleq(m2,m1); }
	INLINE bool operator ==(const l_rmatrix &m1,const l_rmatrix_slice &ms) noexcept { return _mmseq(m1,ms); }
	INLINE bool operator !=(const l_rmatrix &m1,const l_rmatrix_slice &ms) noexcept { return _mmsneq(m1,ms); }
	INLINE bool operator <(const l_rmatrix &m1,const l_rmatrix_slice &ms) noexcept { return _mmsless(m1,ms); }
	INLINE bool operator <=(const l_rmatrix &m1,const l_rmatrix_slice &ms) noexcept { return _mmsleq(m1,ms); }
	INLINE bool operator >(const l_rmatrix &m1,const l_rmatrix_slice &ms) noexcept { return _msmless(ms,m1); }
	INLINE bool operator >=(const l_rmatrix &m1,const l_rmatrix_slice &ms) noexcept { return _msmleq(ms,m1); }
	INLINE bool operator ==(const l_rmatrix_slice &m1,const l_rmatrix_slice &m2) noexcept { return _msmseq(m1,m2); }
	INLINE bool operator !=(const l_rmatrix_slice &m1,const l_rmatrix_slice &m2) noexcept { return _msmsneq(m1,m2); }
	INLINE bool operator <(const l_rmatrix_slice &m1,const l_rmatrix_slice &m2) noexcept { return _msmsless(m1,m2); }
	INLINE bool operator <=(const l_rmatrix_slice &m1,const l_rmatrix_slice &m2) noexcept { return _msmsleq(m1,m2); }
	INLINE bool operator >(const l_rmatrix_slice &m1,const l_rmatrix_slice &m2) noexcept { return _msmsless(m2,m1); }
	INLINE bool operator >=(const l_rmatrix_slice &m1,const l_rmatrix_slice &m2) noexcept { return _msmsleq(m2,m1); }
	INLINE bool operator !(const l_rmatrix &ms) noexcept { return _mnot(ms); }
	INLINE bool operator !(const l_rmatrix_slice &ms) noexcept { return _msnot(ms); }
	INLINE std::ostream &operator <<(std::ostream &s,const l_rmatrix &r) noexcept { return _mout(s,r); }
	INLINE std::ostream &operator <<(std::ostream &s,const l_rmatrix_slice &r) noexcept { return _msout(s,r); }
	INLINE std::istream &operator >>(std::istream &s,l_rmatrix &r) noexcept { return _min(s,r); }
	INLINE std::istream &operator >>(std::istream &s,l_rmatrix_slice &r) noexcept { return _msin(s,r); }
