...
inline Tres spsp_vv_mult(const Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class Tres, class TDot>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class Tres, class TDot>
inline Tres slsp_vv_mult(const Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class Tres, class TDot>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class Tres, class TDot>
inline Tres spsl_vv_mult(const Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class Tres, class TDot>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class Tres, class TDot>
inline Tres spf_vv_mult(const Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class Tres, class TDot>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class Tres, class TDot>
inline Tres fsp_vv_mult(const Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class Tres, class TDot>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class Tres, class TDot>
inline Tres slf_vv_mult(const Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class Tres, class TDot>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class Tres, class TDot>
inline Tres fsl_vv_mult(const Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class Tres, class TDot>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class Tres, class TDot>
inline Tres slsl_vv_mult(const Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class Tres, class TDot>
...
inline Tres spsp_vv_add(const Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class Tres, class TType>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class Tres, class TType>
inline Tres slsp_vv_add(const Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class Tres, class TType>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class Tres, class TType>
inline Tres spsl_vv_add(const Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class Tres, class TType>
...
inline Tres spf_vv_add(const Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class Tres>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class Tres>
inline Tres fsp_vv_add(const Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class Tres>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class Tres>
inline Tres slf_vv_add(const Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class Tres>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class Tres>
inline Tres fsl_vv_add(const Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class Tres>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class Tres, class TType>
inline Tres slsl_vv_add(const Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class Tres, class TType>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class Tres, class TType>
inline Tres spsp_vv_sub(const Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class Tres, class TType>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class Tres, class TType>
inline Tres slsp_vv_sub(const Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class Tres, class TType>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class Tres, class TType>
inline Tres spsl_vv_sub(const Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class Tres, class TType>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class Tres>
inline Tres spf_vv_sub(const Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class Tres>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class Tres>
inline Tres fsp_vv_sub(const Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class Tres>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class Tres>
inline Tres slf_vv_sub(const Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class Tres>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class Tres>
inline Tres fsl_vv_sub(const Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class Tres>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class Tres, class TType>
inline Tres slsl_vv_sub(const Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class Tres, class TType>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class Tres, class TType>
inline Tres spsp_vv_hull(const Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class Tres, class TType>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class Tres, class TType>
inline Tres slsp_vv_hull(const Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class Tres, class TType>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class Tres, class TType>
inline Tres spsl_vv_hull(const Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class Tres, class TType>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class Tres>
inline Tres spf_vv_hull(const Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class Tres>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class Tres>
inline Tres fsp_vv_hull(const Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class Tres>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class Tres>
inline Tres slf_vv_hull(const Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class Tres>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class Tres>
inline Tres fsl_vv_hull(const Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class Tres>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class Tres, class TType>
inline Tres slsl_vv_hull(const Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class Tres, class TType>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class Tres, class TType>
inline Tres spsp_vv_intersect(const Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class Tres, class TType>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class Tres, class TType>
inline Tres slsp_vv_intersect(const Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class Tres, class TType>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class Tres, class TType>
inline Tres spsl_vv_intersect(const Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class Tres, class TType>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class Tres>
inline Tres spf_vv_intersect(const Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class Tres>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class Tres>
inline Tres fsp_vv_intersect(const Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class Tres>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class Tres>
inline Tres slf_vv_intersect(const Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class Tres>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class Tres>
inline Tres fsl_vv_intersect(const Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class Tres>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class Tres, class TType>
inline Tres slsl_vv_intersect(const Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class Tres, class TType>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class TType>
inline Tx& fssp_vv_assign(Tx& v1, const Ty& v2) noexcept(false);
#else
template<class Tx, class Ty, class TType>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class TType>
inline Tx& fssl_vv_assign(Tx& v1, const Ty& v2) noexcept(false);
#else
template<class Tx, class Ty, class TType>
...
inline Tx& slsl_vv_assign(Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class TType, class TIt>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class TType, class TIt>
inline Tx& slsp_vv_assign(Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class TType, class TIt>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class TType, class TIt>
inline Tx& slf_vv_assign(Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class TType, class TIt>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty>
inline Tx& spf_vv_addassign(Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty>
inline Tx& spsp_vv_addassign(Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty>
inline Tx& spsl_vv_addassign(Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty>
inline Tx& fsp_vv_addassign(Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty>
inline Tx& fsl_vv_addassign(Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty>
inline Tx& spf_vv_subassign(Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty>
inline Tx& spsp_vv_subassign(Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty>
inline Tx& spsl_vv_subassign(Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty>
inline Tx& fsp_vv_subassign(Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty>
inline Tx& fsl_vv_subassign(Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty>
inline Tx& spf_vv_hullassign(Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty>
inline Tx& spsp_vv_hullassign(Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty>
inline Tx& spsl_vv_hullassign(Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty>
inline Tx& fsp_vv_hullassign(Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty>
inline Tx& fsl_vv_hullassign(Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty>
inline Tx& spf_vv_intersectassign(Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty>
inline Tx& spsp_vv_intersectassign(Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty>
inline Tx& spsl_vv_intersectassign(Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty>
inline Tx& fsp_vv_intersectassign(Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty>
inline Tx& fsl_vv_intersectassign(Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class TType>
inline Tx& slf_vv_addassign(Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class TType>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty>
inline Tx& slsp_vv_addassign(Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty>
inline Tx& slsl_vv_addassign(Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class TType>
inline Tx& slf_vv_subassign(Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class TType>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty>
inline Tx& slsp_vv_subassign(Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty>
inline Tx& slsl_vv_subassign(Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class TType>
inline Tx& slf_vv_hullassign(Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class TType>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty>
inline Tx& slsp_vv_hullassign(Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty>
inline Tx& slsl_vv_hullassign(Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty, class TType>
inline Tx& slf_vv_intersectassign(Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty, class TType>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty>
inline Tx& slsp_vv_intersectassign(Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty>
...
#if(CXSC_INDEX_CHECK)
template<class Tx, class Ty>
inline Tx& slsl_vv_intersectassign(Tx&, const Ty&) noexcept(false);
#else
template<class Tx, class Ty>
...
inline Tres spsl_mv_mult(const TA&, const Tx&) noexcept(false);
#else
template<class TA, class Tx, class Tres, class TDot>
...
#if(CXSC_INDEX_CHECK)
template<class TA, class Tx, class Tres, class TDot>
inline Tres spsp_mv_mult(const TA&, const Tx&) noexcept(false);
#else
template<class TA, class Tx, class Tres, class TDot>
...
#if(CXSC_INDEX_CHECK)
template<class TA, class Tx, class Tres, class TDot>
inline Tres spf_mv_mult(const TA&, const Tx&) noexcept(false);
#else
template<class TA, class Tx, class Tres, class TDot>
...
#if(CXSC_INDEX_CHECK)
template<class TA, class Tx, class Tres, class TDot>
inline Tres fsp_mv_mult(const TA&, const Tx&) noexcept(false);
#else
template<class TA, class Tx, class Tres, class TDot>
...
#if(CXSC_INDEX_CHECK)
template<class TA, class Tx, class Tres, class TDot>
inline Tres fsl_mv_mult(const TA&, const Tx&) noexcept(false);
#else
template<class TA, class Tx, class Tres, class TDot>
...
inline void spsp_vv_accu(TDot&, const Tx&, const Ty&) noexcept(false);
#else
template<class TDot, class Tx, class Ty, class TSparseDot>
...
#if(CXSC_INDEX_CHECK)
template<class TDot, class Tx, class Ty, class TSparseDot>
inline void spf_vv_accu(TDot&, const Tx&, const Ty&) noexcept(false);
#else
template<class TDot, class Tx, class Ty, class TSparseDot>
...
#if(CXSC_INDEX_CHECK)
template<class TDot, class Tx, class Ty, class TSparseDot>
inline void fsp_vv_accu(TDot&, const Tx&, const Ty&) noexcept(false);
#else
template<class TDot, class Tx, class Ty, class TSparseDot>
...
#if(CXSC_INDEX_CHECK)
template<class TDot, class Tx, class Ty, class TSparseDot>
inline void slsl_vv_accu(TDot&, const Tx&, const Ty&) noexcept(false);
#else
template<class TDot, class Tx, class Ty, class TSparseDot>
...
#if(CXSC_INDEX_CHECK)
template<class TDot, class Tx, class Ty, class TSparseDot>
inline void spsl_vv_accu(TDot&, const Tx&, const Ty&) noexcept(false);
#else
template<class TDot, class Tx, class Ty, class TSparseDot>
...
#if(CXSC_INDEX_CHECK)
template<class TDot, class Tx, class Ty, class TSparseDot>
inline void slsp_vv_accu(TDot&, const Tx&, const Ty&) noexcept(false);
#else
template<class TDot, class Tx, class Ty, class TSparseDot>
...
#if(CXSC_INDEX_CHECK)
template<class TDot, class Tx, class Ty, class TSparseDot>
inline void slf_vv_accu(TDot&, const Tx&, const Ty&) noexcept(false);
#else
template<class TDot, class Tx, class Ty, class TSparseDot>
...
#if(CXSC_INDEX_CHECK)
template<class TDot, class Tx, class Ty, class TSparseDot>
inline void fsl_vv_accu(TDot&, const Tx&, const Ty&) noexcept(false);
#else
template<class TDot, class Tx, class Ty, class TSparseDot>
...
#if(CXSC_INDEX_CHECK)
template<class TDot, class Tx, class Ty, class TSparseDot>
inline void spsp_vv_accuapprox(TDot&, const Tx&, const Ty&) noexcept(false);
#else
template<class TDot, class Tx, class Ty, class TSparseDot>
...
#if(CXSC_INDEX_CHECK)
template<class TDot, class Tx, class Ty, class TSparseDot>
inline void spf_vv_accuapprox(TDot&, const Tx&, const Ty&) noexcept(false);
#else
template<class TDot, class Tx, class Ty, class TSparseDot>
...
#if(CXSC_INDEX_CHECK)
template<class TDot, class Tx, class Ty, class TSparseDot>
inline void fsp_vv_accuapprox(TDot&, const Tx&, const Ty&) noexcept(false);
#else
template<class TDot, class Tx, class Ty, class TSparseDot>
...
#if(CXSC_INDEX_CHECK)
template<class TDot, class Tx, class Ty, class TSparseDot>
inline void slsl_vv_accuapprox(TDot&, const Tx&, const Ty&) noexcept(false);
#else
template<class TDot, class Tx, class Ty, class TSparseDot>
...
#if(CXSC_INDEX_CHECK)
template<class TDot, class Tx, class Ty, class TSparseDot>
inline void spsl_vv_accuapprox(TDot&, const Tx&, const Ty&) noexcept(false);
#else
template<class TDot, class Tx, class Ty, class TSparseDot>
...
#if(CXSC_INDEX_CHECK)
template<class TDot, class Tx, class Ty, class TSparseDot>
inline void slsp_vv_accuapprox(TDot&, const Tx&, const Ty&) noexcept(false);
#else
template<class TDot, class Tx, class Ty, class TSparseDot>
...
#if(CXSC_INDEX_CHECK)
template<class TDot, class Tx, class Ty, class TSparseDot>
inline void slf_vv_accuapprox(TDot&, const Tx&, const Ty&) noexcept(false);
#else
template<class TDot, class Tx, class Ty, class TSparseDot>
...
#if(CXSC_INDEX_CHECK)
template<class TDot, class Tx, class Ty, class TSparseDot>
inline void fsl_vv_accuapprox(TDot&, const Tx&, const Ty&) noexcept(false);
#else
template<class TDot, class Tx, class Ty, class TSparseDot>
...
#if(CXSC_INDEX_CHECK)
template <class Tx>
inline void sp_v_resize(Tx &v, const int &len) noexcept(false);
#else
template <class Tx>
...
#if(CXSC_INDEX_CHECK)
template<class Tx>
inline void sp_v_resize(Tx &v, const int &lb, const int &ub) noexcept(false);
#else
template<class Tx>
