...
inline complex & complex::operator= (const real & r) noexcept
{
   re=r;im=0;
   return *this;
}
...
inline complex operator +(const complex &a,const complex &b) noexcept
{
...
inline complex & operator +=(complex &a, const complex &b) noexcept { return a=a+b; }
inline complex & operator -=(complex &a, const complex &b) noexcept { return a=a-b; }
inline complex & operator *=(complex &a, const complex &b) noexcept { return a=a*b; }
inline complex & operator /=(complex &a, const complex &b) noexcept { return a=a/b; }

inline complex operator +(const complex & a,const real & b) noexcept 
{ 
   return complex(a.re+b,a.im);
}

inline complex operator +(const real & a,const complex & b) noexcept
{
...
inline complex & operator +=(complex & a, const real & b) noexcept { return a=a+b; }
inline complex & operator -=(complex & a, const real & b) noexcept { return a=a-b; }
inline complex & operator *=(complex & a, const real & b) noexcept { return a=a*b; }
inline complex & operator /=(complex & a, const real & b) noexcept { return a=a/b; }

      // ---- Comp.Operat.  ---------------------------------------
inline bool operator!  (const complex & a)                    noexcept { return !a.re && !a.im; }
inline bool operator== (const complex & a, const complex & b) noexcept { return a.re==b.re && a.im==b.im; }
inline bool operator!= (const complex & a, const complex & b) noexcept { return a.re!=b.re || a.im!=b.im; }
inline bool operator== (const complex & a, const real & b)    noexcept { return !a.im && a.re==b; }
inline bool operator== (const real & a, const complex & b)    noexcept { return !b.im && a==b.re; }
inline bool operator!= (const complex & a, const real & b)    noexcept { return !!a.im || a.re!=b; }
inline bool operator!= (const real & a, const complex & b)    noexcept { return !!b.im || a!=b.re; }

      // ---- Others   -------------------------------------------

inline complex conj(const complex & a) noexcept { return complex(a.re,-a.im); }
...
inline complex addd(const complex& a, const complex& b) noexcept
{ return complex(addd(a.re,b.re), addd(a.im,b.im)); }

inline complex addu(const complex& a, const complex& b) noexcept
{ return complex(addu(a.re,b.re), addu(a.im,b.im)); }

inline complex addd(const complex& a, const real& b) noexcept
{ return complex(addd(a.re,b), a.im); }

inline complex addu(const complex& a, const real& b) noexcept
{ return complex(addu(a.re,b), a.im); }

inline complex addd(const real& a, const complex& b) noexcept
{ return complex(addd(a,b.re), b.im); }

inline complex addu(const real& a, const complex& b) noexcept
{ return complex(addu(a,b.re), b.im); }
   // ----------------- subtraction: ----------------------------

inline complex subd(const complex& a, const complex& b) noexcept
{ return complex(subd(a.re,b.re), subd(a.im,b.im)); }

inline complex subu(const complex& a, const complex& b) noexcept
{ return complex(subu(a.re,b.re), subu(a.im,b.im)); }

inline complex subd(const complex& a, const real& b) noexcept
{ return complex(subd(a.re,b), a.im); }

inline complex subu(const complex& a, const real& b) noexcept
{ return complex(subu(a.re,b), a.im); }

inline complex subd(const real& a, const complex& b) noexcept
{ return complex(subd(a,b.re), -b.im); }

inline complex subu(const real& a, const complex& b) noexcept
{ return complex(subu(a,b.re), -b.im); }

   // --------------- multiplikation ------------------------

inline complex muld(const complex &a, const real &b) noexcept
{ return complex( muld(a.re,b), muld(a.im,b) ); }

inline complex mulu(const complex &a, const real &b) noexcept
{ return complex( mulu(a.re,b), mulu(a.im,b) ); }

inline complex muld(const real &a, const complex &b) noexcept
{ return complex( muld(a,b.re), muld(a,b.im) ); }

inline complex mulu(const real &a, const complex &b) noexcept
{ return complex( mulu(a,b.re), mulu(a,b.im) ); }

   // -------------- division ---------------------------------

inline complex divd(const complex &a, const real &b) noexcept
{ return complex( divd(a.re,b), divd(a.im,b) ); }

inline complex divu(const complex &a, const real &b) noexcept
{ return complex( divu(a.re,b), divu(a.im,b) ); }

inline complex divd(const real &a, const complex &b) noexcept
{ return divd(_complex(a),b); }

inline complex divu(const real &a, const complex &b) noexcept
...
inline complex muld(const complex &a, const complex &b) noexcept
{  // Blomquist 07.11.02;
   complex tmp;
   dotprecision dot(0.0);
...
inline complex mulu(const complex &a, const complex &b) noexcept
{  // Blomquist 07.11.02;
   complex tmp;
   dotprecision dot(0.0);
...
inline real abs2(const complex &a) noexcept
{
   dotprecision dot(0.0);
...
inline real abs (complex z) noexcept
