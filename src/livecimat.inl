...
namespace cxsc {
	...
	INLINE l_ivector::l_ivector(const imatrix_subv &v) noexcept:l(v.lb),u(v.ub),size(v.size)
	{
	...
	*/
	...
	INLINE l_ivector &l_ivector::operator =(const imatrix_subv &mv) noexcept { return _vmvassign<l_ivector,imatrix_subv,l_interval>(*this,mv); }
	INLINE l_ivector_slice &l_ivector_slice::operator =(const imatrix_subv &mv) noexcept { return _vsvassign(*this,ivector(mv)); }
